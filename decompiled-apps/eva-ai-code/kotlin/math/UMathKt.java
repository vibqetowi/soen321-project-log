...
public final class UMathKt {
    ...
    private static final int m8527minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m8466minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m8528mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m8474minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m8525maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m8454maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m8526maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m8462maxOfeb3DHEI(j, j2);
    }
}
