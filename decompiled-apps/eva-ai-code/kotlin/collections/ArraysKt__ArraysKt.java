        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m7841contentEqualskV0jMPg(((UByteArray) t).m7357unboximpl(), ((UByteArray) t2).m7357unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m7839contentEqualsFGO6Aew(((UShortArray) t).m7620unboximpl(), ((UShortArray) t2).m7620unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m7840contentEqualsKJPZfPQ(((UIntArray) t).m7436unboximpl(), ((UIntArray) t2).m7436unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m7842contentEqualslec5QzE(((ULongArray) t).m7515unboximpl(), ((ULongArray) t2).m7515unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m7847contentToString2csIQuQ(uByteArray != null ? uByteArray.m7357unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m7849contentToStringd6D3K8(uShortArray != null ? uShortArray.m7620unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m7848contentToStringXUkPCBk(uIntArray != null ? uIntArray.m7436unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m7850contentToStringuLth9ew(uLongArray != null ? uLongArray.m7515unboximpl() : null));
            } else {
