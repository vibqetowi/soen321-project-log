...
public interface TimeMark {
    ...
    TimeMark mo8631minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8633plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m8778plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m8777minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo8633plusLRDsOJo(Duration.m8693unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m8673isNegativeimpl(timeMark.mo8630elapsedNowUwyO8pc());
        }
