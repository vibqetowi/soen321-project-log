...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m8634getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo8631minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m8777minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo8630elapsedNowUwyO8pc() {
        return Duration.m8675minusLRDsOJo(this.mark.mo8630elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo8633plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m8676plusLRDsOJo(this.adjustment, j), null);
    }
}
