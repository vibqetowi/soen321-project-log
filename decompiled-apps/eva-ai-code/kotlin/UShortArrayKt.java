...
public final class UShortArrayKt {
    ...
    private static final short[] m7622ushortArrayOfrL5Bavg(short... elements) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = init.invoke(Integer.valueOf(i2)).m7603unboximpl();
        }
        return UShortArray.m7606constructorimpl(sArr);
    }
}
