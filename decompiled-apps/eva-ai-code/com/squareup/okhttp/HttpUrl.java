...
public final class HttpUrl {
    ...
    public List<String> encodedPathSegments() {
        ...
        while (indexOf < delimiterOffset) {
            int i = indexOf + 1;
            int delimiterOffset2 = delimiterOffset(this.url, i, delimiterOffset, RemoteSettings.FORWARD_SLASH_STRING);
        ...
        ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (charAt == '@') {
                        if (!z2) {
                            int delimiterOffset2 = HttpUrl.delimiterOffset(str, i2, delimiterOffset, CertificateUtil.DELIMITER);
                            i = delimiterOffset;
