...
public class CryptoAlgoGcm implements CryptoAlgo {
    ...
    public InputStream wrap(InputStream inputStream, Entity entity) throws IOException, CryptoInitializationException, KeyChainException {
        ...
        boolean z = read == 1;
        Assertions.checkArgumentForIO(z, "Unexpected crypto version " + ((int) read));
        boolean z2 = read2 == this.mConfig.cipherId;
        Assertions.checkArgumentForIO(z2, "Unexpected cipher ID " + ((int) read2));
