...
public final class RecognitionConfig extends GeneratedMessageV3 implements RecognitionConfigOrBuilder {
    ...
    private LazyStringList alternativeLanguageCodes_;
    ...
    private static final Parser<RecognitionConfig> PARSER = new AbstractParser<RecognitionConfig>() { // from class: com.google.cloud.speech.v1p1beta1.RecognitionConfig.1
    ...
    private RecognitionConfig() {
        ...
        this.encoding_ = 0;
        this.languageCode_ = "";
        this.alternativeLanguageCodes_ = LazyStringArrayList.EMPTY;
    ...
    private RecognitionConfig(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        while (!z) {
            try {
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 128:
                                ...
                                continue;
                            case 136:
                                this.diarizationSpeakerCount_ = codedInputStream.readInt32();
                                continue;
                            case 146:
                                ...
                                z2 = z2;
                                if (!z4) {
                                    this.alternativeLanguageCodes_ = new LazyStringArrayList();
                                    z2 = (z2 ? 1 : 0) | true;
                                }
                            ...
                            case 162:
                                ...
                                SpeechAdaptation.Builder builder3 = speechAdaptation != null ? speechAdaptation.toBuilder() : null;
                                SpeechAdaptation speechAdaptation2 = (SpeechAdaptation) codedInputStream.readMessage(SpeechAdaptation.parser(), extensionRegistryLite);
                                this.adaptation_ = speechAdaptation2;
                                if (builder3 != null) {
                                    builder3.mergeFrom(speechAdaptation2);
                                    this.adaptation_ = builder3.buildPartial();
                                } else {
                                    continue;
                                }
                            default:
                ...
                if ((z2 ? 1 : 0) & true) {
                    this.alternativeLanguageCodes_ = this.alternativeLanguageCodes_.getUnmodifiableView();
                }
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_RecognitionConfig_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_RecognitionConfig_fieldAccessorTable.ensureFieldAccessorsInitialized(RecognitionConfig.class, Builder.class);
    }
    ...
    public enum AudioEncoding implements ProtocolMessageEnum {
        ...
        private static final Internal.EnumLiteMap<AudioEncoding> internalValueMap = new Internal.EnumLiteMap<AudioEncoding>() { // from class: com.google.cloud.speech.v1p1beta1.RecognitionConfig.AudioEncoding.1
    ...
    @Override // com.google.cloud.speech.v1p1beta1.RecognitionConfigOrBuilder
    ...
    public String getAlternativeLanguageCodes(int i) {
        return (String) this.alternativeLanguageCodes_.get(i);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        boolean z6 = this.enableWordConfidence_;
        if (z6) {
            codedOutputStream.writeBool(15, z6);
        }
        boolean z7 = this.enableSpeakerDiarization_;
        if (z7) {
            codedOutputStream.writeBool(16, z7);
        }
        int i5 = this.diarizationSpeakerCount_;
        if (i5 != 0) {
            codedOutputStream.writeInt32(17, i5);
        }
        for (int i6 = 0; i6 < this.alternativeLanguageCodes_.size(); i6++) {
            GeneratedMessageV3.writeString(codedOutputStream, 18, this.alternativeLanguageCodes_.getRaw(i6));
        }
    ...
    public int getSerializedSize() {
        ...
        boolean z6 = this.enableWordConfidence_;
        if (z6) {
            computeEnumSize += CodedOutputStream.computeBoolSize(15, z6);
        }
        boolean z7 = this.enableSpeakerDiarization_;
        if (z7) {
            computeEnumSize += CodedOutputStream.computeBoolSize(16, z7);
        }
        int i6 = this.diarizationSpeakerCount_;
        if (i6 != 0) {
            computeEnumSize += CodedOutputStream.computeInt32Size(17, i6);
        }
        int i7 = 0;
        for (int i8 = 0; i8 < this.alternativeLanguageCodes_.size(); i8++) {
            i7 += computeStringSizeNoTag(this.alternativeLanguageCodes_.getRaw(i8));
        }
        int size = computeEnumSize + i7 + (getAlternativeLanguageCodesList().size() * 2);
        if (this.diarizationConfig_ != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.encoding_ == recognitionConfig.encoding_ && getSampleRateHertz() == recognitionConfig.getSampleRateHertz() && getAudioChannelCount() == recognitionConfig.getAudioChannelCount() && getEnableSeparateRecognitionPerChannel() == recognitionConfig.getEnableSeparateRecognitionPerChannel() && getLanguageCode().equals(recognitionConfig.getLanguageCode()) && getAlternativeLanguageCodesList().equals(recognitionConfig.getAlternativeLanguageCodesList()) && getMaxAlternatives() == recognitionConfig.getMaxAlternatives() && getProfanityFilter() == recognitionConfig.getProfanityFilter() && hasAdaptation() == recognitionConfig.hasAdaptation()) {
            if ((!hasAdaptation() || getAdaptation().equals(recognitionConfig.getAdaptation())) && getSpeechContextsList().equals(recognitionConfig.getSpeechContextsList()) && getEnableWordTimeOffsets() == recognitionConfig.getEnableWordTimeOffsets() && getEnableWordConfidence() == recognitionConfig.getEnableWordConfidence() && getEnableAutomaticPunctuation() == recognitionConfig.getEnableAutomaticPunctuation() && getEnableSpeakerDiarization() == recognitionConfig.getEnableSpeakerDiarization() && getDiarizationSpeakerCount() == recognitionConfig.getDiarizationSpeakerCount() && hasDiarizationConfig() == recognitionConfig.hasDiarizationConfig()) {
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + this.encoding_) * 37) + 2) * 53) + getSampleRateHertz()) * 37) + 7) * 53) + getAudioChannelCount()) * 37) + 12) * 53) + Internal.hashBoolean(getEnableSeparateRecognitionPerChannel())) * 37) + 3) * 53) + getLanguageCode().hashCode();
        if (getAlternativeLanguageCodesCount() > 0) {
            hashCode = (((hashCode * 37) + 18) * 53) + getAlternativeLanguageCodesList().hashCode();
        }
        int maxAlternatives = (((((((hashCode * 37) + 4) * 53) + getMaxAlternatives()) * 37) + 5) * 53) + Internal.hashBoolean(getProfanityFilter());
        if (hasAdaptation()) {
        ...
        int hashBoolean = (((((((((((((((((((maxAlternatives * 37) + 8) * 53) + Internal.hashBoolean(getEnableWordTimeOffsets())) * 37) + 15) * 53) + Internal.hashBoolean(getEnableWordConfidence())) * 37) + 11) * 53) + Internal.hashBoolean(getEnableAutomaticPunctuation())) * 37) + 16) * 53) + Internal.hashBoolean(getEnableSpeakerDiarization())) * 37) + 17) * 53) + getDiarizationSpeakerCount();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements RecognitionConfigOrBuilder {
        ...
        public Builder clear() {
            ...
            this.diarizationSpeakerCount_ = 0;
        ...
        public RecognitionConfig buildPartial() {
            ...
            if (singleFieldBuilderV3 == null) {
                recognitionConfig.adaptation_ = this.adaptation_;
            } else {
                recognitionConfig.adaptation_ = singleFieldBuilderV3.build();
            }
            RepeatedFieldBuilderV3<SpeechContext, SpeechContext.Builder, SpeechContextOrBuilder> repeatedFieldBuilderV3 = this.speechContextsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
            ...
            recognitionConfig.enableSpeakerDiarization_ = this.enableSpeakerDiarization_;
            recognitionConfig.diarizationSpeakerCount_ = this.diarizationSpeakerCount_;
            SingleFieldBuilderV3<SpeakerDiarizationConfig, SpeakerDiarizationConfig.Builder, SpeakerDiarizationConfigOrBuilder> singleFieldBuilderV32 = this.diarizationConfigBuilder_;
            if (singleFieldBuilderV32 == null) {
                recognitionConfig.diarizationConfig_ = this.diarizationConfig_;
            } else {
                recognitionConfig.diarizationConfig_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<RecognitionMetadata, RecognitionMetadata.Builder, RecognitionMetadataOrBuilder> singleFieldBuilderV33 = this.metadataBuilder_;
            if (singleFieldBuilderV33 == null) {
                recognitionConfig.metadata_ = this.metadata_;
            } else {
                recognitionConfig.metadata_ = singleFieldBuilderV33.build();
            }
        ...
        public Builder mergeFrom(RecognitionConfig recognitionConfig) {
            ...
            if (recognitionConfig.getDiarizationSpeakerCount() != 0) {
                setDiarizationSpeakerCount(recognitionConfig.getDiarizationSpeakerCount());
            }
        ...
        */
        ...
        @Override // com.google.cloud.speech.v1p1beta1.RecognitionConfigOrBuilder
        public ProtocolStringList getAlternativeLanguageCodesList() {
            return this.alternativeLanguageCodes_.getUnmodifiableView();
        }
        ...
        public Builder addAllAlternativeLanguageCodes(Iterable<String> iterable) {
            ensureAlternativeLanguageCodesIsMutable();
            AbstractMessageLite.Builder.addAll((Iterable) iterable, (List) this.alternativeLanguageCodes_);
            onChanged();
            return this;
        }
        ...
        @Override // com.google.cloud.speech.v1p1beta1.RecognitionConfigOrBuilder
        public boolean hasAdaptation() {
            return (this.adaptationBuilder_ == null && this.adaptation_ == null) ? false : true;
        }
        ...
        public Builder mergeAdaptation(SpeechAdaptation speechAdaptation) {
            SingleFieldBuilderV3<SpeechAdaptation, SpeechAdaptation.Builder, SpeechAdaptationOrBuilder> singleFieldBuilderV3 = this.adaptationBuilder_;
            if (singleFieldBuilderV3 == null) {
                SpeechAdaptation speechAdaptation2 = this.adaptation_;
                if (speechAdaptation2 != null) {
                    this.adaptation_ = SpeechAdaptation.newBuilder(speechAdaptation2).mergeFrom(speechAdaptation).buildPartial();
                } else {
                    this.adaptation_ = speechAdaptation;
                }
                onChanged();
        ...
        @Deprecated
        public Builder setDiarizationSpeakerCount(int i) {
            this.diarizationSpeakerCount_ = i;
            onChanged();
            return this;
        }
