...
public final class StreamingRecognizeRequest extends GeneratedMessageV3 implements StreamingRecognizeRequestOrBuilder {
    ...
    private static final Parser<StreamingRecognizeRequest> PARSER = new AbstractParser<StreamingRecognizeRequest>() { // from class: com.google.cloud.speech.v1p1beta1.StreamingRecognizeRequest.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_StreamingRecognizeRequest_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_StreamingRecognizeRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(StreamingRecognizeRequest.class, Builder.class);
    }
    ...
    @Override // com.google.cloud.speech.v1p1beta1.StreamingRecognizeRequestOrBuilder
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements StreamingRecognizeRequestOrBuilder {
        ...
        public Builder mergeFrom(StreamingRecognizeRequest streamingRecognizeRequest) {
            ...
            int i = AnonymousClass2.$SwitchMap$com$google$cloud$speech$v1p1beta1$StreamingRecognizeRequest$StreamingRequestCase[streamingRecognizeRequest.getStreamingRequestCase().ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.google.cloud.speech.v1p1beta1.StreamingRecognizeRequest$2  reason: invalid class name */
    /* loaded from: classes7.dex */
    public static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$google$cloud$speech$v1p1beta1$StreamingRecognizeRequest$StreamingRequestCase;

        static {
            int[] iArr = new int[StreamingRequestCase.values().length];
            $SwitchMap$com$google$cloud$speech$v1p1beta1$StreamingRecognizeRequest$StreamingRequestCase = iArr;
            try {
                iArr[StreamingRequestCase.STREAMING_CONFIG.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$google$cloud$speech$v1p1beta1$StreamingRecognizeRequest$StreamingRequestCase[StreamingRequestCase.AUDIO_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$google$cloud$speech$v1p1beta1$StreamingRecognizeRequest$StreamingRequestCase[StreamingRequestCase.STREAMINGREQUEST_NOT_SET.ordinal()] = 3;
