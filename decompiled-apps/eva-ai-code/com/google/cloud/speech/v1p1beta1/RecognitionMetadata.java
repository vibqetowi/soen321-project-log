...
public final class RecognitionMetadata extends GeneratedMessageV3 implements RecognitionMetadataOrBuilder {
    ...
    private static final Parser<RecognitionMetadata> PARSER = new AbstractParser<RecognitionMetadata>() { // from class: com.google.cloud.speech.v1p1beta1.RecognitionMetadata.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_RecognitionMetadata_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1p1beta1_RecognitionMetadata_fieldAccessorTable.ensureFieldAccessorsInitialized(RecognitionMetadata.class, Builder.class);
    }
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((((((((((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + this.interactionType_) * 37) + 3) * 53) + getIndustryNaicsCodeOfAudio()) * 37) + 4) * 53) + this.microphoneDistance_) * 37) + 5) * 53) + this.originalMediaType_) * 37) + 6) * 53) + this.recordingDeviceType_) * 37) + 7) * 53) + getRecordingDeviceName().hashCode()) * 37) + 8) * 53) + getOriginalMimeType().hashCode()) * 37) + 9) * 53) + Internal.hashLong(getObfuscatedId())) * 37) + 10) * 53) + getAudioTopic().hashCode()) * 29) + this.unknownFields.hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements RecognitionMetadataOrBuilder {
        ...
        public RecognitionMetadata buildPartial() {
            ...
            recognitionMetadata.obfuscatedId_ = this.obfuscatedId_;
        ...
        public Builder mergeFrom(RecognitionMetadata recognitionMetadata) {
            ...
            if (recognitionMetadata.getObfuscatedId() != 0) {
                setObfuscatedId(recognitionMetadata.getObfuscatedId());
            }
