...
public final class WordInfo extends GeneratedMessageV3 implements WordInfoOrBuilder {
    ...
    private static final Parser<WordInfo> PARSER = new AbstractParser<WordInfo>() { // from class: com.google.cloud.speech.v1.WordInfo.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1_WordInfo_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1_WordInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(WordInfo.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasStartTime() || getStartTime().equals(wordInfo.getStartTime())) && hasEndTime() == wordInfo.hasEndTime()) {
            return (!hasEndTime() || getEndTime().equals(wordInfo.getEndTime())) && getWord().equals(wordInfo.getWord()) && getSpeakerTag() == wordInfo.getSpeakerTag() && this.unknownFields.equals(wordInfo.unknownFields);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode * 37) + 3) * 53) + getWord().hashCode()) * 37) + 5) * 53) + getSpeakerTag()) * 29) + this.unknownFields.hashCode();
