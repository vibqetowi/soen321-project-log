...
public final class RecognitionAudio extends GeneratedMessageV3 implements RecognitionAudioOrBuilder {
    ...
    private static final Parser<RecognitionAudio> PARSER = new AbstractParser<RecognitionAudio>() { // from class: com.google.cloud.speech.v1.RecognitionAudio.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1_RecognitionAudio_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1_RecognitionAudio_fieldAccessorTable.ensureFieldAccessorsInitialized(RecognitionAudio.class, Builder.class);
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements RecognitionAudioOrBuilder {
        ...
        public Builder mergeFrom(RecognitionAudio recognitionAudio) {
            ...
            int i = AnonymousClass2.$SwitchMap$com$google$cloud$speech$v1$RecognitionAudio$AudioSourceCase[recognitionAudio.getAudioSourceCase().ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            $SwitchMap$com$google$cloud$speech$v1$RecognitionAudio$AudioSourceCase = iArr;
            try {
