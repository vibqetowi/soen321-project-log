...
public final class LongRunningRecognizeMetadata extends GeneratedMessageV3 implements LongRunningRecognizeMetadataOrBuilder {
    ...
    private static final Parser<LongRunningRecognizeMetadata> PARSER = new AbstractParser<LongRunningRecognizeMetadata>() { // from class: com.google.cloud.speech.v1.LongRunningRecognizeMetadata.1
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return SpeechProto.internal_static_google_cloud_speech_v1_LongRunningRecognizeMetadata_descriptor;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return SpeechProto.internal_static_google_cloud_speech_v1_LongRunningRecognizeMetadata_fieldAccessorTable.ensureFieldAccessorsInitialized(LongRunningRecognizeMetadata.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getProgressPercent() == longRunningRecognizeMetadata.getProgressPercent() && hasStartTime() == longRunningRecognizeMetadata.hasStartTime()) {
            if ((!hasStartTime() || getStartTime().equals(longRunningRecognizeMetadata.getStartTime())) && hasLastUpdateTime() == longRunningRecognizeMetadata.hasLastUpdateTime()) {
                return (!hasLastUpdateTime() || getLastUpdateTime().equals(longRunningRecognizeMetadata.getLastUpdateTime())) && this.unknownFields.equals(longRunningRecognizeMetadata.unknownFields);
            }
            return false;
        }
        return false;
