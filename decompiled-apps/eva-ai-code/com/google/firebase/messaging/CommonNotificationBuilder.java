...
public final class CommonNotificationBuilder {
    ...
    private static boolean isValidIcon(Resources resources, int i) {
        ...
        try {
            if (CheckGcpEnvironment$$ExternalSyntheticApiModelOutline0.m7234m((Object) resources.getDrawable(i, null))) {
    ...
    public static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            ...
            if (notificationChannel == null) {
                ...
                notificationManager.createNotificationChannel(Util$$ExternalSyntheticApiModelOutline0.m(FCM_FALLBACK_NOTIFICATION_CHANNEL, string, 3));
            }
