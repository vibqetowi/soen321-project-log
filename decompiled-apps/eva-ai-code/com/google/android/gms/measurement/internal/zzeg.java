...
public final class zzeg {
    ...
    static {
        Long valueOf = Long.valueOf((long) HandlingStrategy.DEFAULT_TTL);
        zza = zza("measurement.ad_id_cache_time", valueOf, valueOf, zzbh.zza);
        zzb = zza("measurement.app_uninstalled_additional_ad_id_cache_time", 3600000L, 3600000L, zzaz.zza);
        zzc = zza("measurement.monitoring.sample_period_millis", 86400000L, 86400000L, zzbl.zza);
        zzd = zza("measurement.config.cache_time", 86400000L, 3600000L, zzbx.zza);
        zze = zza("measurement.config.url_scheme", "https", "https", zzcj.zza);
        zzf = zza("measurement.config.url_authority", "app-measurement.com", "app-measurement.com", zzcv.zza);
        zzg = zza("measurement.upload.max_bundles", 100, 100, zzdh.zza);
        zzh = zza("measurement.upload.max_batch_size", 65536, 65536, zzdt.zza);
        zzi = zza("measurement.upload.max_bundle_size", 65536, 65536, zzdy.zza);
        zzj = zza("measurement.upload.max_events_per_bundle", 1000, 1000, zzdz.zza);
        zzk = zza("measurement.upload.max_events_per_day", 100000, 100000, zzbs.zza);
        ...
        zzp = zza("measurement.store.max_stored_events_per_app", 100000, 100000, zzdv.zza);
        ...
        zzu = zza("measurement.upload.realtime_upload_interval", valueOf, valueOf, zzba.zza);
        ...
        zzK = zza("measurement.test.boolean_flag", false, false, zzbp.zza);
        ...
        zzU = zza("measurement.collection.log_event_and_bundle_v2", true, true, zzcb.zza);
        zzV = zza("measurement.quality.checksum", false, false, null);
        zzW = zza("measurement.audience.use_bundle_end_timestamp_for_non_sequence_property_filters", false, false, zzcc.zza);
        zzX = zza("measurement.audience.refresh_event_count_filters_timestamp", false, false, zzce.zza);
        zzY = zza("measurement.audience.use_bundle_timestamp_for_event_count_filters", false, false, zzcf.zza);
        zzZ = zza("measurement.sdk.collection.retrieve_deeplink_from_bow_2", true, true, zzcg.zza);
        zzaa = zza("measurement.sdk.collection.last_deep_link_referrer_campaign2", false, false, zzch.zza);
        zzab = zza("measurement.lifecycle.app_in_background_parameter", false, false, zzci.zza);
        zzac = zza("measurement.integration.disable_firebase_instance_id", false, false, zzck.zza);
        zzad = zza("measurement.collection.service.update_with_analytics_fix", false, false, zzcl.zza);
        zzae = zza("measurement.client.firebase_feature_rollout.v1.enable", true, true, zzcm.zza);
        zzaf = zza("measurement.client.sessions.check_on_reset_and_enable2", true, true, zzcn.zza);
        zzag = zza("measurement.collection.synthetic_data_mitigation", false, false, zzcp.zza);
        zzah = zza("measurement.service.storage_consent_support_version", 203600, 203600, zzcq.zza);
        zzai = zza("measurement.client.click_identifier_control.dev", false, false, zzcr.zza);
        zzaj = zza("measurement.service.click_identifier_control", false, false, zzcs.zza);
        zzak = zza("measurement.service.store_null_safelist", true, true, zzct.zza);
        zzal = zza("measurement.service.store_safelist", true, true, zzcu.zza);
        zzam = zza("measurement.collection.enable_session_stitching_token.first_open_fix", true, true, zzcw.zza);
        zzan = zza("measurement.collection.enable_session_stitching_token.client.dev", true, true, zzcx.zza);
        zzao = zza("measurement.session_stitching_token_enabled", false, false, zzcy.zza);
        zzap = zza("measurement.sgtm.client.dev", false, false, zzda.zza);
        zzaq = zza("measurement.sgtm.service", false, false, zzdb.zza);
        zzar = zza("measurement.redaction.retain_major_os_version", true, true, zzdc.zza);
        zzas = zza("measurement.redaction.scion_payload_generator", true, true, zzdd.zza);
        zzat = zza("measurement.service.clear_global_params_on_uninstall", true, true, zzde.zza);
        zzau = zza("measurement.sessionid.enable_client_session_id", true, true, zzdf.zza);
        zzav = zza("measurement.sfmc.client", true, true, zzdg.zza);
        zzaw = zza("measurement.sfmc.service", true, true, zzdi.zza);
        zzax = zza("measurement.gmscore_feature_tracking", true, true, zzdj.zza);
        zzay = zza("measurement.fix_health_monitor_stack_trace", true, true, zzdl.zza);
        zzaz = zza("measurement.item_scoped_custom_parameters.client", true, true, zzdm.zza);
        zzaA = zza("measurement.item_scoped_custom_parameters.service", false, false, zzdn.zza);
        zzaB = zza("measurement.remove_app_background.client", false, false, zzdo.zza);
        zzaC = zza("measurement.rb.attribution.service", false, false, zzdp.zza);
        zzaD = zza("measurement.collection.client.log_target_api_version", true, true, zzdq.zza);
        zzaE = zza("measurement.collection.service.log_target_api_version", true, true, zzdr.zza);
        zzaF = zza("measurement.client.deep_link_referrer_fix", true, true, zzds.zza);
        zzaG = zza("measurement.client.sessions.enable_fix_background_engagement", false, false, zzdu.zza);
        zzaH = zza("measurement.link_sst_to_sid", true, true, zzdw.zza);
        zzaI = zza("measurement.client.ad_id_consent_fix", true, true, zzdx.zza);
    }
