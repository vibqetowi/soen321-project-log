...
public class AsynchronousMediaCodecBufferEnqueuer {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m6539m();
            cryptoInfo2.setPattern(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
