...
public final class NavHostFlowFragment$addArgs$2 extends Lambda implements Function1<NavArgumentBuilder, Unit> {
    final /* synthetic */ Bundle $args;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavHostFlowFragment$addArgs$2(Bundle bundle) {
        super(1);
        this.$args = bundle;
    }
    ...
    public final void invoke2(NavArgumentBuilder argument) {
        ...
        String string = this.$args.getString(NavHostFlowFragment.CHAT_SUBSCRIPTION_ARG_KEY);
        if (string == null) {
            string = "";
        }
