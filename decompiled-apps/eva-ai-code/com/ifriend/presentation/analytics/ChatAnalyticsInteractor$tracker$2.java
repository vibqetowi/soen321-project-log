...
final class ChatAnalyticsInteractor$tracker$2 extends Lambda implements Function0<AnnalsTrackerAnalyticsSender> {
    public static final ChatAnalyticsInteractor$tracker$2 INSTANCE = new ChatAnalyticsInteractor$tracker$2();

    ChatAnalyticsInteractor$tracker$2() {
        super(0);
    }
