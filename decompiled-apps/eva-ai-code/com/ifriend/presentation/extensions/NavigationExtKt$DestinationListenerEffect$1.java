...
public final class NavigationExtKt$DestinationListenerEffect$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public NavigationExtKt$DestinationListenerEffect$1(NavController navController, NavController.OnDestinationChangedListener onDestinationChangedListener) {
        super(1);
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
        ...
        return new DisposableEffectResult() { // from class: com.ifriend.presentation.extensions.NavigationExtKt$DestinationListenerEffect$1$invoke$$inlined$onDispose$1
