...
@DebugMetadata(c = "com.ifriend.presentation.features.purchases.premium.viewmodel.BuyPremiumViewModel$updateActionLabel$1", f = "BuyPremiumViewModel.kt", i = {}, l = {203}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class BuyPremiumViewModel$updateActionLabel$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BuyPremiumViewModel$updateActionLabel$1(BuyPremiumViewModel buyPremiumViewModel, BuyPremiumPlanUiParams buyPremiumPlanUiParams, Continuation<? super BuyPremiumViewModel$updateActionLabel$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BuyPremiumViewModel$updateActionLabel$1(this.this$0, this.$item, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BuyPremiumViewModel$updateActionLabel$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* renamed from: com.ifriend.presentation.features.purchases.premium.viewmodel.BuyPremiumViewModel$updateActionLabel$1$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public static final class AnonymousClass1 extends Lambda implements Function1<BuyPremiumViewModel.UiState, BuyPremiumViewModel.UiState> {
        ...
        public final BuyPremiumViewModel.UiState invoke(BuyPremiumViewModel.UiState state) {
            ...
            return BuyPremiumViewModel.UiState.copy$default(state, null, null, null, null, false, false, this.$actionLabel, 63, null);
        }
    }
}
