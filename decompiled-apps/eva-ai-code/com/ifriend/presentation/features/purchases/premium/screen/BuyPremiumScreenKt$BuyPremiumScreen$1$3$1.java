...
final class BuyPremiumScreenKt$BuyPremiumScreen$1$3$1 extends Lambda implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstrainedLayoutReference $image;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyPremiumScreenKt$BuyPremiumScreen$1$3$1(ConstrainedLayoutReference constrainedLayoutReference) {
        super(1);
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        HorizontalAnchorable.DefaultImpls.m5910linkToVpY3zN4$default(constrainAs.getTop(), this.$image.getBottom(), 0.0f, 0.0f, 6, null);
