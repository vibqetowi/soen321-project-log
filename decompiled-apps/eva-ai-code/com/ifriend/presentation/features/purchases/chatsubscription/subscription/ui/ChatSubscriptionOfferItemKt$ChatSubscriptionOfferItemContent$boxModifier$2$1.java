...
final class ChatSubscriptionOfferItemKt$ChatSubscriptionOfferItemContent$boxModifier$2$1 extends Lambda implements Function1<Modifier, Modifier> {
    final /* synthetic */ long $gradientShadow;
    final /* synthetic */ float $radius;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatSubscriptionOfferItemKt$ChatSubscriptionOfferItemContent$boxModifier$2$1(long j, float f) {
        super(1);
