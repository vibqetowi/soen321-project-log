package com.ifriend.presentation.features.purchases.chatsubscription.benefits.ui;
...
/* compiled from: ChatSubscriptionBenefitsScreen.kt */
@Metadata(d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u001a'\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0010\u0010\u0004\u001a\f\u0012\u0004\u0012\u00020\u00010\u0005j\u0002`\u0006H\u0007¢\u0006\u0002\u0010\u0007¨\u0006\b²\u0006\n\u0010\t\u001a\u00020\nX\u008a\u0084\u0002"}, d2 = {"ChatSubscriptionBenefitsScreen", "", "viewModel", "Lcom/ifriend/presentation/features/purchases/chatsubscription/benefits/viewmodel/ChatSubscriptionBenefitsViewModel;", "onBackClick", "Lkotlin/Function0;", "Lcom/ifriend/ui/tools/OnClick;", "(Lcom/ifriend/presentation/features/purchases/chatsubscription/benefits/viewmodel/ChatSubscriptionBenefitsViewModel;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "presentation_release", "state", "Lcom/ifriend/presentation/features/purchases/chatsubscription/benefits/viewmodel/ChatSubscriptionBenefitsViewModel$UiState;"}, k = 2, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes6.dex */
public final class ChatSubscriptionBenefitsScreenKt {
    public static final void ChatSubscriptionBenefitsScreen(ChatSubscriptionBenefitsViewModel viewModel, Function0<Unit> onBackClick, Composer composer, int i) {
        BoxScopeInstance boxScopeInstance;
        Composer composer2;
        TextStyle m5100copyv2rsoow;
        Intrinsics.checkNotNullParameter(viewModel, "viewModel");
        Intrinsics.checkNotNullParameter(onBackClick, "onBackClick");
        Composer startRestartGroup = composer.startRestartGroup(2000488121);
        ComposerKt.sourceInformation(startRestartGroup, "C(ChatSubscriptionBenefitsScreen)P(1)");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2000488121, i, -1, "com.ifriend.presentation.features.purchases.chatsubscription.benefits.ui.ChatSubscriptionBenefitsScreen (ChatSubscriptionBenefitsScreen.kt:32)");
        }
        State collectAsState = SnapshotStateKt.collectAsState(viewModel.getUiStateFlow(), null, startRestartGroup, 8, 1);
        long m6960getGradientColor0d7_KjU = ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).m6960getGradientColor0d7_KjU();
        Modifier background$default = BackgroundKt.background$default(Modifier.Companion, Brush.Companion.m3249verticalGradient8A3gB4$default(Brush.Companion, new Pair[]{TuplesKt.to(Float.valueOf(0.0f), Color.m3281boximpl(m6960getGradientColor0d7_KjU)), TuplesKt.to(Float.valueOf(0.45f), Color.m3281boximpl(m6960getGradientColor0d7_KjU)), TuplesKt.to(Float.valueOf(0.8f), Color.m3281boximpl(Color.Companion.m3326getTransparent0d7_KjU())), TuplesKt.to(Float.valueOf(1.0f), Color.m3281boximpl(Color.Companion.m3326getTransparent0d7_KjU()))}, Float.POSITIVE_INFINITY, 0.0f, 0, 8, (Object) null), null, 0.0f, 6, null);
        ...
        ChatSubscriptionCommonKt.ChatSubscriptionBenefitsHeader(onBackClick, ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).getChatName(), startRestartGroup, (i >> 3) & 14);
        ...
        startRestartGroup.startReplaceableGroup(2058660585);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 276693570, "C77@3893L9:Column.kt#2w3rfo");
        SpacerKt.Spacer(ColumnScope.CC.weight$default(ColumnScopeInstance.INSTANCE, Modifier.Companion, 1.0f, false, 2, null), startRestartGroup, 0);
        startRestartGroup.startReplaceableGroup(-722710369);
        if (!ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).getBenefits().isEmpty()) {
            Modifier m750paddingVpY3zN4$default = PaddingKt.m750paddingVpY3zN4$default(PaddingKt.m752paddingqDBjuR0$default(Modifier.Companion, 0.0f, Dp.m5607constructorimpl(28), 0.0f, 0.0f, 13, null), AppTheme.INSTANCE.getDimensions(startRestartGroup, AppTheme.$stable).m7175getMediumD9Ej5fM(), 0.0f, 2, null);
            String screenTitle = ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).getScreenTitle();
        ...
        SubscriptionBenefitsListKt.m6988SubscriptionBenefitsList6a0pyJM(ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).getBenefits(), PaddingKt.m750paddingVpY3zN4$default(PaddingKt.m752paddingqDBjuR0$default(Modifier.Companion, 0.0f, AppTheme.INSTANCE.getDimensions(composer3, AppTheme.$stable).m7166getExtraLargeD9Ej5fM(), 0.0f, AppTheme.INSTANCE.getDimensions(composer3, AppTheme.$stable).m7176getSmallD9Ej5fM(), 5, null), AppTheme.INSTANCE.getDimensions(composer3, AppTheme.$stable).m7175getMediumD9Ej5fM(), 0.0f, 2, null), 0.0f, composer3, 8, 4);
        ...
        composer3.endReplaceableGroup();
        composer3.endReplaceableGroup();
        composer3.startReplaceableGroup(-763492752);
        if (ChatSubscriptionBenefitsScreen$lambda$0(collectAsState).isLoading()) {
            IndeterminateProgressKt.m7059IndeterminateProgresssW7UJKQ(boxScopeInstance.matchParentSize(Modifier.Companion), 0L, null, null, composer3, 0, 14);
        }
        composer3.endReplaceableGroup();
        ComposerKt.sourceInformationMarkerEnd(composer3);
        composer3.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new ChatSubscriptionBenefitsScreenKt$ChatSubscriptionBenefitsScreen$2(viewModel, onBackClick, i));
    }

    private static final ChatSubscriptionBenefitsViewModel.UiState ChatSubscriptionBenefitsScreen$lambda$0(State<ChatSubscriptionBenefitsViewModel.UiState> state) {
