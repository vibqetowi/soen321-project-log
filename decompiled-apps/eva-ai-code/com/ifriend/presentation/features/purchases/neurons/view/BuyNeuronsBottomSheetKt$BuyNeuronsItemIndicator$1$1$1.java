...
public final class BuyNeuronsBottomSheetKt$BuyNeuronsItemIndicator$1$1$1 extends Lambda implements Function1<DrawScope, Unit> {
    final /* synthetic */ float $topPadding;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyNeuronsBottomSheetKt$BuyNeuronsItemIndicator$1$1$1(float f) {
        super(1);
        this.$topPadding = f;
    }
