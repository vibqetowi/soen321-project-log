...
public final class BuyNeuronsBottomSheetKt$BuyNeuronsCard$1$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public BuyNeuronsBottomSheetKt$BuyNeuronsCard$1$2(BuyNeuronsViewModel.UiState uiState, BuyNeuronsClicks buyNeuronsClicks, int i) {
        super(2);
        this.$state = uiState;
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1113521843, i, -1, "com.ifriend.presentation.features.purchases.neurons.view.BuyNeuronsCard.<anonymous>.<anonymous> (BuyNeuronsBottomSheet.kt:107)");
            }
            BuyNeuronsViewModel.UiState uiState = this.$state;
            ...
            bottomSheetDefaults.m1585DragHandlelgZ2HuY(columnScopeInstance.align(Modifier.Companion, Alignment.Companion.getCenterHorizontally()), Dp.m5607constructorimpl(56), Dp.m5607constructorimpl(6), null, Color, composer, 221616, 8);
            AnimatedVisibilityKt.AnimatedVisibility(columnScopeInstance, uiState.isContentVisible(), (Modifier) null, (EnterTransition) null, (ExitTransition) null, (String) null, ComposableLambdaKt.composableLambda(composer, -1624230049, true, new BuyNeuronsBottomSheetKt$BuyNeuronsCard$1$2$1$1$1(uiState, buyNeuronsClicks, i2)), composer, 1572870, 30);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endReplaceableGroup();
            composer.endNode();
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.startReplaceableGroup(1801778749);
