...
@DebugMetadata(c = "com.ifriend.presentation.features.app.delegates.BillingEventDelegateImpl$buySubscription$$inlined$makeRequest$1", f = "BillingEventDelegate.kt", i = {}, l = {110, 183, 185, TsExtractor.TS_PACKET_SIZE}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class BillingEventDelegateImpl$buySubscription$$inlined$makeRequest$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ AppViewModel $$context_receiver_0;
    final /* synthetic */ AppViewModel $$context_receiver_0$inlined;
    final /* synthetic */ BuySubscriptionBillingUiParams $params$inlined;
    Object L$0;
    int label;
    final /* synthetic */ BillingEventDelegateImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BillingEventDelegateImpl$buySubscription$$inlined$makeRequest$1(AppViewModel appViewModel, Continuation continuation, BillingEventDelegateImpl billingEventDelegateImpl, AppViewModel appViewModel2, BuySubscriptionBillingUiParams buySubscriptionBillingUiParams) {
        super(2, continuation);
        this.this$0 = billingEventDelegateImpl;
        this.$$context_receiver_0$inlined = appViewModel2;
        this.$params$inlined = buySubscriptionBillingUiParams;
        this.$$context_receiver_0 = appViewModel;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BillingEventDelegateImpl$buySubscription$$inlined$makeRequest$1(this.$$context_receiver_0, continuation, this.this$0, this.$$context_receiver_0$inlined, this.$params$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BillingEventDelegateImpl$buySubscription$$inlined$makeRequest$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                if (Result.m7278isSuccessimpl(obj2)) {
                    ...
                    this.L$0 = obj2;
                    this.label = 3;
                    if (uiStateDelegate2.sendEvent2(uiStateDelegate2, (AppViewModel.Event) new AppViewModel.Event.GoToBuySubscription(this.$params$inlined), (Continuation<? super Unit>) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
