...
public final class InAppUpdatePopupKt$InAppUpdatesPopupPreview$3$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MutableState<Boolean> $isVisible$delegate;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InAppUpdatePopupKt$InAppUpdatesPopupPreview$3$1(MutableState<Boolean> mutableState) {
        super(0);
