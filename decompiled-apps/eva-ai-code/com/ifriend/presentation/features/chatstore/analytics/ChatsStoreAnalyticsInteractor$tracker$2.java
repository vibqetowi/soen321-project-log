...
final class ChatsStoreAnalyticsInteractor$tracker$2 extends Lambda implements Function0<AnnalsTrackerAnalyticsSender> {
    public static final ChatsStoreAnalyticsInteractor$tracker$2 INSTANCE = new ChatsStoreAnalyticsInteractor$tracker$2();

    ChatsStoreAnalyticsInteractor$tracker$2() {
        super(0);
    }
