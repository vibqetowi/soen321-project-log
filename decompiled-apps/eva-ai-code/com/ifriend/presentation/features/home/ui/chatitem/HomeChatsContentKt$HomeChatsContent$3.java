...
public final class HomeChatsContentKt$HomeChatsContent$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public HomeChatsContentKt$HomeChatsContent$3(HomeViewModel.UiState uiState, Function1<? super HomeChatUi, Unit> function1, int i) {
        super(2);
        this.$state = uiState;
