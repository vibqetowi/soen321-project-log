...
final class HomeAnalyticsInteractor$tracker$2 extends Lambda implements Function0<AnnalsTrackerAnalyticsSender> {
    public static final HomeAnalyticsInteractor$tracker$2 INSTANCE = new HomeAnalyticsInteractor$tracker$2();

    HomeAnalyticsInteractor$tracker$2() {
        super(0);
    }
