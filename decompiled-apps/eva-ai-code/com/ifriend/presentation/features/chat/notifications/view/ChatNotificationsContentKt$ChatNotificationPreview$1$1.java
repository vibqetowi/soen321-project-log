...
final class ChatNotificationsContentKt$ChatNotificationPreview$1$1 extends Lambda implements Function1<ChatNotificationUi, Unit> {
    public static final ChatNotificationsContentKt$ChatNotificationPreview$1$1 INSTANCE = new ChatNotificationsContentKt$ChatNotificationPreview$1$1();

    ChatNotificationsContentKt$ChatNotificationPreview$1$1() {
        super(1);
    }
