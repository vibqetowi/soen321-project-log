...
public final class ChatNotificationsContentKt$ChatNotificationPreview$1$3 extends Lambda implements Function0<Unit> {
    ...
    public ChatNotificationsContentKt$ChatNotificationPreview$1$3(MutableState<PersistentList<ChatNotificationUi>> mutableState, List<String> list, List<String> list2, MutableIntState mutableIntState) {
        super(0);
