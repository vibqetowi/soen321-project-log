...
@DebugMetadata(c = "com.ifriend.presentation.features.chat.screen.viewmodel.ChatViewModel$onUpgradeClick$1", f = "ChatViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class ChatViewModel$onUpgradeClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ChatViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatViewModel$onUpgradeClick$1(ChatViewModel chatViewModel, Continuation<? super ChatViewModel$onUpgradeClick$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatViewModel$onUpgradeClick$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatViewModel$onUpgradeClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
