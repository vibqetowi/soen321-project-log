...
@DebugMetadata(c = "com.ifriend.presentation.features.chat.message.ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2", f = "ChatMessageAccessDelegate.kt", i = {0}, l = {231, 236}, m = "invokeSuspend", n = {"requestId"}, s = {"L$0"})
/* loaded from: classes6.dex */
public final class ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2(ChatMessageAccessDelegateImpl chatMessageAccessDelegateImpl, String str, ChatMessageAccessReason chatMessageAccessReason, ViewModel viewModel, Continuation<? super ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2(this.this$0, this.$messageId, this.$accessActionType, this.$$context_receiver_0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = randomUUID;
            this.label = 1;
            sendBuySubscriptionEvent = chatMessageAccessDelegateImpl.sendBuySubscriptionEvent(randomUUID, this.$messageId, this.$accessActionType, this);
            if (sendBuySubscriptionEvent == coroutine_suspended) {
        ...
        this.L$0 = null;
        this.label = 2;
        if (paymentResultFlow2.collect(new FlowCollector<Boolean>() { // from class: com.ifriend.presentation.features.chat.message.ChatMessageAccessDelegateImpl$handleSubscriptionAccessException$2.1
