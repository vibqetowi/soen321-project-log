...
@DebugMetadata(c = "com.ifriend.presentation.features.chat.message.ChatMessageAccessDelegateImpl$requestAccessAfterUpdateBalance$2", f = "ChatMessageAccessDelegate.kt", i = {}, l = {209, 212, 211, 220}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class ChatMessageAccessDelegateImpl$requestAccessAfterUpdateBalance$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatMessageAccessDelegateImpl$requestAccessAfterUpdateBalance$2(this.this$0, this.$$context_receiver_0, this.$messageId, this.$accessActionType, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatMessageAccessDelegateImpl$requestAccessAfterUpdateBalance$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = null;
            this.label = 3;
            obj = chatMessageAccessInteractor2.requestMessageAccess(str2, (ChatMessage) obj, (r16 & 4) != 0 ? false : false, (r16 & 8) != 0 ? false : true, this.$accessActionType, this);
        ...
        this.L$0 = null;
        this.label = 3;
        obj = chatMessageAccessInteractor22.requestMessageAccess(str2, (ChatMessage) obj, (r16 & 4) != 0 ? false : false, (r16 & 8) != 0 ? false : true, this.$accessActionType, this);
        if (obj == coroutine_suspended) {
        }
