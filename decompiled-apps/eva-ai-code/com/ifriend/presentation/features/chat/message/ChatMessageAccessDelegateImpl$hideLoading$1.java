...
final class ChatMessageAccessDelegateImpl$hideLoading$1 extends Lambda implements Function1<ChatMessageAccessUiState, ChatMessageAccessUiState> {
    public static final ChatMessageAccessDelegateImpl$hideLoading$1 INSTANCE = new ChatMessageAccessDelegateImpl$hideLoading$1();

    ChatMessageAccessDelegateImpl$hideLoading$1() {
        super(1);
    }
