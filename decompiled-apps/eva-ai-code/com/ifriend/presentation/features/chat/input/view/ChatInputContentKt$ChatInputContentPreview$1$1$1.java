...
public final class ChatInputContentKt$ChatInputContentPreview$1$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MutableState<ChatInputState> $state$delegate;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatInputContentKt$ChatInputContentPreview$1$1$1(MutableState<ChatInputState> mutableState) {
        super(0);
