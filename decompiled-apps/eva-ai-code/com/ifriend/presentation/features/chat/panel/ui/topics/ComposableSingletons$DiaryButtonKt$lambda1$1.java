...
/* renamed from: com.ifriend.presentation.features.chat.panel.ui.topics.ComposableSingletons$DiaryButtonKt$lambda-1$1  reason: invalid class name */
/* loaded from: classes6.dex */
final class ComposableSingletons$DiaryButtonKt$lambda1$1 extends Lambda implements Function3<BoxScope, Composer, Integer, Unit> {
    public static final ComposableSingletons$DiaryButtonKt$lambda1$1 INSTANCE = new ComposableSingletons$DiaryButtonKt$lambda1$1();

    ComposableSingletons$DiaryButtonKt$lambda1$1() {
        super(3);
    }
    ...
    public final void invoke(BoxScope NeomorphicButton, Composer composer, int i) {
        ...
        if ((i & 81) != 16 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1336222869, i, -1, "com.ifriend.presentation.features.chat.panel.ui.topics.ComposableSingletons$DiaryButtonKt.lambda-1.<anonymous> (DiaryButton.kt:58)");
            }
            ...
            String stringResource = StringResources_androidKt.stringResource(R.string.chat_panel__diary, composer, 0);
            long sp = TextUnitKt.getSp(16);
            long sp2 = TextUnitKt.getSp(16);
            FontFamily generalSans = AppFontFamily.INSTANCE.getGeneralSans();
            TextKt.m2145Text4IGK_g(stringResource, align, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, new TextStyle(AppTheme.INSTANCE.getColors(composer, AppTheme.$stable).m7108getTextPrimary0d7_KjU(), sp, FontWeight.Companion.getMedium(), (FontStyle) null, (FontSynthesis) null, generalSans, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (DrawStyle) null, (TextAlign) null, (TextDirection) null, sp2, (TextIndent) null, (PlatformTextStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, (TextMotion) null, 16646104, (DefaultConstructorMarker) null), composer, 0, 0, 65532);
