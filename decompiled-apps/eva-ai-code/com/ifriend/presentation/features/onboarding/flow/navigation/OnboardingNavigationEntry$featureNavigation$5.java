...
public final class OnboardingNavigationEntry$featureNavigation$5 extends Lambda implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {
    final /* synthetic */ OnboardingStepViewModelFactory $factory;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingNavigationEntry$featureNavigation$5(OnboardingStepViewModelFactory onboardingStepViewModelFactory) {
        super(4);
    ...
    public final void invoke(AnimatedContentScope onboardingComposable, NavBackStackEntry it, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1395018517, i, -1, "com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry.featureNavigation.<anonymous> (OnboardingNavigationEntry.kt:273)");
        }
        ...
        ViewModel viewModel = ViewModelKt.viewModel(OnboardingAskEveryDayViewModel.class, current, null, onboardingStepViewModelFactory, empty, composer, 36936, 0);
        composer.endReplaceableGroup();
        OnboardingAskEveryDayViewModel onboardingAskEveryDayViewModel = (OnboardingAskEveryDayViewModel) viewModel;
        OnboardingSelectorScreenKt.OnboardingSelectorScreen(invoke$lambda$0(UiStateDelegateExKt.collectUiState(onboardingAskEveryDayViewModel, null, composer, 8, 1)), new AnonymousClass1(onboardingAskEveryDayViewModel), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry$featureNavigation$5$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<SelectButtonUiParams, Unit> {
        AnonymousClass1(Object obj) {
            super(1, obj, OnboardingAskEveryDayViewModel.class, "onButtonClick", "onButtonClick(Lcom/ifriend/presentation/features/onboarding/steps/view/common/SelectButtonUiParams;)V", 0);
        }
        ...
        public final void invoke2(SelectButtonUiParams p0) {
            ...
            ((OnboardingAskEveryDayViewModel) this.receiver).onButtonClick(p0);
        }
    }
