...
public final class OnboardingNavigationEntry$featureNavigation$3 extends Lambda implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {
    final /* synthetic */ OnboardingStepViewModelFactory $factory;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingNavigationEntry$featureNavigation$3(OnboardingStepViewModelFactory onboardingStepViewModelFactory) {
        super(4);
    ...
    public final void invoke(AnimatedContentScope onboardingComposable, NavBackStackEntry it, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(503943895, i, -1, "com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry.featureNavigation.<anonymous> (OnboardingNavigationEntry.kt:251)");
        }
        ...
        ViewModel viewModel = ViewModelKt.viewModel(OnboardingLetKnowMoreViewModel.class, current, null, onboardingStepViewModelFactory, empty, composer, 36936, 0);
        composer.endReplaceableGroup();
        OnboardingLetKnowMoreViewModel onboardingLetKnowMoreViewModel = (OnboardingLetKnowMoreViewModel) viewModel;
        OnboardingInfoScreenKt.OnboardingInfoScreen(invoke$lambda$0(UiStateDelegateExKt.collectUiState(onboardingLetKnowMoreViewModel, null, composer, 8, 1)), null, new AnonymousClass1(onboardingLetKnowMoreViewModel), composer, 0, 2);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry$featureNavigation$3$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function0<Unit> {
        AnonymousClass1(Object obj) {
            super(0, obj, OnboardingLetKnowMoreViewModel.class, "onButtonClick", "onButtonClick()V", 0);
        }
        ...
        public final void invoke2() {
            ((OnboardingLetKnowMoreViewModel) this.receiver).onButtonClick();
        }
    }
