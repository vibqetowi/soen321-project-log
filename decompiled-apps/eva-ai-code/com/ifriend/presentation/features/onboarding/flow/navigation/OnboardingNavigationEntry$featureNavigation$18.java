...
public final class OnboardingNavigationEntry$featureNavigation$18 extends Lambda implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {
    final /* synthetic */ OnboardingStepViewModelFactory $factory;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingNavigationEntry$featureNavigation$18(OnboardingStepViewModelFactory onboardingStepViewModelFactory) {
        super(4);
    ...
    public final void invoke(AnimatedContentScope onboardingComposable, NavBackStackEntry it, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-920606203, i, -1, "com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry.featureNavigation.<anonymous> (OnboardingNavigationEntry.kt:427)");
        }
        ...
        ViewModel viewModel = ViewModelKt.viewModel(OnboardingBotCharacterViewModel.class, current, null, onboardingStepViewModelFactory, empty, composer, 36936, 0);
        composer.endReplaceableGroup();
        OnboardingBotCharacterViewModel onboardingBotCharacterViewModel = (OnboardingBotCharacterViewModel) viewModel;
        OnboardingSelectorScreenKt.OnboardingSelectorScreen(invoke$lambda$0(UiStateDelegateExKt.collectUiState(onboardingBotCharacterViewModel, null, composer, 8, 1)), new AnonymousClass1(onboardingBotCharacterViewModel), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.flow.navigation.OnboardingNavigationEntry$featureNavigation$18$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<SelectButtonUiParams, Unit> {
        AnonymousClass1(Object obj) {
            super(1, obj, OnboardingBotCharacterViewModel.class, "onButtonClick", "onButtonClick(Lcom/ifriend/presentation/features/onboarding/steps/view/common/SelectButtonUiParams;)V", 0);
        }
        ...
        public final void invoke2(SelectButtonUiParams p0) {
            ...
            ((OnboardingBotCharacterViewModel) this.receiver).onButtonClick(p0);
        }
    }
