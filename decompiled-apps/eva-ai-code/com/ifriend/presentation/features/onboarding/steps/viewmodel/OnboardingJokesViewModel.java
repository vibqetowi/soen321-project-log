...
public final class OnboardingJokesViewModel extends ViewModel implements UiStateDelegate<OnboardingSelectorState, Unit> {
    ...
    public OnboardingJokesViewModel(CoroutineScope onboardingScope, OnboardingAnalytics onboardingAnalytics, ResourceProvider resources, OnboardingAnswersRepository onboardingAnswersRepository, DispatcherProvider dispatchers, MutableSharedFlow<OnboardingStepEvent> onboardingEventsFlow) {
    ...
    /* compiled from: OnboardingJokesViewModel.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lcom/ifriend/presentation/features/onboarding/steps/viewmodel/OnboardingJokesViewModel$Companion;", "", "()V", "NO_BUTTON_ID", "", "YES_BUTTON_ID", "presentation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.steps.viewmodel.OnboardingJokesViewModel$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    static final class AnonymousClass1 extends Lambda implements Function1<OnboardingSelectorState, OnboardingSelectorState> {
        ...
        public final OnboardingSelectorState invoke(OnboardingSelectorState state) {
            ...
            String string = OnboardingJokesViewModel.this.resources.getString(R.string.onboarding__jokes__title);
            OnboardingJokesViewModel onboardingJokesViewModel = OnboardingJokesViewModel.this;
            OnboardingJokesViewModel onboardingJokesViewModel2 = OnboardingJokesViewModel.this;
            return state.copy(string, ExtensionsKt.persistentListOf(onboardingJokesViewModel.createButtonUiParams(OnboardingJokesViewModel.YES_BUTTON_ID, onboardingJokesViewModel.resources.getString(R.string.onboarding__jokes__yes), SelectButtonUiParams.Style.Primary), onboardingJokesViewModel2.createButtonUiParams(OnboardingJokesViewModel.NO_BUTTON_ID, onboardingJokesViewModel2.resources.getString(R.string.onboarding__jokes__no), SelectButtonUiParams.Style.Secondary)));
        }
    }
    ...
    public final void onButtonClick(SelectButtonUiParams buttonUiParams) {
        ...
        if (buttonUiParams.getSelected()) {
            BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new OnboardingJokesViewModel$onButtonClick$1(this, null), 3, null);
            return;
        }
        OnboardingJokesViewModel onboardingJokesViewModel = this;
        asyncUpdateUiState(this, ViewModelKt.getViewModelScope(onboardingJokesViewModel), new OnboardingJokesViewModel$onButtonClick$2(buttonUiParams.getId()));
        CoroutinesKt.safeLaunch$default(this.onboardingScope, null, this.dispatchers.background(), new OnboardingJokesViewModel$onButtonClick$3(buttonUiParams, this, null), 1, null);
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(onboardingJokesViewModel), null, null, new OnboardingJokesViewModel$onButtonClick$4(this, null), 3, null);
    }
}
