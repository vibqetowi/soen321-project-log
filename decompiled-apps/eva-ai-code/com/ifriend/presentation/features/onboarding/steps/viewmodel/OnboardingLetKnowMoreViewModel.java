...
public final class OnboardingLetKnowMoreViewModel extends ViewModel implements UiStateDelegate<OnboardingInfoState, Unit> {
    ...
    public OnboardingLetKnowMoreViewModel(OnboardingAnalytics onboardingAnalytics, ResourceProvider resources, MutableSharedFlow<OnboardingStepEvent> onboardingEventsFlow) {
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.steps.viewmodel.OnboardingLetKnowMoreViewModel$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    static final class AnonymousClass1 extends Lambda implements Function1<OnboardingInfoState, OnboardingInfoState> {
        ...
        public final OnboardingInfoState invoke(OnboardingInfoState state) {
            ...
            copy = state.copy((r18 & 1) != 0 ? state.titleLabel : OnboardingLetKnowMoreViewModel.this.resources.getString(R.string.onboarding__let_know_more__title), (r18 & 2) != 0 ? state.subtitleLabel : null, (r18 & 4) != 0 ? state.isSubtitleVisible : false, (r18 & 8) != 0 ? state.descriptionLabel : null, (r18 & 16) != 0 ? state.isDescriptionVisible : false, (r18 & 32) != 0 ? state.buttonLabel : OnboardingLetKnowMoreViewModel.this.resources.getString(R.string.onboarding__let_know_more__button), (r18 & 64) != 0 ? state.isButtonActive : true, (r18 & 128) != 0 ? state.buttonDescriptionLabel : OnboardingLetKnowMoreViewModel.this.resources.getString(R.string.onboarding__let_know_more__info));
            return copy;
        }
    }

    public final void onButtonClick() {
        OnboardingLetKnowMoreViewModel onboardingLetKnowMoreViewModel = this;
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(onboardingLetKnowMoreViewModel), null, null, new OnboardingLetKnowMoreViewModel$onButtonClick$1(this, null), 3, null);
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(onboardingLetKnowMoreViewModel), null, null, new OnboardingLetKnowMoreViewModel$onButtonClick$2(this, null), 3, null);
    }
}
