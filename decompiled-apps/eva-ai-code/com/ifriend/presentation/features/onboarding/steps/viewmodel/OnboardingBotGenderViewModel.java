...
public final class OnboardingBotGenderViewModel extends ViewModel implements UiStateDelegate<OnboardingSelectorState, Unit> {
    ...
    public OnboardingBotGenderViewModel(CoroutineScope onboardingScope, ChangeBotGenderUseCase changeBotGenderUseCase, GetBotUseCase getBotUseCase, OnboardingAnalytics onboardingAnalytics, ResourceProvider resources, DispatcherProvider dispatchers, MutableSharedFlow<OnboardingStepEvent> onboardingEventsFlow) {
    ...
    /* renamed from: com.ifriend.presentation.features.onboarding.steps.viewmodel.OnboardingBotGenderViewModel$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    static final class AnonymousClass1 extends Lambda implements Function1<OnboardingSelectorState, OnboardingSelectorState> {
        ...
        public final OnboardingSelectorState invoke(OnboardingSelectorState state) {
            ...
            Bot current = OnboardingBotGenderViewModel.this.getBotUseCase.current();
            String name = current != null ? current.getName() : null;
            if (name == null) {
                name = "";
            }
            return state.copy(OnboardingBotGenderViewModel.this.resources.getString(R.string.onboarding__bot_gender__title, name), ExtensionsKt.persistentListOf(OnboardingBotGenderViewModel.this.createButtonUiParams(Gender.FEMALE.name(), OnboardingBotGenderViewModel.this.resources.getString(R.string.onboarding__user_gender__female)), OnboardingBotGenderViewModel.this.createButtonUiParams(Gender.MALE.name(), OnboardingBotGenderViewModel.this.resources.getString(R.string.onboarding__user_gender__male)), OnboardingBotGenderViewModel.this.createButtonUiParams(Gender.NON_BINARY.name(), OnboardingBotGenderViewModel.this.resources.getString(R.string.onboarding__user_gender__non_binary))));
        }
    }
    ...
    public final void onButtonClick(SelectButtonUiParams buttonUiParams) {
        ...
        if (buttonUiParams.getSelected()) {
            BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new OnboardingBotGenderViewModel$onButtonClick$1(this, null), 3, null);
            return;
        }
        String id = buttonUiParams.getId();
        OnboardingBotGenderViewModel onboardingBotGenderViewModel = this;
        asyncUpdateUiState(this, ViewModelKt.getViewModelScope(onboardingBotGenderViewModel), new OnboardingBotGenderViewModel$onButtonClick$2(id));
        CoroutinesKt.safeLaunch$default(this.onboardingScope, null, this.dispatchers.background(), new OnboardingBotGenderViewModel$onButtonClick$3(id, this, null), 1, null);
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(onboardingBotGenderViewModel), null, null, new OnboardingBotGenderViewModel$onButtonClick$4(this, null), 3, null);
    }
}
