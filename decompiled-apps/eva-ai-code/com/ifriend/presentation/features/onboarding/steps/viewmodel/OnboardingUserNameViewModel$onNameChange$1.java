...
final class OnboardingUserNameViewModel$onNameChange$1 extends Lambda implements Function1<OnboardingTextFieldState, OnboardingTextFieldState> {
    final /* synthetic */ String $name;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingUserNameViewModel$onNameChange$1(String str) {
        super(1);
        this.$name = str;
    }
    ...
    public final OnboardingTextFieldState invoke(OnboardingTextFieldState state) {
        ...
        return OnboardingTextFieldState.copy$default(state, null, null, StringsKt.take(this.$name, 14), null, null, !StringsKt.isBlank(this.$name), false, 91, null);
    }
}
