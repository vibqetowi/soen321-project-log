...
final class OnboardingUserBirthDateViewModel$onItemSelected$1 extends Lambda implements Function1<OnboardingWheelState, OnboardingWheelState> {
    final /* synthetic */ int $index;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingUserBirthDateViewModel$onItemSelected$1(int i) {
        super(1);
        this.$index = i;
    }
