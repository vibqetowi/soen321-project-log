...
final class OnboardingAskEveryDayViewModel$onButtonClick$2 extends Lambda implements Function1<OnboardingSelectorState, OnboardingSelectorState> {
    final /* synthetic */ String $id;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingAskEveryDayViewModel$onButtonClick$2(String str) {
        super(1);
        this.$id = str;
    }
