...
@DebugMetadata(c = "com.ifriend.presentation.features.profile.actions.ChatProfileActionDelegateImpl$chatAvatarClick$1", f = "ChatProfileActionDelegate.kt", i = {}, l = {35}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class ChatProfileActionDelegateImpl$chatAvatarClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ChatProfileActionDelegateImpl$chatAvatarClick$1(ChatViewModel chatViewModel, ChatProfileActionDelegateImpl chatProfileActionDelegateImpl, Continuation<? super ChatProfileActionDelegateImpl$chatAvatarClick$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatProfileActionDelegateImpl$chatAvatarClick$1(this.$$context_receiver_0, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatProfileActionDelegateImpl$chatAvatarClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (i2 == 1) {
                ...
                chatScreenAnalyticsUseCase.trackClickAvatarPic();
                ...
                chatScreenAnalyticsUseCase2.trackClickAvatarPic();
