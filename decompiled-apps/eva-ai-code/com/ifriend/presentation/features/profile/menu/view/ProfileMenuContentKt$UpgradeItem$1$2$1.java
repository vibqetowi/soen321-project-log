...
public final class ProfileMenuContentKt$UpgradeItem$1$2$1 extends Lambda implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstrainedLayoutReference $textRef;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProfileMenuContentKt$UpgradeItem$1$2$1(ConstrainedLayoutReference constrainedLayoutReference) {
        super(1);
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        HorizontalAnchorable.DefaultImpls.m5910linkToVpY3zN4$default(constrainAs.getBottom(), this.$textRef.getBottom(), Dp.m5607constructorimpl(5), 0.0f, 4, null);
