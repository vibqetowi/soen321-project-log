...
/* renamed from: com.ifriend.presentation.features.profile.menu.view.ComposableSingletons$ProfileMenuContentKt$lambda-1$1$1$1  reason: invalid class name */
/* loaded from: classes6.dex */
final class ComposableSingletons$ProfileMenuContentKt$lambda1$1$1$1 extends Lambda implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstrainedLayoutReference $textRef;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposableSingletons$ProfileMenuContentKt$lambda1$1$1$1(ConstrainedLayoutReference constrainedLayoutReference) {
        super(1);
