...
final class ProfileMenuContentKt$ProfileMenuContent$1$invoke$lambda$5$$inlined$rememberAction$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ProfileMenuNavigator $navigator$inlined;
    final /* synthetic */ Function0 $onDismiss$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProfileMenuContentKt$ProfileMenuContent$1$invoke$lambda$5$$inlined$rememberAction$3(Function0 function0, ProfileMenuNavigator profileMenuNavigator) {
        super(0);
    ...
    public final Unit invoke() {
        ...
        this.$navigator$inlined.getToEditProfile().invoke();
