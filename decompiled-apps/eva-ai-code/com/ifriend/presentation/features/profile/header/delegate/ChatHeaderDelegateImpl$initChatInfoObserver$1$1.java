...
final class ChatHeaderDelegateImpl$initChatInfoObserver$1$1 extends Lambda implements Function1<ChatHeaderUiState, ChatHeaderUiState> {
    final /* synthetic */ ChatInfo $info;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatHeaderDelegateImpl$initChatInfoObserver$1$1(ChatInfo chatInfo) {
        super(1);
        this.$info = chatInfo;
    }
    ...
    public final ChatHeaderUiState invoke(ChatHeaderUiState state) {
        ...
        copy = state.copy((r26 & 1) != 0 ? state.animatedAvatarState : null, (r26 & 2) != 0 ? state.title : this.$info.getName(), (r26 & 4) != 0 ? state.unreadMessagesCount : 0, (r26 & 8) != 0 ? state.lvlProgress : 0.0f, (r26 & 16) != 0 ? state.lvlLabel : null, (r26 & 32) != 0 ? state.isVisibleLvlProgress : false, (r26 & 64) != 0 ? state.balanceLabel : null, (r26 & 128) != 0 ? state.isVisibleBackButton : false, (r26 & 256) != 0 ? state.isVisibleMenuButton : false, (r26 & 512) != 0 ? state.isVisibleMenuIndicator : false, (r26 & 1024) != 0 ? state.isVisibleUpdateIndicator : false, (r26 & 2048) != 0 ? state.isVisibleVerified : this.$info.getTags().contains(ChatInfoTag.VERIFIED_ACCOUNT));
        return copy;
    }
}
