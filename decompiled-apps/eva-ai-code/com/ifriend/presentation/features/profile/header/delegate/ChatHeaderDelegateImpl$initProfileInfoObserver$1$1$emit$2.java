...
final class ChatHeaderDelegateImpl$initProfileInfoObserver$1$1$emit$2 extends Lambda implements Function1<ChatHeaderUiState, ChatHeaderUiState> {
    ...
    public ChatHeaderDelegateImpl$initProfileInfoObserver$1$1$emit$2(ChatHeaderDelegateImpl chatHeaderDelegateImpl, String str, float f) {
        super(1);
