...
final class ChatHeaderDelegateImpl$initProfileInfoObserver$2$1 extends Lambda implements Function1<ChatHeaderUiState, ChatHeaderUiState> {
    final /* synthetic */ UserBalance $balance;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatHeaderDelegateImpl$initProfileInfoObserver$2$1(UserBalance userBalance) {
        super(1);
