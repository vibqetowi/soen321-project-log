...
final class VideoBackgroundRegistrationViewModel$updateShowingUI$1 extends Lambda implements Function1<VideoBackgroundRegistrationState, VideoBackgroundRegistrationState> {
    final /* synthetic */ boolean $isShowing;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoBackgroundRegistrationViewModel$updateShowingUI$1(boolean z) {
        super(1);
        this.$isShowing = z;
    }
    ...
    public final VideoBackgroundRegistrationState invoke(VideoBackgroundRegistrationState it) {
        ...
        return VideoBackgroundRegistrationState.copy$default(it, false, false, this.$isShowing, 3, null);
    }
}
