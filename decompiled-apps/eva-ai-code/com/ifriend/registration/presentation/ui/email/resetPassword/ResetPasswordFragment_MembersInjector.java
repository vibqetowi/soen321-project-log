...
public final class ResetPasswordFragment_MembersInjector implements MembersInjector<ResetPasswordFragment> {
    ...
    public ResetPasswordFragment_MembersInjector(Provider<InternetConnection> provider, Provider<InternalNotificationHandlersRegister> provider2, Provider<Logger> provider3, Provider<RouterProvider> provider4, Provider<ViewModelFactory> provider5) {
    ...
    public static MembersInjector<ResetPasswordFragment> create(Provider<InternetConnection> provider, Provider<InternalNotificationHandlersRegister> provider2, Provider<Logger> provider3, Provider<RouterProvider> provider4, Provider<ViewModelFactory> provider5) {
        return new ResetPasswordFragment_MembersInjector(provider, provider2, provider3, provider4, provider5);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(ResetPasswordFragment resetPasswordFragment) {
        BaseFragment_MembersInjector.injectInternetConnection(resetPasswordFragment, this.internetConnectionProvider.get());
        BaseFragment_MembersInjector.injectInternalNotificationHandlersRegister(resetPasswordFragment, this.internalNotificationHandlersRegisterProvider.get());
        BaseFragment_MembersInjector.injectLogger(resetPasswordFragment, this.loggerProvider.get());
        BaseFragment_MembersInjector.injectRouterProvider(resetPasswordFragment, this.routerProvider.get());
