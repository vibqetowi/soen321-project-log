...
public final class SnackbarKt$showSnackbarNotification$show$1 extends Lambda implements Function3<View, WindowInsetsCompat, InitialPadding, Unit> {
    public static final SnackbarKt$showSnackbarNotification$show$1 INSTANCE = new SnackbarKt$showSnackbarNotification$show$1();

    SnackbarKt$showSnackbarNotification$show$1() {
        super(3);
    }
