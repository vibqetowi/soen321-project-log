...
final class SnackbarKt$showCongratulationSnackbar$1 extends Lambda implements Function3<View, WindowInsetsCompat, InitialPadding, Unit> {
    public static final SnackbarKt$showCongratulationSnackbar$1 INSTANCE = new SnackbarKt$showCongratulationSnackbar$1();

    SnackbarKt$showCongratulationSnackbar$1() {
        super(3);
    }
