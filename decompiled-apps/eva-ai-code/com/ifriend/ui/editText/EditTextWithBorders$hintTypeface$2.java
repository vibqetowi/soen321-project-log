...
final class EditTextWithBorders$hintTypeface$2 extends Lambda implements Function0<CustomTypefaceSpan> {
    final /* synthetic */ Context $context;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EditTextWithBorders$hintTypeface$2(Context context) {
        super(0);
    ...
    public final CustomTypefaceSpan invoke() {
        Typeface font = ResourcesCompat.getFont(this.$context, R.font.poppins_extra_light);
