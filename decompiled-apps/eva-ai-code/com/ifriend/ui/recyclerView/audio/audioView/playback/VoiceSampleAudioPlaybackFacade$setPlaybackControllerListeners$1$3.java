...
public final class VoiceSampleAudioPlaybackFacade$setPlaybackControllerListeners$1$3 extends Lambda implements Function0<Unit> {
    ...
    public VoiceSampleAudioPlaybackFacade$setPlaybackControllerListeners$1$3(VoiceSampleAudioPlaybackFacade voiceSampleAudioPlaybackFacade, PlaybackController playbackController) {
        super(0);
    ...
    public final void invoke2() {
        ...
        this.this$0.setPlaybackState(VoiceSampleAudioPlaybackFacade.PlaybackState.PAUSE);
        this.$playbackController.seekTo(0L);
        long duration = this.$playbackController.getDuration();
        List<ChatAudioViewEventListener> eventListeners = this.this$0.getEventListeners();
        if (eventListeners != null) {
            for (ChatAudioViewEventListener chatAudioViewEventListener : eventListeners) {
                chatAudioViewEventListener.onCompleted(duration);
            }
        }
