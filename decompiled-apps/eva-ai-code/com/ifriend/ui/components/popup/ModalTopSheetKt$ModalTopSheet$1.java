...
final class ModalTopSheetKt$ModalTopSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public ModalTopSheetKt$ModalTopSheet$1(Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1638962469, i, -1, "com.ifriend.ui.components.popup.ModalTopSheet.<anonymous> (ModalTopSheet.kt:94)");
            }
