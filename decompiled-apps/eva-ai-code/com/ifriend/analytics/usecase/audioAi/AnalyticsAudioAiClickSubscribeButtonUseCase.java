...
/* compiled from: AnalyticsAudioAiClickSubscribeButtonUseCase.kt */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\u0018\u00002\u00020\u0001B\u0019\u0012\u0012\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\u0003\"\u00020\u0004¢\u0006\u0002\u0010\u0005J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0018\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\u0003X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0006¨\u0006\u000b"}, d2 = {"Lcom/ifriend/analytics/usecase/audioAi/AnalyticsAudioAiClickSubscribeButtonUseCase;", "", "analyticsSenders", "", "Lcom/ifriend/analytics/AnalyticsSender;", "([Lcom/ifriend/analytics/AnalyticsSender;)V", "[Lcom/ifriend/analytics/AnalyticsSender;", "handle", "", "messageId", "", "analytics_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes6.dex */
public final class AnalyticsAudioAiClickSubscribeButtonUseCase {
    private final AnalyticsSender[] analyticsSenders;

    public AnalyticsAudioAiClickSubscribeButtonUseCase(AnalyticsSender... analyticsSenders) {
    ...
    public final void handle(String messageId) {
        ...
        if (annalsTrackerAnalyticsSender2 != null) {
            annalsTrackerAnalyticsSender2.sendEvent("click-sub-btn-modal-audio-ai", MapsKt.mapOf(new Pair(AnalyticsAudioAiConstants.MESSAGE_ID, messageId), new Pair(AnalyticsConstants.TIMESTAMP, Long.valueOf(System.currentTimeMillis()))));
        }
    }
}
