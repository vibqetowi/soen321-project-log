...
final class AppConfigLocalDataSourceImpl$getEntity$2 extends Lambda implements Function1<ConfigEntity, Boolean> {
    final /* synthetic */ String $fullKey;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppConfigLocalDataSourceImpl$getEntity$2(String str) {
        super(1);
        this.$fullKey = str;
    }
    ...
    public final Boolean invoke(ConfigEntity it) {
        ...
        return Boolean.valueOf(Intrinsics.areEqual(it.getKey(), this.$fullKey));
    }
}
