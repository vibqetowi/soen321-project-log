...
@DebugMetadata(c = "com.ifriend.data.memorycached.onboarding.OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2", f = "OnboardingChatConfigsMemoryCachedSourceImpl.kt", i = {}, l = {38, 39}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends OnboardingChatInfo>>, Object> {
    int label;
    final /* synthetic */ OnboardingChatConfigsMemoryCachedSourceImpl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2(OnboardingChatConfigsMemoryCachedSourceImpl onboardingChatConfigsMemoryCachedSourceImpl, Continuation<? super OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<OnboardingChatInfo>> continuation) {
        return ((OnboardingChatConfigsMemoryCachedSourceImpl$getChatConfigs$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
