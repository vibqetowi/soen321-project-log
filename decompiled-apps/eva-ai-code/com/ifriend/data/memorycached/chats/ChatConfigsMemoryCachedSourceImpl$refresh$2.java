...
@DebugMetadata(c = "com.ifriend.data.memorycached.chats.ChatConfigsMemoryCachedSourceImpl$refresh$2", f = "ChatConfigsMemoryCachedSourceImpl.kt", i = {}, l = {44, 44}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class ChatConfigsMemoryCachedSourceImpl$refresh$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public ChatConfigsMemoryCachedSourceImpl$refresh$2(ChatConfigsMemoryCachedSourceImpl chatConfigsMemoryCachedSourceImpl, Continuation<? super ChatConfigsMemoryCachedSourceImpl$refresh$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatConfigsMemoryCachedSourceImpl$refresh$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatConfigsMemoryCachedSourceImpl$refresh$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
