...
final class BotRepositoryImpl$setVoice$2 extends Lambda implements Function1<Bot, Bot> {
    final /* synthetic */ String $voiceId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BotRepositoryImpl$setVoice$2(String str) {
        super(1);
        this.$voiceId = str;
    }
    ...
    public final Bot invoke(Bot bot) {
        ...
        return Bot.copy$default(bot, null, null, null, null, null, voiceConfig != null ? BotVoiceConfig.copy$default(voiceConfig, this.$voiceId, null, 2, null) : null, 31, null);
    }
}
