...
final class UserOffersRepositoryImpl$shouldShowChatSubscriptionOfferAfterOnboardingDelegate$2 extends Lambda implements Function0<DataStorePreferenceDelegateImpl<Boolean>> {
    final /* synthetic */ DataStore<Preferences> $dataStore;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserOffersRepositoryImpl$shouldShowChatSubscriptionOfferAfterOnboardingDelegate$2(DataStore<Preferences> dataStore) {
        super(0);
    ...
    public final DataStorePreferenceDelegateImpl<Boolean> invoke() {
        return new DataStorePreferenceDelegateImpl<>(this.$dataStore, PreferencesKeys.INSTANCE.getCHAT_SUBSCRIPTION_OFFER_ONBOARDING(), false);
    }
}
