...
final class LocalDefaultsConfig$neurons$2 extends Lambda implements Function1<LocalDefaultsConfigBuilder.FeatureBuilder<Integer>, Unit> {
    public static final LocalDefaultsConfig$neurons$2 INSTANCE = new LocalDefaultsConfig$neurons$2();

    LocalDefaultsConfig$neurons$2() {
        super(1);
    }
    ...
    public final void invoke2(LocalDefaultsConfigBuilder.FeatureBuilder<Integer> feature) {
        ...
        feature.byTags(CollectionsKt.listOf(NeuronsToggle.FEATURE_V1_NAME), 20);
        feature.byTags(CollectionsKt.listOf(NeuronsToggle.FEATURE_V2_NAME), 30);
    }
}
