...
final class FirebaseRemoteConfigParserImpl$tryLong$1 extends Lambda implements Function1<FirebaseRemoteConfigValue, PrimitiveValue> {
    final /* synthetic */ FirebaseRemoteConfigValue $value;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FirebaseRemoteConfigParserImpl$tryLong$1(FirebaseRemoteConfigValue firebaseRemoteConfigValue) {
        super(1);
    ...
    public final PrimitiveValue invoke(FirebaseRemoteConfigValue safe) {
        ...
        return new LongPrimitiveValue(this.$value.asLong());
    }
}
