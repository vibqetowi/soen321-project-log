...
final class LocalDefaultsConfig$neurons$3 extends Lambda implements Function1<LocalDefaultsConfigBuilder.FeatureBuilder<Integer>, Unit> {
    public static final LocalDefaultsConfig$neurons$3 INSTANCE = new LocalDefaultsConfig$neurons$3();

    LocalDefaultsConfig$neurons$3() {
        super(1);
    }
    ...
    public final void invoke2(LocalDefaultsConfigBuilder.FeatureBuilder<Integer> feature) {
        ...
        feature.byTags(CollectionsKt.listOf("100.registration.neurons"), 100);
        feature.byTags(CollectionsKt.listOf("300.registration.neurons"), 300);
    }
}
