...
public final class AppActivity$special$$inlined$viewBindingActivity$default$1 extends Lambda implements Function1<AppActivity, ActivityAppBinding> {
    public AppActivity$special$$inlined$viewBindingActivity$default$1() {
        super(1);
    }

    @Override // kotlin.jvm.functions.Function1
    public final ActivityAppBinding invoke(AppActivity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        return ActivityAppBinding.bind(UtilsKt.findRootView(activity));
    }
}
