...
final class LightDiaryFragment$applyWindowInsets$1 extends Lambda implements Function3<View, WindowInsetsCompat, InitialPadding, Unit> {
    public static final LightDiaryFragment$applyWindowInsets$1 INSTANCE = new LightDiaryFragment$applyWindowInsets$1();

    LightDiaryFragment$applyWindowInsets$1() {
        super(3);
    }
