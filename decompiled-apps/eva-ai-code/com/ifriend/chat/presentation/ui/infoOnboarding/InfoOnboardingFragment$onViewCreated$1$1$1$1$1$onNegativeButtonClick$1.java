...
final class InfoOnboardingFragment$onViewCreated$1$1$1$1$1$onNegativeButtonClick$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ InfoOnboardingSlide $screen;
    final /* synthetic */ InfoOnboardingFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoOnboardingFragment$onViewCreated$1$1$1$1$1$onNegativeButtonClick$1(InfoOnboardingFragment infoOnboardingFragment, InfoOnboardingSlide infoOnboardingSlide) {
        super(0);
    ...
    public final void invoke2() {
        ...
        viewModel.clickButton(this.$screen, InfoOnboardingAction.No);
    }
}
