...
public final class InfoOnboardingScreen implements FragmentScreen {
    ...
    public Fragment createFragment(FragmentFactory factory) {
        ...
        return new InfoOnboardingFragment();
    }

    @Override // com.ifriend.base.navigation.api.cicerone.Screen
    public String getScreenKey() {
        return AnalyticsScreenName.SCREENS_AFTER_ONBOARDING.getValue();
    }
}
