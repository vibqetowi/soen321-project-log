...
public final class UserGenderFragment$special$$inlined$viewModels$default$3 extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Lazy $owner$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserGenderFragment$special$$inlined$viewModels$default$3(Lazy lazy) {
        super(0);
