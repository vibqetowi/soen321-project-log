...
final class BotProfileAnalytics$tracker$2 extends Lambda implements Function0<AnnalsTrackerAnalyticsSender> {
    public static final BotProfileAnalytics$tracker$2 INSTANCE = new BotProfileAnalytics$tracker$2();

    BotProfileAnalytics$tracker$2() {
        super(0);
    }
