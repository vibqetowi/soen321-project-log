...
final class SelectGeneratedAvatarViewModel$onCoroutineError$1 extends Lambda implements Function1<SelectGeneratedAvatarState, SelectGeneratedAvatarState> {
    public static final SelectGeneratedAvatarViewModel$onCoroutineError$1 INSTANCE = new SelectGeneratedAvatarViewModel$onCoroutineError$1();

    SelectGeneratedAvatarViewModel$onCoroutineError$1() {
        super(1);
    }
