...
final class SelectGeneratedAvatarViewModel$generateAgain$1 extends Lambda implements Function1<SelectGeneratedAvatarState, SelectGeneratedAvatarState> {
    public static final SelectGeneratedAvatarViewModel$generateAgain$1 INSTANCE = new SelectGeneratedAvatarViewModel$generateAgain$1();

    SelectGeneratedAvatarViewModel$generateAgain$1() {
        super(1);
    }
