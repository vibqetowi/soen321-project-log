...
public final class ChatListFragment$special$$inlined$viewModels$default$3 extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ Lazy $owner$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatListFragment$special$$inlined$viewModels$default$3(Lazy lazy) {
        super(0);
