...
final class TopicSeparatorDelegateKt$premiumTopicSeparatorDelegate$1 extends Lambda implements Function2<LayoutInflater, ViewGroup, ViewComposeWrapContentBinding> {
    public static final TopicSeparatorDelegateKt$premiumTopicSeparatorDelegate$1 INSTANCE = new TopicSeparatorDelegateKt$premiumTopicSeparatorDelegate$1();

    TopicSeparatorDelegateKt$premiumTopicSeparatorDelegate$1() {
        super(2);
    }
