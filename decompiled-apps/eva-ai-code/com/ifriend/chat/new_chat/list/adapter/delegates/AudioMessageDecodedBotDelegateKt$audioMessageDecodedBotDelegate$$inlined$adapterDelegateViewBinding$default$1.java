...
public final class AudioMessageDecodedBotDelegateKt$audioMessageDecodedBotDelegate$$inlined$adapterDelegateViewBinding$default$1 extends Lambda implements Function3<Object, List<? extends Object>, Integer, Boolean> {
    public AudioMessageDecodedBotDelegateKt$audioMessageDecodedBotDelegate$$inlined$adapterDelegateViewBinding$default$1() {
        super(3);
    }

    public final Boolean invoke(Object obj, List<? extends Object> noName_1, int i) {
        Intrinsics.checkNotNullParameter(noName_1, "$noName_1");
        return Boolean.valueOf(obj instanceof AudioMessageBotDecodedUiModel);
    }
