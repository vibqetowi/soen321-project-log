...
@Metadata(d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0010\u0000\n\u0000\u001a\r\u0010\u0000\u001a\u00020\u0001H\u0007¢\u0006\u0002\u0010\u0002\u001a\u0012\u0010\u0003\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u0004¨\u0006\u0007"}, d2 = {"ChatEndCallContent", "", "(Landroidx/compose/runtime/Composer;I)V", "endCallDelegate", "Lcom/hannesdorfmann/adapterdelegates4/AdapterDelegate;", "", "", "new_chat_release"}, k = 2, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes6.dex */
public final class EndCallDelegateKt {
    public static final AdapterDelegate<List<Object>> endCallDelegate() {
        return new DslViewBindingListAdapterDelegate(EndCallDelegateKt$endCallDelegate$1.INSTANCE, new EndCallDelegateKt$endCallDelegate$$inlined$adapterDelegateViewBinding$default$1(), EndCallDelegateKt$endCallDelegate$2.INSTANCE, EndCallDelegateKt$endCallDelegate$$inlined$adapterDelegateViewBinding$default$2.INSTANCE);
    }

    public static final void ChatEndCallContent(Composer composer, int i) {
        Modifier m7069innerShadowhy0AmR8;
        Composer composer2;
        Composer startRestartGroup = composer.startRestartGroup(-873735372);
        ComposerKt.sourceInformation(startRestartGroup, "C(ChatEndCallContent)");
        if (i != 0 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-873735372, i, -1, "com.ifriend.chat.new_chat.list.adapter.delegates.ChatEndCallContent (EndCallDelegate.kt:45)");
            }
            ...
            Modifier clip = ClipKt.clip(SizeKt.wrapContentSize$default(Modifier.Companion, null, false, 3, null), RoundedCornerShapeKt.m1009RoundedCornerShape0680j_4(m5607constructorimpl));
            float m5607constructorimpl2 = Dp.m5607constructorimpl(4);
            float f = (float) 0.5d;
            m7069innerShadowhy0AmR8 = ShadowKt.m7069innerShadowhy0AmR8(clip, (r16 & 1) != 0 ? AppColors.Companion.m7142getViolet0d7_KjU() : AppColors.Companion.m7139getRed0d7_KjU(), (r16 & 2) != 0 ? Dp.m5607constructorimpl(0) : m5607constructorimpl, (r16 & 4) != 0 ? Dp.m5607constructorimpl(0) : 0.0f, (r16 & 8) != 0 ? Dp.m5607constructorimpl(0) : m5607constructorimpl2, (r16 & 16) != 0 ? Dp.m5607constructorimpl(0) : Dp.m5607constructorimpl(f), (r16 & 32) != 0 ? Dp.m5607constructorimpl(0) : Dp.m5607constructorimpl(f));
            Modifier m7024innerButtonGradientTIErZ5U$default = ButtonWidgetsKt.m7024innerButtonGradientTIErZ5U$default(m7069innerShadowhy0AmR8, AppColors.Companion.m7139getRed0d7_KjU(), 0.7f, m5607constructorimpl, 0.0f, 0.0f, 24, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(m7024innerButtonGradientTIErZ5U$default);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
        ...
        endRestartGroup.updateScope(new EndCallDelegateKt$ChatEndCallContent$2(i));
    }
}
