...
final class BillingInteractorImpl$confirmPurchases$4 extends Lambda implements Function1<Map<String, String>, Unit> {
    ...
    public BillingInteractorImpl$confirmPurchases$4(List<? extends Purchase> list, boolean z) {
        super(1);
        this.$purchases = list;
        this.$isSuccessful = z;
    }
    ...
    /* renamed from: com.ifiend.billing.impl.logic.BillingInteractorImpl$confirmPurchases$4$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    public final void invoke2(Map<String, String> logEvent) {
        ...
        logEvent.put("successful", String.valueOf(this.$isSuccessful));
    }
}
