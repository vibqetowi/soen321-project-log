...
public class ConscryptEngineSocket extends OpenSSLSocketImpl implements SSLParametersImpl.AliasChooser {
    ...
    private static X509TrustManager getDelegatingTrustManager(X509TrustManager x509TrustManager, final ConscryptEngineSocket conscryptEngineSocket) {
        if (CheckGcpEnvironment$$ExternalSyntheticApiModelOutline0.m$2(x509TrustManager)) {
            final X509ExtendedTrustManager m7231m = CheckGcpEnvironment$$ExternalSyntheticApiModelOutline0.m7231m((Object) x509TrustManager);
            return new X509ExtendedTrustManager() { // from class: org.conscrypt.ConscryptEngineSocket.2
                ...
                public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str, SSLEngine sSLEngine) throws CertificateException {
                    X509ExtendedTrustManager.this.checkClientTrusted(x509CertificateArr, str, conscryptEngineSocket);
                }

                public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str, SSLEngine sSLEngine) throws CertificateException {
                    X509ExtendedTrustManager.this.checkServerTrusted(x509CertificateArr, str, conscryptEngineSocket);
                }

                @Override // javax.net.ssl.X509TrustManager
                public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
                    X509ExtendedTrustManager.this.checkClientTrusted(x509CertificateArr, str);
                }

                @Override // javax.net.ssl.X509TrustManager
                public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
                    X509ExtendedTrustManager.this.checkServerTrusted(x509CertificateArr, str);
                }

                @Override // javax.net.ssl.X509TrustManager
                public X509Certificate[] getAcceptedIssuers() {
                    return X509ExtendedTrustManager.this.getAcceptedIssuers();
                }
            };
        }
