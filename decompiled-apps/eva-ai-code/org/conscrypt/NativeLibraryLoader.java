...
public final class NativeLibraryLoader {
    ...
    static {
        ...
        DELETE_NATIVE_LIB_AFTER_LOADING = Boolean.valueOf(System.getProperty(DELETE_LIB_PROPERTY_NAME, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)).booleanValue();
    }
    ...
    private static boolean loadFromWorkdir(String str, ClassLoader classLoader, List<LoadResult> list) {
        ...
        try {
            try {
                File createTempFile = Platform.createTempFile(mapLibraryName.substring(0, lastIndexOf), mapLibraryName.substring(lastIndexOf, mapLibraryName.length()), WORKDIR);
