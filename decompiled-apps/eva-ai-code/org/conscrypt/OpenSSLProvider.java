...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str, boolean z, String str2) {
        ...
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.2", CipherStorageKeystoreAesCbc.ALGORITHM_AES);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", CipherStorageKeystoreAesCbc.ALGORITHM_AES);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", CipherStorageKeystoreAesCbc.ALGORITHM_AES);
        ...
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        put("Alg.Alias.KeyPairGenerator.2.5.8.1.1", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        ...
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        put("Alg.Alias.KeyFactory.2.5.8.1.1", CipherStorageKeystoreRsaEcb.ALGORITHM_RSA);
        ...
        putRSACipherImplClass(CipherStorageKeystoreRsaEcb.TRANSFORMATION_RSA_ECB_PKCS1, "OpenSSLCipherRSA$PKCS1");
        put("Alg.Alias.Cipher.RSA/None/PKCS1Padding", CipherStorageKeystoreRsaEcb.TRANSFORMATION_RSA_ECB_PKCS1);
