...
public class SimpleLog implements Log, Serializable {
    ...
    private static boolean getBooleanProperty(String str, boolean z) {
        String stringProperty = getStringProperty(str);
        return stringProperty == null ? z : ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(stringProperty);
    }
    ...
    public SimpleLog(String str) {
        ...
        if (TtmlNode.COMBINE_ALL.equalsIgnoreCase(stringProperty)) {
            setLevel(0);
        } else if (SpanContext.TYPE.equalsIgnoreCase(stringProperty)) {
            setLevel(1);
