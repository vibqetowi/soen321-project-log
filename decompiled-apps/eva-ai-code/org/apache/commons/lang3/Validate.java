...
public class Validate {
    ...
    public static <T> T notNull(T t, final String str, final Object... objArr) {
        return (T) Platform$$ExternalSyntheticApiModelOutline0.m(t, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda5
    ...
    public static <T> T[] notEmpty(T[] tArr, final String str, final Object... objArr) {
        Platform$$ExternalSyntheticApiModelOutline0.m(tArr, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends Collection<?>> T notEmpty(T t, final String str, final Object... objArr) {
        Platform$$ExternalSyntheticApiModelOutline0.m(t, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends Map<?, ?>> T notEmpty(T t, final String str, final Object... objArr) {
        Platform$$ExternalSyntheticApiModelOutline0.m(t, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends CharSequence> T notEmpty(T t, final String str, final Object... objArr) {
        Platform$$ExternalSyntheticApiModelOutline0.m(t, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static <T extends CharSequence> T notBlank(T t, final String str, final Object... objArr) {
        Platform$$ExternalSyntheticApiModelOutline0.m(t, new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(str, objArr);
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        ...
        objArr[1] = obj == null ? AbstractJsonLexerKt.NULL : obj.getClass().getName();
