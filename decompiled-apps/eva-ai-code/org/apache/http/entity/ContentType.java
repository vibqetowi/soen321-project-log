...
public final class ContentType implements Serializable {
    ...
    static {
        ...
        ContentType create3 = create(HttpHeaders.Values.APPLICATION_JSON, Consts.UTF_8);
        ...
        IMAGE_WEBP = create13;
        ContentType create14 = create(HttpHeaders.Values.MULTIPART_FORM_DATA, Consts.ISO_8859_1);
        MULTIPART_FORM_DATA = create14;
        ContentType create15 = create("text/html", Consts.ISO_8859_1);
        TEXT_HTML = create15;
        ContentType create16 = create("text/plain", Consts.ISO_8859_1);
        TEXT_PLAIN = create16;
