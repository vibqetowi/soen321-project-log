...
public class UriPatternMatcher<T> {
    ...
    public synchronized T lookup(String str) {
        ...
        if (t == null) {
            ...
            for (String str3 : this.map.keySet()) {
                if (matchUriRequestPattern(str3, str) && (str2 == null || str2.length() < str3.length() || (str2.length() == str3.length() && str3.endsWith(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD)))) {
                    t = this.map.get(str3);
                    str2 = str3;
                }
            }
    ...
    protected boolean matchUriRequestPattern(String str, String str2) {
        ...
        if (str.endsWith(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD) && str2.startsWith(str.substring(0, str.length() - 1))) {
            return true;
        }
        return str.startsWith(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD) && str2.endsWith(str.substring(1, str.length()));
    }
