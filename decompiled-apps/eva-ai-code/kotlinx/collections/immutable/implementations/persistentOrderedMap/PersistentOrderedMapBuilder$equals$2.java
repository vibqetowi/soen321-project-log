...
final class PersistentOrderedMapBuilder$equals$2 extends Lambda implements Function2<LinkedValue<V>, ?, Boolean> {
    public static final PersistentOrderedMapBuilder$equals$2 INSTANCE = new PersistentOrderedMapBuilder$equals$2();

    PersistentOrderedMapBuilder$equals$2() {
        super(2);
    }
