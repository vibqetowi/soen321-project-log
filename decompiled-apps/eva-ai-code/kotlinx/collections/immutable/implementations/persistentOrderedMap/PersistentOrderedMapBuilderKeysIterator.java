...
public final class PersistentOrderedMapBuilderKeysIterator<K, V> implements Iterator<K>, KMutableIterator {
    ...
    public K next() {
        this.internal.next();
        return (K) this.internal.getLastIteratedKey$kotlinx_collections_immutable();
    }
