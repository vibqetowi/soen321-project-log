...
final class PersistentOrderedMapBuilder$equals$1 extends Lambda implements Function2<LinkedValue<V>, ?, Boolean> {
    public static final PersistentOrderedMapBuilder$equals$1 INSTANCE = new PersistentOrderedMapBuilder$equals$1();

    PersistentOrderedMapBuilder$equals$1() {
        super(2);
    }
