...
final class PersistentOrderedMap$equals$1 extends Lambda implements Function2<LinkedValue<V>, ?, Boolean> {
    public static final PersistentOrderedMap$equals$1 INSTANCE = new PersistentOrderedMap$equals$1();

    PersistentOrderedMap$equals$1() {
        super(2);
    }
