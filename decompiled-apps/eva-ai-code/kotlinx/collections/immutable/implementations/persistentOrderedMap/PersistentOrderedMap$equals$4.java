...
final class PersistentOrderedMap$equals$4 extends Lambda implements Function2<LinkedValue<V>, ?, Boolean> {
    public static final PersistentOrderedMap$equals$4 INSTANCE = new PersistentOrderedMap$equals$4();

    PersistentOrderedMap$equals$4() {
        super(2);
    }
