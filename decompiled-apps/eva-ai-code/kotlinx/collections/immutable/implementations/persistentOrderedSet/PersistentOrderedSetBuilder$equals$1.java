...
final class PersistentOrderedSetBuilder$equals$1 extends Lambda implements Function2<Links, Links, Boolean> {
    public static final PersistentOrderedSetBuilder$equals$1 INSTANCE = new PersistentOrderedSetBuilder$equals$1();

    PersistentOrderedSetBuilder$equals$1() {
        super(2);
    }
