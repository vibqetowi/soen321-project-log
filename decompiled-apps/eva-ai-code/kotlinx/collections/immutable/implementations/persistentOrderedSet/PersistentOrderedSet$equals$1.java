...
final class PersistentOrderedSet$equals$1 extends Lambda implements Function2<Links, Links, Boolean> {
    public static final PersistentOrderedSet$equals$1 INSTANCE = new PersistentOrderedSet$equals$1();

    PersistentOrderedSet$equals$1() {
        super(2);
    }
