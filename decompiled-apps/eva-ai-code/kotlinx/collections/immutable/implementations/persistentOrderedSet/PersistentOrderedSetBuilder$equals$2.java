...
final class PersistentOrderedSetBuilder$equals$2 extends Lambda implements Function2<Links, Links, Boolean> {
    public static final PersistentOrderedSetBuilder$equals$2 INSTANCE = new PersistentOrderedSetBuilder$equals$2();

    PersistentOrderedSetBuilder$equals$2() {
        super(2);
    }
