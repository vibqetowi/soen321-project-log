...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m8845trySendImplMj0NB7M = conflatedBufferedChannel.m8845trySendImplMj0NB7M(e, true);
        if (m8845trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m8831exceptionOrNullimpl(m8845trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m8845trySendImplMj0NB7M = conflatedBufferedChannel.m8845trySendImplMj0NB7M(e, true);
        if (!(m8845trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m8845trySendImplMj0NB7M;
    ...
    public Object mo8817trySendJP2dKIU(E e) {
        return m8845trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m8845trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8843trySendDropLatestMj0NB7M(e, z) : m8844trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m8843trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo8817trySendJP2dKIU = super.mo8817trySendJP2dKIU(e);
        if (ChannelResult.m8837isSuccessimpl(mo8817trySendJP2dKIU) || ChannelResult.m8835isClosedimpl(mo8817trySendJP2dKIU)) {
            return mo8817trySendJP2dKIU;
        }
    ...
    private final Object m8844trySendDropOldestJP2dKIU(E e) {
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        Object mo8817trySendJP2dKIU = mo8817trySendJP2dKIU(obj);
        if (!(mo8817trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo8817trySendJP2dKIU;
            selectInstance.selectInRegistrationPhase(Unit.INSTANCE);
        } else if (!(mo8817trySendJP2dKIU instanceof ChannelResult.Closed)) {
            throw new IllegalStateException("unreachable".toString());
        } else {
            ChannelResult.m8831exceptionOrNullimpl(mo8817trySendJP2dKIU);
