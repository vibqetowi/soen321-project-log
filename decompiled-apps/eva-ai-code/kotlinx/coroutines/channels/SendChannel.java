...
public interface SendChannel<E> {
    ...
    Object mo8817trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo8817trySendJP2dKIU = sendChannel.mo8817trySendJP2dKIU(e);
            if (ChannelResult.m8837isSuccessimpl(mo8817trySendJP2dKIU)) {
                return true;
            }
            Throwable m8831exceptionOrNullimpl = ChannelResult.m8831exceptionOrNullimpl(mo8817trySendJP2dKIU);
            if (m8831exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m8831exceptionOrNullimpl);
        }
    }
}
