...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m7271constructorimpl = Result.m7271constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m7271constructorimpl = Result.m7271constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m7277isFailureimpl(m7271constructorimpl) ? null : m7271constructorimpl;
