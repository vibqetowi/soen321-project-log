        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m7271constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m7271constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m7271constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m7271constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m7271constructorimpl2 = Result.m7271constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m7271constructorimpl2 = Result.m7271constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m7274exceptionOrNullimpl(m7271constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m7271constructorimpl = Result.m7271constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m7274exceptionOrNullimpl(m7271constructorimpl));
        }
    }
