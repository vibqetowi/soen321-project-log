...
public final class ActivityFilter {
    ...
    public ActivityFilter(ComponentName componentName, String str) {
        ...
        if (StringsKt.contains$default((CharSequence) str3, (CharSequence) WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, false, 2, (Object) null) && StringsKt.indexOf$default((CharSequence) str3, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, 0, false, 6, (Object) null) != className.length() - 1) {
            z = false;
        }
        if (!z) {
