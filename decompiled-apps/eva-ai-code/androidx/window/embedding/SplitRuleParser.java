    ...
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                if (!Intrinsics.areEqual(obj, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD) && StringsKt.indexOf$default((CharSequence) obj, (char) ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null) < 0) {
                    return new ComponentName(str, str + ClassUtils.PACKAGE_SEPARATOR_CHAR + obj);
                }
