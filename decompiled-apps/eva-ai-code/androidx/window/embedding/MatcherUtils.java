    ...
    */
    public final boolean areComponentsMatching$window_release(ComponentName componentName, ComponentName ruleComponent) {
        ...
        if (componentName == null) {
            return Intrinsics.areEqual(ruleComponent.getPackageName(), WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD) && Intrinsics.areEqual(ruleComponent.getClassName(), WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD);
        }
        Intrinsics.checkNotNullExpressionValue(componentName.toString(), "activityComponent.toString()");
        if (!(!StringsKt.contains$default((CharSequence) componentName2, (CharSequence) WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, false, 2, (Object) null))) {
    ...
    private final boolean wildcardMatch(String str, String str2) {
        ...
        if (StringsKt.contains$default((CharSequence) str3, (CharSequence) WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, false, 2, (Object) null)) {
            if (Intrinsics.areEqual(str2, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD)) {
                return true;
            }
            if (!(StringsKt.indexOf$default((CharSequence) str3, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, 0, false, 6, (Object) null) == StringsKt.lastIndexOf$default((CharSequence) str3, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, 0, false, 6, (Object) null) && StringsKt.endsWith$default(str2, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, false, 2, (Object) null))) {
