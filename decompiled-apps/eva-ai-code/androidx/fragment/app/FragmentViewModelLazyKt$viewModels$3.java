...
public final class FragmentViewModelLazyKt$viewModels$3 extends Lambda implements Function0<CreationExtras> {
    ...
    public final CreationExtras invoke() {
        ViewModelStoreOwner m6095viewModels$lambda0;
        CreationExtras defaultViewModelCreationExtras;
        m6095viewModels$lambda0 = FragmentViewModelLazyKt.m6095viewModels$lambda0(this.$owner$delegate);
        HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m6095viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m6095viewModels$lambda0 : null;
