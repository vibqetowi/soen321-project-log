...
final class Dimension$Companion$value$1 extends Lambda implements Function1<State, androidx.constraintlayout.core.state.Dimension> {
    ...
    public final androidx.constraintlayout.core.state.Dimension invoke(State state) {
        ...
        androidx.constraintlayout.core.state.Dimension Fixed = androidx.constraintlayout.core.state.Dimension.Fixed(state.convertDimension(Dp.m5605boximpl(this.$dp)));
