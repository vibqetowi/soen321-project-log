...
public final class ConstraintLayoutBaseScope$createStartBarrier$1 extends Lambda implements Function1<State, Unit> {
    ...
    public ConstraintLayoutBaseScope$createStartBarrier$1(int i, float f, ConstrainedLayoutReference[] constrainedLayoutReferenceArr) {
        super(1);
        this.$id = i;
        this.$margin = f;
