            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.Companion.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m7271constructorimpl = Result.m7271constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m7271constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
