...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5958m(it.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5967m().getName())) {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (Message message : this.mMessages) {
                    Api24Impl.addMessage(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), message.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message message2 : this.mHistoricMessages) {
                        Api26Impl.addHistoricMessage(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), message2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey("time")) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            build = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5958m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5958m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m5986clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m5987clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                Iterator it = parcelableArrayList.iterator();
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5958m(it.next())));
                }
            }
        } else {
