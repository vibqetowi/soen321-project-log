...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6048m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m6048m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m6048m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6049m(windowInsets);
            } else {
                m6048m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m6048m();
            }
            this.mPlatBuilder = m6048m;
        }
