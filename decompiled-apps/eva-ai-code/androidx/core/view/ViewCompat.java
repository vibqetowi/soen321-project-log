...
public class ViewCompat {
    ...
    public static void setOnReceiveContentListener(View view, String[] strArr, OnReceiveContentListener onReceiveContentListener) {
        ...
        if (strArr != null) {
            ...
            while (true) {
                if (i >= length) {
                    break;
                } else if (strArr[i].startsWith(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD)) {
                    z = true;
                    break;
                } else {
                    i++;
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, HalfKt$$ExternalSyntheticApiModelOutline0.m6028m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
