...
public final class BiasAlignment implements Alignment {
    ...
    public long mo2908alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        ...
        float m5767getWidthimpl = (IntSize.m5767getWidthimpl(j2) - IntSize.m5767getWidthimpl(j)) / 2.0f;
        float m5766getHeightimpl = (IntSize.m5766getHeightimpl(j2) - IntSize.m5766getHeightimpl(j)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m5767getWidthimpl * (f + f2)), MathKt.roundToInt(m5766getHeightimpl * (f2 + this.verticalBias)));
    }
