...
public final class AndroidAutofill implements Autofill {
    ...
    public AndroidAutofill(View view, AutofillTree autofillTree) {
        ...
        AutofillManager m12m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(view.getContext().getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m()));
        if (m12m == null) {
            throw new IllegalStateException("Autofill service could not be located.".toString());
        }
        this.autofillManager = m12m;
