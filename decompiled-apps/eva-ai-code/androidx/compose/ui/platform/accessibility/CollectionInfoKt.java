    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m3007boximpl(OffsetKt.Offset(Math.abs(Offset.m3018getXimpl(semanticsNode4.getBoundsInRoot().m3048getCenterF1C5BW0()) - Offset.m3018getXimpl(semanticsNode3.getBoundsInRoot().m3048getCenterF1C5BW0())), Math.abs(Offset.m3019getYimpl(semanticsNode4.getBoundsInRoot().m3048getCenterF1C5BW0()) - Offset.m3019getYimpl(semanticsNode3.getBoundsInRoot().m3048getCenterF1C5BW0())))));
                semanticsNode = semanticsNode2;
            }
        }
        if (emptyList.size() == 1) {
            m3028unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) emptyList)).m3028unboximpl();
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m3007boximpl(Offset.m3023plusMKHz9U(((Offset) first).m3028unboximpl(), ((Offset) emptyList.get(i2)).m3028unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m3028unboximpl = ((Offset) first).m3028unboximpl();
        }
        return Offset.m3009component2impl(m3028unboximpl) < Offset.m3008component1impl(m3028unboximpl);
    }
