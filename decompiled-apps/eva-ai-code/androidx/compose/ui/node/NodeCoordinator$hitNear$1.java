...
public final class NodeCoordinator$hitNear$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        m4755nextUntilhw7D004 = NodeCoordinatorKt.m4755nextUntilhw7D004(this.$this_hitNear, this.$hitTestSource.mo4753entityTypeOLwlOKw(), NodeKind.m4757constructorimpl(2));
        nodeCoordinator.m4732hitNearJHbHoSQ(m4755nextUntilhw7D004, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
