...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long m4679findBestHitDistanceptXAw2c = m4679findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m4674getDistanceimpl(m4679findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m4676isInLayerimpl(m4679findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndInLayer.m4670compareToS_HNhKs(m4679findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }

    /* renamed from: findBestHitDistance-ptXAw2c  reason: not valid java name */
    private final long m4679findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        ...
        if (i <= lastIndex) {
            while (true) {
                long m4671constructorimpl = DistanceAndInLayer.m4671constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m4670compareToS_HNhKs(m4671constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m4671constructorimpl;
                }
                if (DistanceAndInLayer.m4674getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m4676isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final void speculativeHit(Modifier.Node node, float f, boolean z, Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, f, z, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m4670compareToS_HNhKs(m4679findBestHitDistanceptXAw2c, m4679findBestHitDistanceptXAw2c()) > 0) {
