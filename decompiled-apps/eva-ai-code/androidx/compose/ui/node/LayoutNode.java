...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo272measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) mo272measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        /* renamed from: measure-3p2s80s */
        public Void mo272measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4691getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.Companion.m5715getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m4720hasH91voCI$ui_release(NodeKind.m4757constructorimpl(8)) || this._collapsedSemantics != null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:103:0x0027  */
    ...
    */
    public final void attach$ui_release(Owner owner) {
        ...
        int i = 0;
        if ((this.owner == null ? 1 : null) == null) {
        ...
        if (layoutNode2 != null) {
            if (!Intrinsics.areEqual(layoutNode2 != null ? layoutNode2.owner : null, owner)) {
                ...
                if (this.nodes.m4720hasH91voCI$ui_release(NodeKind.m4757constructorimpl(8))) {
    ...
    */
    public final void detach$ui_release() {
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release;
        Owner owner = this.owner;
        if (owner == null) {
        ...
        if (parent$ui_release2 != null) {
            ...
            if (lookaheadPassDelegate$ui_release2 != null) {
                lookaheadPassDelegate$ui_release2.setMeasuredByParent$ui_release(UsageByParent.NotUsed);
            }
        }
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long m4741getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4741getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m5549getHasFixedWidthimpl(m4741getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m5548getHasFixedHeightimpl(m4741getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    */
    private final String debugTreeToString(int i) {
        ...
        if (size <= 0) {
            ...
            if (i != 0) {
                String substring = sb22.substring(0, sb22.length() - 1);
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        @Override // androidx.compose.ui.layout.MeasurePolicy
        public Void minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
        ...
        @Override // androidx.compose.ui.layout.MeasurePolicy
        public Void minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        @Override // androidx.compose.ui.layout.MeasurePolicy
        public Void maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        @Override // androidx.compose.ui.layout.MeasurePolicy
        public Void maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
    ...
    public void setDensity(Density value) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & m4757constructorimpl) != 0) {
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        NodeChain nodeChain = this.nodes;
        int m4757constructorimpl = NodeKind.m4757constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & m4757constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4757constructorimpl) != 0) {
                    Modifier.Node node = head$ui_release;
    ...
    public void setModifier(Modifier value) {
        ...
        this.layoutDelegate.updateParentData();
        if (this.nodes.m4720hasH91voCI$ui_release(NodeKind.m4757constructorimpl(512)) && this.lookaheadRoot == null) {
            setLookaheadRoot(this);
        }
    }
    ...
    public static /* synthetic */ void m4683hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        boolean z3 = z;
        ...
        layoutNode.m4687hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z2);
    }

    /* renamed from: hitTest-M_7yMNQ$ui_release */
    public final void m4687hitTestM_7yMNQ$ui_release(long j, HitTestResult hitTestResult, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        getOuterCoordinator$ui_release().m4744hitTestYqVAtuI(NodeCoordinator.Companion.getPointerInputSource(), getOuterCoordinator$ui_release().m4740fromParentPositionMKHz9U(j), hitTestResult, z, z2);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release */
    public final void m4688hitTestSemanticsM_7yMNQ$ui_release(long j, HitTestResult hitSemanticsEntities, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(hitSemanticsEntities, "hitSemanticsEntities");
        getOuterCoordinator$ui_release().m4744hitTestYqVAtuI(NodeCoordinator.Companion.getSemanticsSource(), getOuterCoordinator$ui_release().m4740fromParentPositionMKHz9U(j), hitSemanticsEntities, true, z2);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4757constructorimpl(1024) | NodeKind.m4757constructorimpl(2048) | NodeKind.m4757constructorimpl(4096))) {
            for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if (((NodeKind.m4757constructorimpl(1024) & head$ui_release.getKindSet$ui_release()) != 0) | ((NodeKind.m4757constructorimpl(2048) & head$ui_release.getKindSet$ui_release()) != 0) | ((NodeKind.m4757constructorimpl(4096) & head$ui_release.getKindSet$ui_release()) != 0)) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int m4757constructorimpl = NodeKind.m4757constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & m4757constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4757constructorimpl) != 0) {
                    Modifier.Node node = head$ui_release;
                    ...
                    while (node != null) {
                        if (node instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4659requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4757constructorimpl(256)));
                        } else if (((node.getKindSet$ui_release() & m4757constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                            int i = 0;
                            for (Modifier.Node delegate$ui_release = ((DelegatingNode) node).getDelegate$ui_release(); delegate$ui_release != null; delegate$ui_release = delegate$ui_release.getChild$ui_release()) {
                                if ((delegate$ui_release.getKindSet$ui_release() & m4757constructorimpl) != 0) {
    ...
    public static /* synthetic */ boolean m4685lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4699getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4689lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release */
    public final boolean m4689lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m4702remeasureBRTryo0(constraints.m5557unboximpl());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default */
    public static /* synthetic */ boolean m4686remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4698getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4690remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release */
    public final boolean m4690remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui_release();
            }
            return getMeasurePassDelegate$ui_release().m4705remeasureBRTryo0(constraints.m5557unboximpl());
        }
        return false;
    }
                ...
                if ((head$ui_release.getKindSet$ui_release() & m4757constructorimpl) != 0) {
                    ...
                    while (node != null) {
                        if (node instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m4659requireCoordinator64DMado((LayoutModifierNode) node, NodeKind.m4757constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if (((node.getKindSet$ui_release() & m4757constructorimpl) != 0) && (node instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints m4698getLastConstraintsDWUhwKw = this.layoutDelegate.m4698getLastConstraintsDWUhwKw();
        if (m4698getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4812measureAndLayout0kLqBqw(this, m4698getLastConstraintsDWUhwKw.m5557unboximpl());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node headNode = innerCoordinator$ui_release.headNode(m4766getIncludeSelfInTraversalH91voCI); headNode != null && (headNode.getAggregateChildKindSet$ui_release() & m4757constructorimpl) != 0; headNode = headNode.getChild$ui_release()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (!this.nodes.m4720hasH91voCI$ui_release(NodeKind.m4757constructorimpl(4)) || this.nodes.m4720hasH91voCI$ui_release(NodeKind.m4757constructorimpl(2))) {
            for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if (((NodeKind.m4757constructorimpl(2) & head$ui_release.getKindSet$ui_release()) != 0) && DelegatableNodeKt.m4659requireCoordinator64DMado(head$ui_release, NodeKind.m4757constructorimpl(2)).getLayer() != null) {
                    return false;
                }
                if ((NodeKind.m4757constructorimpl(4) & head$ui_release.getKindSet$ui_release()) != 0) {
                    return true;
                }
            }
            return true;
