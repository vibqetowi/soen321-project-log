...
public final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        m4755nextUntilhw7D004 = NodeCoordinatorKt.m4755nextUntilhw7D004(this.$this_hit, this.$hitTestSource.mo4753entityTypeOLwlOKw(), NodeKind.m4757constructorimpl(2));
        nodeCoordinator.m4731hit1hIXUjU(m4755nextUntilhw7D004, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}
