...
public final class NodeKindKt {
    ...
    public static final boolean m4765contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m4767or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4757constructorimpl = NodeKind.m4757constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4757constructorimpl |= NodeKind.m4757constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m4757constructorimpl | NodeKind.m4757constructorimpl(131072) : m4757constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if (((NodeKind.m4757constructorimpl(2) & i) != 0) && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m4659requireCoordinator64DMado(node, NodeKind.m4757constructorimpl(2)).onRelease();
                }
            }
            if (((NodeKind.m4757constructorimpl(256) & i) != 0) && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if (((NodeKind.m4757constructorimpl(4) & i) != 0) && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if (((NodeKind.m4757constructorimpl(8) & i) != 0) && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if (((NodeKind.m4757constructorimpl(64) & i) != 0) && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if (((NodeKind.m4757constructorimpl(1024) & i) != 0) && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if (((NodeKind.m4757constructorimpl(2048) & i) != 0) && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if (((i & NodeKind.m4757constructorimpl(4096)) != 0) && (node instanceof FocusEventModifierNode)) {
    ...
    public static final boolean m4766getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4757constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4757constructorimpl | NodeKind.m4757constructorimpl(128) : m4757constructorimpl;
    }
}
