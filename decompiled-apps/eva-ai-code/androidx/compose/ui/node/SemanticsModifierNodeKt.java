...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (node.getNode().isAttached()) {
            if (!z) {
                return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4659requireCoordinator64DMado(node, NodeKind.m4757constructorimpl(8)));
            }
            return DelegatableNodeKt.m4659requireCoordinator64DMado(node, NodeKind.m4757constructorimpl(8)).touchBoundsInRoot();
        }
