...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4545measureBRTryo0(long j) {
            ...
            lookaheadDelegateForLayoutModifierNode.m4603setMeasurementConstraintsBRTryo0(j);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5539boximpl(j);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo500measure3p2s80s(this, lookaheadDelegate, j));
    ...
    /* renamed from: measure-BRTryo0 */
    public Placeable mo4545measureBRTryo0(long j) {
        MeasureResult mo500measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            mo500measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m4547intermediateMeasureTeuZzU(this, wrappedNonNull, j, IntSize, constraints.m5557unboximpl());
        } else {
            mo500measure3p2s80s = layoutModifierNode.mo500measure3p2s80s(this, getWrappedNonNull(), j);
        }
        setMeasureResult$ui_release(mo500measure3p2s80s);
    ...
    public void mo4546placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        int m5767getWidthimpl = IntSize.m5767getWidthimpl(m4600getMeasuredSizeYbymL2g());
        ...
        Placeable.PlacementScope.parentWidth = m5767getWidthimpl;
    ...
    static {
        ...
        Paint.mo3139setColor8_81llA(Color.Companion.m3318getBlue0d7_KjU());
