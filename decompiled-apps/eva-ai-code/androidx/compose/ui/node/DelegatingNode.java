...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    public final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (node != delegatableNode) {
            ...
            if (isAttached()) {
                if ((calculateNodeKindSetFromIncludingDelegates & NodeKind.m4757constructorimpl(2)) != 0) {
                    if (!((kindSet$ui_release & NodeKind.m4757constructorimpl(2)) != 0)) {
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        if (z) {
            ...
            if (isAttached()) {
                if ((kindSet$ui_release & NodeKind.m4757constructorimpl(2)) != 0) {
                    if ((NodeKind.m4757constructorimpl(2) & calculateNodeKindSetFromIncludingDelegates) != 0) {
                        return;
                    }
                    NodeChain nodes$ui_release = DelegatableNodeKt.requireLayoutNode(this).getNodes$ui_release();
                    getNode().updateCoordinator$ui_release(null);
    ...
    private final void validateDelegateKindSet(int i, Modifier.Node node) {
        int kindSet$ui_release = getKindSet$ui_release();
        if ((i & NodeKind.m4757constructorimpl(2)) != 0) {
            if (!((NodeKind.m4757constructorimpl(2) & kindSet$ui_release) != 0) || (this instanceof LayoutModifierNode)) {
                return;
            }
