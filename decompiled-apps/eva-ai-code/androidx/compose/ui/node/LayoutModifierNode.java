...
public interface LayoutModifierNode extends DelegatableNode {
    ...
    MeasureResult mo500measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(final LayoutModifierNode _this, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicWidth$1
                ...
                public final MeasureResult mo4551measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long j) {
                    ...
                    return LayoutModifierNode.this.mo500measure3p2s80s(minWidth, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }

        public static int $default$minIntrinsicHeight(final LayoutModifierNode _this, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicHeight$1
                ...
                public final MeasureResult mo4551measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo500measure3p2s80s(minHeight, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }

        public static int $default$maxIntrinsicWidth(final LayoutModifierNode _this, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicWidth$1
                ...
                public final MeasureResult mo4551measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo500measure3p2s80s(maxWidth, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }

        public static int $default$maxIntrinsicHeight(final LayoutModifierNode _this, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicHeight$1
                ...
                public final MeasureResult mo4551measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long j) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo500measure3p2s80s(maxHeight, intrinsicMeasurable, j);
                }
            }, intrinsicMeasureScope, measurable, i);
        }
    }
