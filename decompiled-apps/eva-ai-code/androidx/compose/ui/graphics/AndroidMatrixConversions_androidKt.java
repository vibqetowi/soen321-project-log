...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m3131setFromtUYjHk(float[] setFrom, android.graphics.Matrix matrix) {
    ...
    */
    public static final void m3130setFromEL8BTi8(android.graphics.Matrix setFrom, float[] matrix) {
        boolean z;
        Intrinsics.checkNotNullParameter(setFrom, "$this$setFrom");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float f = matrix[2];
