...
public final class PaintingStyle {
    ...
    private static final int Fill = m3552constructorimpl(0);
    private static final int Stroke = m3552constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m3551boximpl(int i) {
    ...
    public static boolean m3553equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m3557unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3558getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m3559getStrokeTiuSbCo() {
    ...
    public static String m3556toStringimpl(int i) {
        return m3554equalsimpl0(i, Fill) ? "Fill" : m3554equalsimpl0(i, Stroke) ? "Stroke" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
