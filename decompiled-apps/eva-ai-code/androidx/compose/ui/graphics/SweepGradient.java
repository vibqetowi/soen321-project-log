...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo3260createShaderuvyYCjk(long j) {
        ...
        if (OffsetKt.m3039isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m3097getCenteruvyYCjk(j);
        } else {
            Offset = OffsetKt.Offset((Offset.m3018getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m3018getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m3087getWidthimpl(j) : Offset.m3018getXimpl(this.center), Offset.m3019getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3084getHeightimpl(j) : Offset.m3019getYimpl(this.center));
        }
        return ShaderKt.m3610SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SweepGradient) {
            ...
            return Offset.m3015equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
        }
        return false;
    }

    public int hashCode() {
        int m3020hashCodeimpl = ((Offset.m3020hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m3020hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
