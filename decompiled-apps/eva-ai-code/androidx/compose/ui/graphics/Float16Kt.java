...
public final class Float16Kt {
    ...
    public static final short m3433minAoSsdG0(short s, short s2) {
        if (Float16.m3405isNaNimpl(s) || Float16.m3405isNaNimpl(s2)) {
            return Float16.Companion.m3427getNaNslo4al4();
        }
        return Float16.m3392compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m3432maxAoSsdG0(short s, short s2) {
        if (Float16.m3405isNaNimpl(s) || Float16.m3405isNaNimpl(s2)) {
            return Float16.Companion.m3427getNaNslo4al4();
        }
        return Float16.m3392compareTo41bOqos(s, s2) >= 0 ? s : s2;
