...
public final class VectorPath extends VectorNode {
    ...
    public final int m3944getPathFillTypeRgk1Os() {
    ...
    public final int m3945getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m3946getStrokeLineJoinLxFBmk8() {
        ...
        if (Intrinsics.areEqual(this.name, vectorPath.name) && Intrinsics.areEqual(this.fill, vectorPath.fill)) {
            if ((this.fillAlpha == vectorPath.fillAlpha) && Intrinsics.areEqual(this.stroke, vectorPath.stroke)) {
                if (this.strokeAlpha == vectorPath.strokeAlpha) {
                    if ((this.strokeLineWidth == vectorPath.strokeLineWidth) && StrokeCap.m3640equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) && StrokeJoin.m3650equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
                        if (this.strokeLineMiter == vectorPath.strokeLineMiter) {
                            if (this.trimPathStart == vectorPath.trimPathStart) {
                                if (this.trimPathEnd == vectorPath.trimPathEnd) {
                                    return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m3570equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
                                }
                                return false;
                            }
                            return false;
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.floatToIntBits(this.strokeAlpha)) * 31) + Float.floatToIntBits(this.strokeLineWidth)) * 31) + StrokeCap.m3641hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3651hashCodeimpl(this.strokeLineJoin)) * 31) + Float.floatToIntBits(this.strokeLineMiter)) * 31) + Float.floatToIntBits(this.trimPathStart)) * 31) + Float.floatToIntBits(this.trimPathEnd)) * 31) + Float.floatToIntBits(this.trimPathOffset)) * 31) + PathFillType.m3571hashCodeimpl(this.pathFillType);
    }
}
