...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3948getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m3644getButtKaPHkGw();
        }
        return m3947getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3947getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m3646getSquareKaPHkGw();
            }
    ...
    static /* synthetic */ int m3950getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m3655getMiterLxFBmk8();
        }
        return m3949getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3949getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m3654getBevelLxFBmk8();
            }
    ...
    public static final int parseCurrentVectorNode(AndroidVectorParser androidVectorParser, Resources res, AttributeSet attrs, Resources.Theme theme, ImageVector.Builder builder, int i) {
        ...
        if (eventType == 2) {
            ...
            return i;
        } else if (eventType == 3 && Intrinsics.areEqual("group", androidVectorParser.getXmlParser().getName())) {
            int i2 = i + 1;
        ...
        if (namedFloat <= 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type == 2) {
                    m3327getUnspecified0d7_KjU = Color.Companion.m3327getUnspecified0d7_KjU();
                } else {
                    ...
                    if (namedColorStateList != null) {
                        m3327getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                    } else {
                        m3327getUnspecified0d7_KjU = Color.Companion.m3327getUnspecified0d7_KjU();
                    }
                }
            ...
            long j = m3327getUnspecified0d7_KjU;
            ...
            if (i == -1) {
                m3233getSrcIn0nO6VwU = BlendMode.Companion.m3233getSrcIn0nO6VwU();
            } else if (i == 3) {
                m3233getSrcIn0nO6VwU = BlendMode.Companion.m3235getSrcOver0nO6VwU();
            } else if (i == 5) {
                m3233getSrcIn0nO6VwU = BlendMode.Companion.m3233getSrcIn0nO6VwU();
            } else if (i == 9) {
                m3233getSrcIn0nO6VwU = BlendMode.Companion.m3232getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m3233getSrcIn0nO6VwU = BlendMode.Companion.m3224getModulate0nO6VwU();
                        break;
                    case 15:
                        m3233getSrcIn0nO6VwU = BlendMode.Companion.m3229getScreen0nO6VwU();
                        break;
                    case 16:
                        m3233getSrcIn0nO6VwU = BlendMode.Companion.m3227getPlus0nO6VwU();
                        break;
                    default:
                        m3233getSrcIn0nO6VwU = BlendMode.Companion.m3233getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m3233getSrcIn0nO6VwU;
            float m5607constructorimpl = Dp.m5607constructorimpl(dimension / res.getDisplayMetrics().density);
            float m5607constructorimpl2 = Dp.m5607constructorimpl(dimension2 / res.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m5607constructorimpl, m5607constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
        }
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3947getStrokeLineCapCSYIeUk = m3947getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m3644getButtKaPHkGw());
        int m3949getStrokeLineJoinkLtJ_vA = m3949getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m3654getBevelLxFBmk8());
        ...
        builder.m3927addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m3575getNonZeroRgk1Os() : companion.m3574getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3947getStrokeLineCapCSYIeUk, m3949getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
