...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m5772getZeroYbymL2g();
    ...
    public final void m3921drawCachedImageCJJARo(long j, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5767getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m5766getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m3519ImageBitmapx__hDU$default(IntSize.m5767getWidthimpl(j), IntSize.m5766getHeightimpl(j), 0, false, null, 28, null);
    ...
    public final void drawInto(DrawScope target, float f, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m3831drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, f, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m3842drawRectnJ9OG0$default(drawScope, Color.Companion.m3317getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m3208getClear0nO6VwU(), 62, null);
    }
}
