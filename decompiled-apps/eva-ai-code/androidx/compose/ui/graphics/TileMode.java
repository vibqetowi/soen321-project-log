...
public final class TileMode {
    ...
    private static final int Clamp = m3658constructorimpl(0);
    private static final int Repeated = m3658constructorimpl(1);
    private static final int Mirror = m3658constructorimpl(2);
    private static final int Decal = m3658constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TileMode m3657boximpl(int i) {
    ...
    public static boolean m3659equalsimpl(int i, Object obj) {
        return (obj instanceof TileMode) && i == ((TileMode) obj).m3663unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3664getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0  reason: not valid java name */
        public final int m3667getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0  reason: not valid java name */
        public final int m3666getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0  reason: not valid java name */
        public final int m3665getDecal3opZhB0() {
    ...
    public static String m3662toStringimpl(int i) {
        return m3660equalsimpl0(i, Clamp) ? "Clamp" : m3660equalsimpl0(i, Repeated) ? "Repeated" : m3660equalsimpl0(i, Mirror) ? "Mirror" : m3660equalsimpl0(i, Decal) ? "Decal" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
