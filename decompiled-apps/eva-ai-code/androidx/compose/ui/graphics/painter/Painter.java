...
public abstract class Painter {
    ...
    public abstract long mo3914getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3919drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3920drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0  reason: not valid java name */
    public final void m3920drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m3087getWidthimpl = Size.m3087getWidthimpl(draw.mo3762getSizeNHjbRc()) - Size.m3087getWidthimpl(j);
        float m3084getHeightimpl = Size.m3084getHeightimpl(draw.mo3762getSizeNHjbRc()) - Size.m3084getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m3087getWidthimpl, m3084getHeightimpl);
        if (f > 0.0f && Size.m3087getWidthimpl(j) > 0.0f && Size.m3084getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m3058Recttz77jQw = RectKt.m3058Recttz77jQw(Offset.Companion.m3034getZeroF1C5BW0(), SizeKt.Size(Size.m3087getWidthimpl(j), Size.m3084getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m3058Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
