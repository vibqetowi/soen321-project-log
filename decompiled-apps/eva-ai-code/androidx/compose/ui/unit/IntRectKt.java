...
public final class IntRectKt {
    ...
    public static final IntRect m5757IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m5725getXimpl(j), IntOffset.m5726getYimpl(j), IntOffset.m5725getXimpl(j) + IntSize.m5767getWidthimpl(j2), IntOffset.m5726getYimpl(j) + IntSize.m5766getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m5756IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m5725getXimpl(j), IntOffset.m5726getYimpl(j), IntOffset.m5725getXimpl(j2), IntOffset.m5726getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m5758IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m5725getXimpl(j) - i, IntOffset.m5726getYimpl(j) - i, IntOffset.m5725getXimpl(j) + i, IntOffset.m5726getYimpl(j) + i);
    }
