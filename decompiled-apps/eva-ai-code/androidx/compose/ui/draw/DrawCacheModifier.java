...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0006À\u0006\u0003"}, d2 = {"Landroidx/compose/ui/draw/DrawCacheModifier;", "Landroidx/compose/ui/draw/DrawModifier;", "onBuildCache", "", NativeProtocol.WEB_DIALOG_PARAMS, "Landroidx/compose/ui/draw/BuildDrawCacheParams;", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public interface DrawCacheModifier extends DrawModifier {
    ...
    public static final class DefaultImpls {
        ...
        public static boolean all(DrawCacheModifier drawCacheModifier, Function1<? super Modifier.Element, Boolean> predicate) {
            ...
            return Modifier.Element.CC.$default$all(drawCacheModifier, predicate);
        }

        @Deprecated
        public static boolean any(DrawCacheModifier drawCacheModifier, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$any(drawCacheModifier, predicate);
        }
        ...
        public static Modifier then(DrawCacheModifier drawCacheModifier, Modifier other) {
            ...
            return Modifier.CC.$default$then(drawCacheModifier, other);
        }
    }
}
