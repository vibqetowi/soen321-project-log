    ...
    public final MeasureResult mo272measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size != 0) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.CC.layout$default(Layout, mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight(), null, new AndroidPopup_androidKt$SimpleStack$1$measure$2(mo4545measureBRTryo0), 4, null);
            }
            ...
            return MeasureScope.CC.layout$default(Layout, i, i2, null, new AndroidPopup_androidKt$SimpleStack$1$measure$3(arrayList2), 4, null);
        }
        return MeasureScope.CC.layout$default(Layout, 0, 0, null, AndroidPopup_androidKt$SimpleStack$1$measure$1.INSTANCE, 4, null);
    }
}
