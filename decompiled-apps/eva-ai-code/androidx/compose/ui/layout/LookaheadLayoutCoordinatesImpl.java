...
public final class LookaheadLayoutCoordinatesImpl implements LookaheadLayoutCoordinates {
    ...
    public long mo4552getSizeYbymL2g() {
    ...
    private final long m4569getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3022minusMKHz9U(mo4553localPositionOfR5De75A(rootLookaheadDelegate.getCoordinates(), Offset.Companion.m3034getZeroF1C5BW0()), getCoordinator().mo4553localPositionOfR5De75A(rootLookaheadDelegate.getCoordinator(), Offset.Companion.m3034getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo4557windowToLocalMKHz9U(long j) {
        return Offset.m3023plusMKHz9U(getCoordinator().mo4557windowToLocalMKHz9U(j), m4569getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo4555localToWindowMKHz9U(long j) {
        return getCoordinator().mo4555localToWindowMKHz9U(Offset.m3023plusMKHz9U(j, m4569getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo4554localToRootMKHz9U(long j) {
        return getCoordinator().mo4554localToRootMKHz9U(Offset.m3023plusMKHz9U(j, m4569getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo4553localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long j) {
        ...
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            ...
            if (lookaheadDelegate2 != null) {
                long m4709positionInBjo55l4$ui_release = lookaheadDelegate.m4709positionInBjo55l4$ui_release(lookaheadDelegate2);
                long IntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m3018getXimpl(j)), MathKt.roundToInt(Offset.m3019getYimpl(j)));
                long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(m4709positionInBjo55l4$ui_release) + IntOffset.m5725getXimpl(IntOffset), IntOffset.m5726getYimpl(m4709positionInBjo55l4$ui_release) + IntOffset.m5726getYimpl(IntOffset));
                long m4709positionInBjo55l4$ui_release2 = this.lookaheadDelegate.m4709positionInBjo55l4$ui_release(lookaheadDelegate2);
                long IntOffset3 = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(IntOffset2) - IntOffset.m5725getXimpl(m4709positionInBjo55l4$ui_release2), IntOffset.m5726getYimpl(IntOffset2) - IntOffset.m5726getYimpl(m4709positionInBjo55l4$ui_release2));
                return OffsetKt.Offset(IntOffset.m5725getXimpl(IntOffset3), IntOffset.m5726getYimpl(IntOffset3));
            }
            LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate);
            long m4709positionInBjo55l4$ui_release3 = lookaheadDelegate.m4709positionInBjo55l4$ui_release(rootLookaheadDelegate);
            long mo4706getPositionnOccac = rootLookaheadDelegate.mo4706getPositionnOccac();
            long IntOffset4 = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(m4709positionInBjo55l4$ui_release3) + IntOffset.m5725getXimpl(mo4706getPositionnOccac), IntOffset.m5726getYimpl(m4709positionInBjo55l4$ui_release3) + IntOffset.m5726getYimpl(mo4706getPositionnOccac));
            long IntOffset5 = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m3018getXimpl(j)), MathKt.roundToInt(Offset.m3019getYimpl(j)));
            ...
            long m4709positionInBjo55l4$ui_release4 = lookaheadDelegate3.m4709positionInBjo55l4$ui_release(LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate3));
            long mo4706getPositionnOccac2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate3).mo4706getPositionnOccac();
            long IntOffset7 = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(m4709positionInBjo55l4$ui_release4) + IntOffset.m5725getXimpl(mo4706getPositionnOccac2), IntOffset.m5726getYimpl(m4709positionInBjo55l4$ui_release4) + IntOffset.m5726getYimpl(mo4706getPositionnOccac2));
            long IntOffset8 = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(IntOffset6) - IntOffset.m5725getXimpl(IntOffset7), IntOffset.m5726getYimpl(IntOffset6) - IntOffset.m5726getYimpl(IntOffset7));
            ...
            return wrappedBy$ui_release.mo4553localPositionOfR5De75A(wrappedBy$ui_release2, OffsetKt.Offset(IntOffset.m5725getXimpl(IntOffset8), IntOffset.m5726getYimpl(IntOffset8)));
        }
        LookaheadDelegate rootLookaheadDelegate2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3023plusMKHz9U(mo4553localPositionOfR5De75A(rootLookaheadDelegate2.getLookaheadLayoutCoordinates(), j), rootLookaheadDelegate2.getCoordinator().getCoordinates().mo4553localPositionOfR5De75A(sourceCoordinates, Offset.Companion.m3034getZeroF1C5BW0()));
    }
    ...
    public void mo4556transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        getCoordinator().mo4556transformFromEL8BTi8(sourceCoordinates, matrix);
    }
