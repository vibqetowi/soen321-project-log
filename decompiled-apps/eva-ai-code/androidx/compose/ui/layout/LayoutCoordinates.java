...
public interface LayoutCoordinates {
    ...
    long mo4553localPositionOfR5De75A(LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    long mo4554localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    long mo4555localToWindowMKHz9U(long j);

    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    void mo4556transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, float[] fArr);

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    long mo4557windowToLocalMKHz9U(long j);
    ...
    public final /* synthetic */ class CC {
        ...
        public static void m4558$default$transformFromEL8BTi8(LayoutCoordinates _this, LayoutCoordinates sourceCoordinates, float[] matrix) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
        public static void m4560transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            CC.m4558$default$transformFromEL8BTi8(layoutCoordinates, sourceCoordinates, matrix);
        }
    }
}
