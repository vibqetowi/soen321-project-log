...
final class TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo272measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
        ...
        return MeasureScope.CC.layout$default(MeasurePolicy, Constraints.m5551getMaxWidthimpl(j), Constraints.m5550getMaxHeightimpl(j), null, TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$measure$1.INSTANCE, 4, null);
    }
}
