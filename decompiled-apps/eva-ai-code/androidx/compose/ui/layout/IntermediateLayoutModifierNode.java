...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (lookaheadRoot$ui_release != null && lookaheadRoot$ui_release.isVirtualLookaheadRoot$ui_release()) {
            ...
            int m4757constructorimpl = NodeKind.m4757constructorimpl(512);
    ...
    public MeasureResult mo500measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight(), null, new IntermediateLayoutModifierNode$measure$1$1(mo4545measureBRTryo0), 4, null);
    }

    /* renamed from: intermediateMeasure-Te-uZzU  reason: not valid java name */
    public final MeasureResult m4547intermediateMeasureTeuZzU(MeasureScope intermediateMeasure, Measurable measurable, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m4550setLookaheadSizeozmzZPI(j2);
        this.lookaheadConstraints = Constraints.m5539boximpl(j3);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, intermediateMeasurablePlaceable, Constraints.m5539boximpl(j));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4551measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long j) {
                Intrinsics.checkNotNullParameter(minWidth, "$this$minWidth");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m5539boximpl(j));
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4551measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long j) {
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4551measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long j) {
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo4551measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long j) {
    ...
    public final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo4545measureBRTryo0(long j) {
            ...
            long mo4548getLookaheadSizeYbymL2g;
            if (this.this$0.isIntermediateChangeActive()) {
                mo4545measureBRTryo0 = this.wrappedMeasurable.mo4545measureBRTryo0(j);
                m4603setMeasurementConstraintsBRTryo0(j);
                m4602setMeasuredSizeozmzZPI(IntSizeKt.IntSize(mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight()));
            } else {
                Measurable measurable = this.wrappedMeasurable;
                Constraints constraints = this.this$0.lookaheadConstraints;
                Intrinsics.checkNotNull(constraints);
                mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(constraints.m5557unboximpl());
                ...
                m4603setMeasurementConstraintsBRTryo0(constraints2.m5557unboximpl());
                if (!intermediateLayoutModifierNode.isIntermediateChangeActive()) {
                    mo4548getLookaheadSizeYbymL2g = intermediateLayoutModifierNode.intermediateMeasureScope.mo4548getLookaheadSizeYbymL2g();
                } else {
                    mo4548getLookaheadSizeYbymL2g = IntSizeKt.IntSize(mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight());
                }
                m4602setMeasuredSizeozmzZPI(mo4548getLookaheadSizeYbymL2g);
            }
            this.wrappedPlaceable = mo4545measureBRTryo0;
            return this;
        }
        ...
        public void mo4546placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            Unit unit;
            if (!this.this$0.isIntermediateChangeActive()) {
                j = IntOffset.Companion.m5735getZeronOccac();
            }
            if (function1 != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.Companion.m4613placeWithLayeraW9wM(placeable, j, f, function1);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.Companion.m4608place70tqf50(placeable2, j, f);
    ...
    public final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        ...
        public MeasureResult layout(final int i, final int i2, final Map<AlignmentLine, Integer> alignmentLines, final Function1<? super Placeable.PlacementScope, Unit> placementBlock) {
