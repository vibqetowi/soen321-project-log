...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo272measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.CC.layout$default(measure, Constraints.m5553getMinWidthimpl(j), Constraints.m5552getMinHeightimpl(j), null, AndroidViewHolder$layoutNode$1$5$measure$1.INSTANCE, 4, null);
                }
                if (Constraints.m5553getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m5553getMinWidthimpl(j));
                }
                if (Constraints.m5552getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m5552getMinHeightimpl(j));
                }
                ...
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m5553getMinWidthimpl, m5551getMaxWidthimpl, layoutParams.width);
                ...
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m5552getMinHeightimpl, m5550getMaxHeightimpl, layoutParams2.height);
                androidViewHolder.measure(obtainMeasureSpec, obtainMeasureSpec2);
                return MeasureScope.CC.layout$default(measure, AndroidViewHolder.this.getMeasuredWidth(), AndroidViewHolder.this.getMeasuredHeight(), null, new AndroidViewHolder$layoutNode$1$5$measure$2(AndroidViewHolder.this, layoutNode), 4, null);
            }
    ...
    public void onNestedScroll(View target, int i, int i2, int i3, int i4, int i5, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            long m4311dispatchPostScrollDzOQY0M = this.dispatcher.m4311dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i), AndroidViewHolder_androidKt.access$toComposeOffset(i2)), OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i3), AndroidViewHolder_androidKt.access$toComposeOffset(i4)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i5));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3018getXimpl(m4311dispatchPostScrollDzOQY0M));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3019getYimpl(m4311dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(View target, int i, int i2, int i3, int i4, int i5) {
        Intrinsics.checkNotNullParameter(target, "target");
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m4311dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i), AndroidViewHolder_androidKt.access$toComposeOffset(i2)), OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i3), AndroidViewHolder_androidKt.access$toComposeOffset(i4)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i5));
        }
    }
    ...
    public void onNestedPreScroll(View target, int i, int i2, int[] consumed, int i3) {
        ...
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        if (isNestedScrollingEnabled()) {
            long m4313dispatchPreScrollOzD1aCk = this.dispatcher.m4313dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i), AndroidViewHolder_androidKt.access$toComposeOffset(i2)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i3));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3018getXimpl(m4313dispatchPreScrollOzD1aCk));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3019getYimpl(m4313dispatchPreScrollOzD1aCk));
        }
    }
