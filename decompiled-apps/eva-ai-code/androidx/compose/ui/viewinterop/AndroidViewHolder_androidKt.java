...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int roundToInt = MathKt.roundToInt(Offset.m3018getXimpl(positionInRoot));
        int roundToInt2 = MathKt.roundToInt(Offset.m3019getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.Companion.m4322getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m4323getFlingWNlRxjI();
    }
}
