...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2908alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5767getWidthimpl(j2) - IntSize.m5767getWidthimpl(j), IntSize.m5766getHeightimpl(j2) - IntSize.m5766getHeightimpl(j));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5767getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5766getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
