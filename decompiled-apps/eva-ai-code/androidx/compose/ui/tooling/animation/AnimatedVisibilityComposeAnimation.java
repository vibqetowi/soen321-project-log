...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String str) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m5530boximpl(AnimatedVisibilityState.Companion.m5537getEnterjXw82LU()), AnimatedVisibilityState.m5530boximpl(AnimatedVisibilityState.Companion.m5538getExitjXw82LU())});
    }

    /* renamed from: getAnimationObject */
    public Transition<Boolean> m5524getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m5524getAnimationObject().getTransitions(), 0);
