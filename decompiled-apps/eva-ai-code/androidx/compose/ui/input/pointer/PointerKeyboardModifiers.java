...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m4488boximpl(int i) {
        return new PointerKeyboardModifiers(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4489constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4490equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).m4494unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4490equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4492hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4493toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m4494unboximpl() {
