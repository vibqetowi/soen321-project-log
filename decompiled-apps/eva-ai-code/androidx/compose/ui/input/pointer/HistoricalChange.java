...
public final class HistoricalChange {
    ...
    public final long m4354getPositionF1C5BW0() {
        return this.position;
    }

    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m3026toStringimpl(this.position)) + ')';
    }
}
