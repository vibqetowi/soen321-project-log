...
public final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m4406boximpl(pointerInputEventData.m4439getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo4508screenToLocalMKHz9U = pointerInputEventData.m4440getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo4508screenToLocalMKHz9U = positionCalculator.mo4508screenToLocalMKHz9U(pointerInputData.m4430getPositionOnScreenF1C5BW0());
            }
            linkedHashMap.put(PointerId.m4406boximpl(pointerInputEventData.m4439getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m4439getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m4440getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo4508screenToLocalMKHz9U, down, false, pointerInputEventData.m4443getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m4442getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m4406boximpl(pointerInputEventData.m4439getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m4441getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m4443getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m4406boximpl(pointerInputEventData.m4439getIdJ3iCeTQ()));
            }
        }
    ...
    private static final class PointerInputData {
        ...
        public final long m4430getPositionOnScreenF1C5BW0() {
        ...
        public final int m4431getTypeT8wyACA() {
            return this.type;
        }
    }
}
