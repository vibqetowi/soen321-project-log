...
public final class PointerType {
    ...
    private static final int Touch = m4496constructorimpl(1);
    private static final int Mouse = m4496constructorimpl(2);
    private static final int Stylus = m4496constructorimpl(3);
    private static final int Eraser = m4496constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointerType m4495boximpl(int i) {
    ...
    public static boolean m4497equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).m4501unboximpl();
    }
