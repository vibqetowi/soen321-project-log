...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m4360constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m4489constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4366calculatePointerEventType7fucELk();
    }
    ...
    public final int m4367getButtonsry648PA() {
        return this.buttons;
    }

    /* renamed from: getKeyboardModifiers-k7X9c1A  reason: not valid java name */
    public final int m4368getKeyboardModifiersk7X9c1A() {
        return this.keyboardModifiers;
    }

    /* renamed from: getType-7fucELk  reason: not valid java name */
    public final int m4369getType7fucELk() {
        return this.type;
    }

    /* renamed from: setType-EhbLWgg$ui_release  reason: not valid java name */
    public final void m4370setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk  reason: not valid java name */
    private final int m4366calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.Companion.m4385getScroll7fucELk();
                            case 9:
                                return PointerEventType.Companion.m4380getEnter7fucELk();
                            case 10:
                                return PointerEventType.Companion.m4381getExit7fucELk();
                            default:
                                return PointerEventType.Companion.m4386getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.Companion.m4382getMove7fucELk();
                }
                return PointerEventType.Companion.m4384getRelease7fucELk();
            }
            return PointerEventType.Companion.m4383getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m4406boximpl(pointerInputChange.m4425getIdJ3iCeTQ()), pointerInputChange);
            ArrayList arrayList2 = arrayList;
            long m4425getIdJ3iCeTQ = pointerInputChange.m4425getIdJ3iCeTQ();
            long uptimeMillis = pointerInputChange.getUptimeMillis();
            long m4426getPositionF1C5BW0 = pointerInputChange.m4426getPositionF1C5BW0();
            long m4426getPositionF1C5BW02 = pointerInputChange.m4426getPositionF1C5BW0();
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m4356issuesEnterExitEvent0FcD4WY(pointerInputChange.m4425getIdJ3iCeTQ())) {
                    arrayList2.add(new PointerInputEventData(m4425getIdJ3iCeTQ, uptimeMillis, m4426getPositionF1C5BW0, m4426getPositionF1C5BW02, pressed, pressure, m4429getTypeT8wyACA, z, null, 0L, ViewUtils.EDGE_TO_EDGE_FLAGS, null));
                    i = i2 + 1;
                }
            }
            z = false;
