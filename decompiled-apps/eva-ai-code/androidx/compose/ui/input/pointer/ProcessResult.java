...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m4509boximpl(int i) {
    ...
    public static boolean m4511equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).m4517unboximpl();
    }
    ...
    public static final boolean m4513getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl  reason: not valid java name */
    public static final boolean m4514getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4515hashCodeimpl(int i) {
        return i;
    }
    ...
    public final /* synthetic */ int m4517unboximpl() {
        return this.value;
    }
