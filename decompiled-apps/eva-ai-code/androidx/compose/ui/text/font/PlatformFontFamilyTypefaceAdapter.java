...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo5328getNativeTypefacePYhJU0U;
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            mo5328getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5227createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo5328getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5228createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA());
            ...
            mo5328getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo5328getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA(), typefaceRequest.m5246getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo5328getNativeTypefacePYhJU0U, false, 2, null);
    }
}
