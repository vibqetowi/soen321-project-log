...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m5195getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo5229optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo5156getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeviceFontFamilyNameFont) {
            ...
            return DeviceFontFamilyName.m5169equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m5202equalsimpl0(mo5156getStyle_LCdwA(), deviceFontFamilyNameFont.mo5156getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
        }
        return false;
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m5170hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m5203hashCodeimpl(mo5156getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m5171toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m5204toStringimpl(mo5156getStyle_LCdwA())) + ')';
    }
}
