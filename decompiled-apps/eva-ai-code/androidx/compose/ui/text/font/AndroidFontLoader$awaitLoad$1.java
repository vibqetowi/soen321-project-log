...
@DebugMetadata(c = "androidx.compose.ui.text.font.AndroidFontLoader", f = "AndroidFontLoader.android.kt", i = {1, 1}, l = {LockFreeTaskQueueCore.CLOSED_SHIFT, SSL.SSL_PROTOCOL_TLS}, m = "awaitLoad", n = {"this", "font"}, s = {"L$0", "L$1"})
