    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!FontLoadingStrategy.m5189equalsimpl0(mo5146getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m5194getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m5189equalsimpl0(mo5146getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m5195getOptionalLocalPKNRLFQ())) {
                    if (FontLoadingStrategy.m5189equalsimpl0(mo5146getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m5193getAsyncPKNRLFQ())) {
                        AsyncTypefaceCache.AsyncTypefaceResult m5157get1ASDuI8 = asyncTypefaceCache.m5157get1ASDuI8(font, platformFontLoader);
                        if (m5157get1ASDuI8 == null) {
                            if (list2 == null) {
                                list2 = CollectionsKt.mutableListOf(font);
                            } else {
                                list2.add(font);
                            }
                        } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m5163isPermanentFailureimpl(m5157get1ASDuI8.m5165unboximpl()) && m5157get1ASDuI8.m5165unboximpl() != null) {
                            return TuplesKt.to(list2, FontSynthesis_androidKt.m5221synthesizeTypefaceFxwP2eA(typefaceRequest.m5246getFontSynthesisGVVA2EU(), m5157get1ASDuI8.m5165unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA()));
                        }
                    } else {
                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            m7271constructorimpl = asyncTypefaceResult.m5165unboximpl();
                        } else {
                            Unit unit = Unit.INSTANCE;
                            try {
                                Result.Companion companion = Result.Companion;
                                m7271constructorimpl = Result.m7271constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                            ...
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, m7271constructorimpl, false, 8, null);
                        }
                    }
                    if (m7271constructorimpl != null) {
                        return TuplesKt.to(list2, FontSynthesis_androidKt.m5221synthesizeTypefaceFxwP2eA(typefaceRequest.m5246getFontSynthesisGVVA2EU(), m7271constructorimpl, font, typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA()));
                    }
                }
            } else {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult2 != null) {
                        loadBlocking = asyncTypefaceResult2.m5165unboximpl();
                    } else {
                ...
                return TuplesKt.to(list2, FontSynthesis_androidKt.m5221synthesizeTypefaceFxwP2eA(typefaceRequest.m5246getFontSynthesisGVVA2EU(), loadBlocking, font, typefaceRequest.getFontWeight(), typefaceRequest.m5245getFontStyle_LCdwA()));
            }
        }
