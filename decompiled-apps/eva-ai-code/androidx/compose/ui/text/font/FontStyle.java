...
public final class FontStyle {
    ...
    private static final int Normal = m5200constructorimpl(0);
    private static final int Italic = m5200constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FontStyle m5199boximpl(int i) {
    ...
    public static boolean m5201equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m5205unboximpl();
    }
    ...
    public static String m5204toStringimpl(int i) {
        return m5202equalsimpl0(i, Normal) ? "Normal" : m5202equalsimpl0(i, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m5207getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA  reason: not valid java name */
        public final int m5206getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m5199boximpl(m5207getNormal_LCdwA()), FontStyle.m5199boximpl(m5206getItalic_LCdwA())});
        }
    }
}
