...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int mo5156getStyle_LCdwA() {
        return this.style;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private AndroidPreloadedFont(FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m5194getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, null);
