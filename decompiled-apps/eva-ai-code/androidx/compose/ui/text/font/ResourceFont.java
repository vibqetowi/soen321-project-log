...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m5238getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    */
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, r2, r3, (i4 & 8) != 0 ? FontVariation.INSTANCE.m5222Settings6EWAqTQ(r2, r3, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.Companion.m5193getAsyncPKNRLFQ() : i3, null);
        FontWeight normal = (i4 & 2) != 0 ? FontWeight.Companion.getNormal() : fontWeight;
        int m5207getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.Companion.m5207getNormal_LCdwA() : i2;
    }
    ...
    public int mo5156getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int mo5146getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m5237copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.mo5156getStyle_LCdwA();
        }
        return resourceFont.m5240copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m5240copyRetOiIg(int i, FontWeight weight, int i2) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m5236copyF3nL8kk$default(this, i, weight, i2, mo5146getLoadingStrategyPKNRLFQ(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m5236copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        if ((i4 & 8) != 0) {
            i3 = resourceFont.mo5146getLoadingStrategyPKNRLFQ();
        }
        int i6 = i3;
        if ((i4 & 16) != 0) {
            settings = resourceFont.variationSettings;
        }
        return resourceFont.m5239copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m5239copyF3nL8kk(int i, FontWeight weight, int i2, int i3, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        Intrinsics.checkNotNullParameter(variationSettings, "variationSettings");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceFont) {
            ...
            return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m5202equalsimpl0(mo5156getStyle_LCdwA(), resourceFont.mo5156getStyle_LCdwA()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m5189equalsimpl0(mo5146getLoadingStrategyPKNRLFQ(), resourceFont.mo5146getLoadingStrategyPKNRLFQ());
        }
        return false;
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m5203hashCodeimpl(mo5156getStyle_LCdwA())) * 31) + FontLoadingStrategy.m5190hashCodeimpl(mo5146getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m5204toStringimpl(mo5156getStyle_LCdwA())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m5191toStringimpl(mo5146getLoadingStrategyPKNRLFQ())) + ')';
    }
}
