...
final class SaversKt$ShadowSaver$1 extends Lambda implements Function2<SaverScope, Shadow, Object> {
    ...
    public final Object invoke(SaverScope Saver, Shadow it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m3281boximpl(it.m3616getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(Offset.m3007boximpl(it.m3617getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
    }
}
