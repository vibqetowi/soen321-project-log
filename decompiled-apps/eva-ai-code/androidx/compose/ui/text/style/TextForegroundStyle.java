...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        public static TextForegroundStyle $default$merge(TextForegroundStyle _this, TextForegroundStyle other) {
            float takeOrElse;
            Intrinsics.checkNotNullParameter(other, "other");
            boolean z = other instanceof BrushStyle;
            if (!z || !(_this instanceof BrushStyle)) {
                return (!z || (_this instanceof BrushStyle)) ? (z || !(_this instanceof BrushStyle)) ? other.takeOrElse(new TextForegroundStyle$merge$2(_this)) : _this : other;
            }
            ShaderBrush value = ((BrushStyle) other).getValue();
            takeOrElse = TextDrawStyleKt.takeOrElse(other.getAlpha(), new TextForegroundStyle$merge$1(_this));
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo5376getColor0d7_KjU() {
            return Color.Companion.m3327getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m5488from8_81llA(TextDrawStyleKt.m5487modulateDxMtmZc(((SolidColor) brush).m3626getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m5488from8_81llA(long j) {
            return (j > Color.Companion.m3327getUnspecified0d7_KjU() ? 1 : (j == Color.Companion.m3327getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(j, null) : Unspecified.INSTANCE;
        }
    }
}
