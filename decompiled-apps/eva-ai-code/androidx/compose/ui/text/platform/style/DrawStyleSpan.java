...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(m5359toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3909getJoinLxFBmk8()));
                textPaint.setStrokeCap(m5358toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3908getCapKaPHkGw()));
    ...
    private final Paint.Join m5359toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m3650equalsimpl0(i, StrokeJoin.Companion.m3655getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3650equalsimpl0(i, StrokeJoin.Companion.m3656getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3650equalsimpl0(i, StrokeJoin.Companion.m3654getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE  reason: not valid java name */
    private final Paint.Cap m5358toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m3640equalsimpl0(i, StrokeCap.Companion.m3644getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3640equalsimpl0(i, StrokeCap.Companion.m3645getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3640equalsimpl0(i, StrokeCap.Companion.m3646getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
