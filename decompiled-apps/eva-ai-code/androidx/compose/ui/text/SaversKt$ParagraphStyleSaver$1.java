...
final class SaversKt$ParagraphStyleSaver$1 extends Lambda implements Function2<SaverScope, ParagraphStyle, Object> {
    ...
    public final Object invoke(SaverScope Saver, ParagraphStyle it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(it.m4997getTextAlignbuA522U()), SaversKt.save(it.m4999getTextDirectionmmuk1to()), SaversKt.save(TextUnit.m5778boximpl(it.m4996getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), Saver));
    }
}
