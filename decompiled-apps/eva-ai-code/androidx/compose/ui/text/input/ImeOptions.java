...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.Companion.m5292getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.Companion.m5318getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.Companion.m5265getDefaulteUduSuo() : i3, null);
    }

    /* renamed from: getCapitalization-IUNYP9k  reason: not valid java name */
    public final int m5275getCapitalizationIUNYP9k() {
    ...
    public final int m5277getKeyboardTypePjHm6EE() {
    ...
    public static /* synthetic */ ImeOptions m5273copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m5274copyuxg59PA(z, i5, z3, i6, i3);
    }

    /* renamed from: copy-uxg59PA  reason: not valid java name */
    public final ImeOptions m5274copyuxg59PA(boolean z, int i, boolean z2, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImeOptions) {
            ...
            return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m5283equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m5298equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m5253equalsimpl0(this.imeAction, imeOptions.imeAction);
        }
        return false;
    }

    public int hashCode() {
        return (((((((UByte$$ExternalSyntheticBackport0.m(this.singleLine) * 31) + KeyboardCapitalization.m5284hashCodeimpl(this.capitalization)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m5299hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5254hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m5285toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m5300toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m5255toStringimpl(this.imeAction)) + ')';
    }
}
