...
public final class JvmAnnotatedString_jvmKt {
    public static final AnnotatedString transform(AnnotatedString annotatedString, Function3<? super String, ? super Integer, ? super Integer, String> transform) {
        ArrayList arrayList;
        ...
        CollectionsKt.windowed$default(sortedSetOf, 2, 0, false, new JvmAnnotatedString_jvmKt$transform$1(objectRef, transform, annotatedString, mutableMapOf), 6, null);
