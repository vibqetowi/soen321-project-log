...
public final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        ...
        return FontFamily.Resolver.CC.m5177resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.mo5156getStyle_LCdwA(), 0, 8, null).getValue();
    }
