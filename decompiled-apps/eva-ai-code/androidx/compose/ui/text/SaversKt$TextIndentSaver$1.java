...
final class SaversKt$TextIndentSaver$1 extends Lambda implements Function2<SaverScope, TextIndent, Object> {
    ...
    public final Object invoke(SaverScope Saver, TextIndent it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m5778boximpl(it.m5491getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(TextUnit.m5778boximpl(it.m5492getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver));
    }
}
