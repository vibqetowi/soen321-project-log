...
final class EnterExitTransitionKt$shrinkVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m5759boximpl(m314invokemzRDjE0(intSize.m5771unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m314invokemzRDjE0(long j) {
        return IntSizeKt.IntSize(IntSize.m5767getWidthimpl(j), this.$targetHeight.invoke(Integer.valueOf(IntSize.m5766getHeightimpl(j))).intValue());
    }
}
