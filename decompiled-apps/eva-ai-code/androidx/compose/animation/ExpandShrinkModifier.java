...
public final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m319sizeByStateUzc_VyU(EnterExitState targetState, long j) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize value = this.expand.getValue();
        long m5771unboximpl = value != null ? value.getSize().invoke(IntSize.m5759boximpl(j)).m5771unboximpl() : j;
        ChangeSize value2 = this.shrink.getValue();
        long m5771unboximpl2 = value2 != null ? value2.getSize().invoke(IntSize.m5759boximpl(j)).m5771unboximpl() : j;
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return m5771unboximpl2;
                }
                throw new NoWhenBranchMatchedException();
            }
            return m5771unboximpl;
        }
        return j;
    }

    /* renamed from: targetOffsetByState-oFUgxo0  reason: not valid java name */
    public final long m320targetOffsetByStateoFUgxo0(EnterExitState targetState, long j) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
                        ...
                        if (value != null) {
                            long m5771unboximpl = value.getSize().invoke(IntSize.m5759boximpl(j)).m5771unboximpl();
                            Alignment value2 = this.alignment.getValue();
                            Intrinsics.checkNotNull(value2);
                            long mo2908alignKFBX0sM = value2.mo2908alignKFBX0sM(j, m5771unboximpl, LayoutDirection.Ltr);
                            Alignment alignment = this.currentAlignment;
                            Intrinsics.checkNotNull(alignment);
                            long mo2908alignKFBX0sM2 = alignment.mo2908alignKFBX0sM(j, m5771unboximpl, LayoutDirection.Ltr);
                            return IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(mo2908alignKFBX0sM) - IntOffset.m5725getXimpl(mo2908alignKFBX0sM2), IntOffset.m5726getYimpl(mo2908alignKFBX0sM) - IntOffset.m5726getYimpl(mo2908alignKFBX0sM2));
                        }
    ...
    public MeasureResult mo298measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long IntSize = IntSizeKt.IntSize(mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight());
        long m5771unboximpl = this.sizeAnimation.animate(this.sizeTransitionSpec, new ExpandShrinkModifier$measure$currentSize$1(this, IntSize)).getValue().m5771unboximpl();
        long m5734unboximpl = this.offsetAnimation.animate(ExpandShrinkModifier$measure$offsetDelta$1.INSTANCE, new ExpandShrinkModifier$measure$offsetDelta$2(this, IntSize)).getValue().m5734unboximpl();
        Alignment alignment = this.currentAlignment;
        return MeasureScope.CC.layout$default(measure, IntSize.m5767getWidthimpl(m5771unboximpl), IntSize.m5766getHeightimpl(m5771unboximpl), null, new ExpandShrinkModifier$measure$1(mo4545measureBRTryo0, alignment != null ? alignment.mo2908alignKFBX0sM(IntSize, m5771unboximpl, LayoutDirection.Ltr) : IntOffset.Companion.m5735getZeronOccac(), m5734unboximpl), 4, null);
    }
}
