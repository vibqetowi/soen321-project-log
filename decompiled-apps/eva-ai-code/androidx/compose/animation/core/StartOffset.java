...
public final class StartOffset {
    ...
    public static final /* synthetic */ StartOffset m370boximpl(long j) {
        return new StartOffset(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static long m372constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m374equalsimpl(long j, Object obj) {
        return (obj instanceof StartOffset) && j == ((StartOffset) obj).m380unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m375equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m378hashCodeimpl(long j) {
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m371constructorimpl(int i, int i2) {
        return m372constructorimpl(i * i2);
    }

    /* renamed from: constructor-impl$default  reason: not valid java name */
    public static /* synthetic */ long m373constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.Companion.m388getDelayEo1U57Q();
        }
        return m371constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl  reason: not valid java name */
    public static final int m376getOffsetMillisimpl(long j) {
        return Math.abs((int) j);
    }

    /* renamed from: getOffsetType-Eo1U57Q  reason: not valid java name */
    public static final int m377getOffsetTypeEo1U57Q(long j) {
        boolean z = j > 0;
        if (z) {
            return StartOffsetType.Companion.m389getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.Companion.m388getDelayEo1U57Q();
    }
}
