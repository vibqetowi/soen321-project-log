...
public final class TransitionKt {
    ...
    public static final <T> Transition<T> updateTransition(T t, String str, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new TransitionKt$updateTransition$1$1(transition);
    ...
    public static final <T> Transition<T> updateTransition(MutableTransitionState<T> transitionState, String str, Composer composer, int i, int i2) {
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new TransitionKt$updateTransition$2$1(transition);
            composer.updateRememberedValue(rememberedValue2);
        }
        composer.endReplaceableGroup();
    ...
    public static final <S, T, V extends AnimationVector> Transition<S>.DeferredAnimation<T, V> createDeferredAnimation(Transition<S> transition, TwoWayConverter<T, V> typeConverter, String str, Composer composer, int i, int i2) {
    ...
    public static final <S, T> Transition<T> createChildTransitionInternal(Transition<S> transition, T t, T t2, String childLabel, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(transition, "<this>");
        ...
        Object rememberedValue2 = composer.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new TransitionKt$createChildTransitionInternal$1$1(transition, transition2);
            composer.updateRememberedValue(rememberedValue2);
        }
        composer.endReplaceableGroup();
    ...
    public static final <S, T, V extends AnimationVector> State<T> createTransitionAnimation(Transition<S> transition, T t, T t2, FiniteAnimationSpec<T> animationSpec, TwoWayConverter<T, V> typeConverter, String label, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(transition, "<this>");
        ...
        Object rememberedValue2 = composer.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new TransitionKt$createTransitionAnimation$1$1(transition, transitionAnimationState);
            composer.updateRememberedValue(rememberedValue2);
        }
        composer.endReplaceableGroup();
