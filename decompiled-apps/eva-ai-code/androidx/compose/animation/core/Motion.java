...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m357boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m361equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m367unboximpl();
    }
    ...
    public static final long m359copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default  reason: not valid java name */
    public static /* synthetic */ long m360copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m363getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m364getVelocityimpl(j);
        }
        return m359copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl  reason: not valid java name */
    public static final float m363getValueimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl  reason: not valid java name */
    public static final float m364getVelocityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
