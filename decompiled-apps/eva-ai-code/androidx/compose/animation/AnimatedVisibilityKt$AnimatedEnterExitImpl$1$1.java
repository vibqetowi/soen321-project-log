...
public final class AnimatedVisibilityKt$AnimatedEnterExitImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Boolean> {
        ...
        public final Boolean invoke() {
            return Boolean.valueOf(this.$childTransition.getCurrentState() == EnterExitState.Visible || this.$childTransition.getTargetState() == EnterExitState.Visible);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new AnonymousClass1(this.$childTransition));
