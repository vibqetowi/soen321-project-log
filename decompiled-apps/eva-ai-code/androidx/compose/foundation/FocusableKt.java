...
public final class FocusableKt {
    ...
    public static final Modifier focusableInNonTouchMode(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource) {
        ...
        return InspectableValueKt.inspectableWrapper(modifier, new FocusableKt$focusableInNonTouchMode$1(z, mutableInteractionSource), focusable(Modifier.Companion.then(FocusableInNonTouchModeElement), z, mutableInteractionSource));
    }
}
