...
public final class MagnifierStyle {
    ...
    public final long m483getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }

    /* renamed from: getCornerRadius-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m481getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m482getElevationD9Ej5fM$foundation_release() {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.Companion.m5714getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.Companion.m5627getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.Companion.m5627getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MagnifierStyle) {
            ...
            return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5702equalsimpl0(this.size, magnifierStyle.size) && Dp.m5612equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5612equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
        }
        return false;
    }

    public int hashCode() {
        return (((((((((UByte$$ExternalSyntheticBackport0.m(this.useTextDefault) * 31) + DpSize.m5707hashCodeimpl(this.size)) * 31) + Dp.m5613hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5613hashCodeimpl(this.elevation)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.clippingEnabled)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        return "MagnifierStyle(size=" + ((Object) DpSize.m5712toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m5618toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m5618toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }

    /* compiled from: Magnifier.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001f\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u00042\b\b\u0002\u0010\u000e\u001a\u00020\u000fH\u0000¢\u0006\u0002\b\u0010R\u001c\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007R\u001c\u0010\b\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\t\u0010\u0002\u001a\u0004\b\n\u0010\u0007¨\u0006\u0011"}, d2 = {"Landroidx/compose/foundation/MagnifierStyle$Companion;", "", "()V", "Default", "Landroidx/compose/foundation/MagnifierStyle;", "getDefault$annotations", "getDefault", "()Landroidx/compose/foundation/MagnifierStyle;", "TextDefault", "getTextDefault$annotations", "getTextDefault", "isStyleSupported", "", "style", RemoteConfigConstants.RequestFieldKey.SDK_VERSION, "", "isStyleSupported$foundation_release", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes.dex */
