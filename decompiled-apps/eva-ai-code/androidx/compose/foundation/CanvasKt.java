...
public final class CanvasKt {
    public static final void Canvas(Modifier modifier, Function1<? super DrawScope, Unit> onDraw, Composer composer, int i) {
        int i2;
    ...
    public static final void Canvas(Modifier modifier, String contentDescription, Function1<? super DrawScope, Unit> onDraw, Composer composer, int i) {
        int i2;
        Intrinsics.checkNotNullParameter(modifier, "modifier");
