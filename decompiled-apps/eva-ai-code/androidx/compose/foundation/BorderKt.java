...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke border, Shape shape) {
        ...
        return m434borderziNgDLE(modifier, border.m447getWidthD9Ej5fM(), border.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m433borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m432borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m432borderxT4_qwU(Modifier border, float f, long j, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m434borderziNgDLE(border, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m434borderziNgDLE(Modifier border, float f, Brush brush, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    public static final DrawResult m435drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, Brush brush, long j, long j2, boolean z, float f) {
        return cacheDrawScope.onDrawWithContent(new BorderKt$drawRectBorder$1(brush, z ? Offset.Companion.m3034getZeroF1C5BW0() : j, z ? cacheDrawScope.m2924getSizeNHjbRc() : j2, z ? Fill.INSTANCE : new Stroke(f, 0.0f, 0, 0, null, 30, null)));
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo3152opN5in7k0(path, Path, PathOperation.Companion.m3583getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m436shrinkKibmq7A(roundRect.m3068getTopLeftCornerRadiuskKHJgLs(), f), m436shrinkKibmq7A(roundRect.m3069getTopRightCornerRadiuskKHJgLs(), f), m436shrinkKibmq7A(roundRect.m3067getBottomRightCornerRadiuskKHJgLs(), f), m436shrinkKibmq7A(roundRect.m3066getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m436shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m2993getXimpl(j) - f), Math.max(0.0f, CornerRadius.m2994getYimpl(j) - f));
    }
}
