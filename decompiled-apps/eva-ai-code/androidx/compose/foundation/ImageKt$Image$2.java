...
public final class ImageKt$Image$2 implements MeasurePolicy {
    ...
    public final MeasureResult mo272measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j) {
        ...
        return MeasureScope.CC.layout$default(Layout, Constraints.m5553getMinWidthimpl(j), Constraints.m5552getMinHeightimpl(j), null, ImageKt$Image$2$measure$1.INSTANCE, 4, null);
    }
}
