...
final class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    private final int m495component2ZbEOnfQ() {
    ...
    private final float m496component6D9Ej5fM() {
        return this.velocity;
    }

    /* renamed from: copy-lWfNwf4$default  reason: not valid java name */
    public static /* synthetic */ MarqueeModifierElement m497copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        return marqueeModifierElement.m498copylWfNwf4(i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: copy-lWfNwf4  reason: not valid java name */
    public final MarqueeModifierElement m498copylWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing spacing, float f) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MarqueeModifierElement) {
            ...
            return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m487equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual(this.spacing, marqueeModifierElement.spacing) && Dp.m5612equalsimpl0(this.velocity, marqueeModifierElement.velocity);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((this.iterations * 31) + MarqueeAnimationMode.m488hashCodeimpl(this.animationMode)) * 31) + this.delayMillis) * 31) + this.initialDelayMillis) * 31) + this.spacing.hashCode()) * 31) + Dp.m5613hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + ((Object) MarqueeAnimationMode.m489toStringimpl(this.animationMode)) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + ((Object) Dp.m5618toStringimpl(this.velocity)) + ')';
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("animationMode", MarqueeAnimationMode.m484boximpl(this.animationMode));
        ...
        inspectorInfo.getProperties().set("velocity", Dp.m5605boximpl(this.velocity));
    }
    ...
    public void update(MarqueeModifierNode node) {
        ...
        node.m502updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
}
