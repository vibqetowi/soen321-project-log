...
public final class PagerLayoutInfoKt {
    ...
    public static final int getMainAxisViewportSize(PagerLayoutInfo pagerLayoutInfo) {
        ...
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m5766getHeightimpl(pagerLayoutInfo.mo970getViewportSizeYbymL2g()) : IntSize.m5767getWidthimpl(pagerLayoutInfo.mo970getViewportSizeYbymL2g());
    }
}
