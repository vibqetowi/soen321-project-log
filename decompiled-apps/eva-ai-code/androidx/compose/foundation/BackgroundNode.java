...
public final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final long m422getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m423setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3292equalsimpl0(this.color, Color.Companion.m3327getUnspecified0d7_KjU())) {
            DrawScope.CC.m3842drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.CC.m3841drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline mo470createOutlinePq9zytI;
        if (Size.m3082equalsimpl(contentDrawScope.mo3762getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            mo470createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(mo470createOutlinePq9zytI);
        } else {
            mo470createOutlinePq9zytI = this.shape.mo470createOutlinePq9zytI(contentDrawScope.mo3762getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m3292equalsimpl0(this.color, Color.Companion.m3327getUnspecified0d7_KjU())) {
            OutlineKt.m3549drawOutlinewDX37Ww(contentDrawScope, mo470createOutlinePq9zytI, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.Companion.m3845getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m3548drawOutlinehn5TExg$default(contentDrawScope, mo470createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = mo470createOutlinePq9zytI;
        this.lastSize = Size.m3075boximpl(contentDrawScope.mo3762getSizeNHjbRc());
