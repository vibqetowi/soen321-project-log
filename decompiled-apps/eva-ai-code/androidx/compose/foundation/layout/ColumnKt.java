...
public final class ColumnKt {
    ...
    static {
        ...
        float mo661getSpacingD9Ej5fM = Arrangement.INSTANCE.getTop().mo661getSpacingD9Ej5fM();
        ...
        DefaultColumnMeasurePolicy = RowColumnImplKt.m773rowColumnMeasurePolicyTDGSqEk(layoutOrientation, ColumnKt$DefaultColumnMeasurePolicy$1.INSTANCE, mo661getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
    }

    public static final MeasurePolicy columnMeasurePolicy(Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(verticalArrangement, Arrangement.INSTANCE.getTop()) && Intrinsics.areEqual(horizontalAlignment, Alignment.Companion.getStart())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float mo661getSpacingD9Ej5fM = verticalArrangement.mo661getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m773rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new ColumnKt$columnMeasurePolicy$1$1(verticalArrangement), mo661getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
