...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo698calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo585toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo700calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo585toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo699calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo585toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo697calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo585toDpu2uoSUM(this.insets.getBottom(density));
    }
