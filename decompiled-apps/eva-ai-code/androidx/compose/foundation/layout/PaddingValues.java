...
public interface PaddingValues {
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m761getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m762getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m763getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m764getTopD9Ej5fM$annotations() {
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Absolute) {
                ...
                return Dp.m5612equalsimpl0(this.left, absolute.left) && Dp.m5612equalsimpl0(this.top, absolute.top) && Dp.m5612equalsimpl0(this.right, absolute.right) && Dp.m5612equalsimpl0(this.bottom, absolute.bottom);
            }
            return false;
        }

        public int hashCode() {
            return (((((Dp.m5613hashCodeimpl(this.left) * 31) + Dp.m5613hashCodeimpl(this.top)) * 31) + Dp.m5613hashCodeimpl(this.right)) * 31) + Dp.m5613hashCodeimpl(this.bottom);
        }

        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m5618toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5618toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5618toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5618toStringimpl(this.bottom)) + ')';
        }
