...
public final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo298measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        if (intValue == 0) {
            return MeasureScope.CC.layout$default(measure, 0, 0, null, DerivedHeightModifier$measure$1.INSTANCE, 4, null);
        }
        Placeable mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(Constraints.m5542copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.CC.layout$default(measure, mo4545measureBRTryo0.getWidth(), intValue, null, new DerivedHeightModifier$measure$2(mo4545measureBRTryo0), 4, null);
    }
