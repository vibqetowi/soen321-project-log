...
public final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public final float m634getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m633getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if (!((f >= 0.0f || Dp.m5612equalsimpl0(f, Dp.Companion.m5627getUnspecifiedD9Ej5fM())) && (f2 >= 0.0f || Dp.m5612equalsimpl0(f2, Dp.Companion.m5627getUnspecifiedD9Ej5fM())))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m638setBefore0680j_4(this.before);
        node.m637setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m5612equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m5612equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m5613hashCodeimpl(this.before)) * 31) + Dp.m5613hashCodeimpl(this.after);
    }
}
