...
public final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m710getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: setX-0680j_4  reason: not valid java name */
    public final void m712setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m711getYD9Ej5fM() {
        return this.y;
    }

    /* renamed from: setY-0680j_4  reason: not valid java name */
    public final void m713setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo500measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight(), null, new OffsetNode$measure$1(this, mo4545measureBRTryo0, measure), 4, null);
    }
}
