...
public final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo500measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int m5553getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m5553getMinWidthimpl(j);
        int m5552getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m5552getMinHeightimpl(j) : 0;
        int i = Integer.MAX_VALUE;
        int m5551getMaxWidthimpl = (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m5551getMaxWidthimpl(j) : Integer.MAX_VALUE;
        if (this.direction == Direction.Horizontal || !this.unbounded) {
            i = Constraints.m5550getMaxHeightimpl(j);
        }
        Placeable mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(ConstraintsKt.Constraints(m5553getMinWidthimpl, m5551getMaxWidthimpl, m5552getMinHeightimpl, i));
        int coerceIn = RangesKt.coerceIn(mo4545measureBRTryo0.getWidth(), Constraints.m5553getMinWidthimpl(j), Constraints.m5551getMaxWidthimpl(j));
        int coerceIn2 = RangesKt.coerceIn(mo4545measureBRTryo0.getHeight(), Constraints.m5552getMinHeightimpl(j), Constraints.m5550getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measure, coerceIn, coerceIn2, null, new WrapContentNode$measure$1(this, coerceIn, mo4545measureBRTryo0, coerceIn2, measure), 4, null);
    }
}
