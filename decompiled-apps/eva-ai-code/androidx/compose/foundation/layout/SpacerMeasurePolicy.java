...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, Constraints.m5549getHasFixedWidthimpl(j) ? Constraints.m5551getMaxWidthimpl(j) : 0, Constraints.m5548getHasFixedHeightimpl(j) ? Constraints.m5550getMaxHeightimpl(j) : 0, null, SpacerMeasurePolicy$measure$1$1.INSTANCE, 4, null);
    }
}
