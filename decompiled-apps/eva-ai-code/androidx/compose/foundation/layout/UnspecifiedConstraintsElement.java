...
public final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public final float m813getMinWidthD9Ej5fM() {
        return this.minWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public final float m812getMinHeightD9Ej5fM() {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m817setMinWidth0680j_4(this.minWidth);
        node.m816setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m5605boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m5605boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UnspecifiedConstraintsElement) {
            ...
            return Dp.m5612equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m5612equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5613hashCodeimpl(this.minWidth) * 31) + Dp.m5613hashCodeimpl(this.minHeight);
    }
}
