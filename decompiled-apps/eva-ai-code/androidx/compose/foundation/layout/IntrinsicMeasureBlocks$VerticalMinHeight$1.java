...
final class IntrinsicMeasureBlocks$VerticalMinHeight$1 extends Lambda implements Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends IntrinsicMeasurable> measurables, int i, int i2) {
        ...
        intrinsicSize = RowColumnImplKt.intrinsicSize(measurables, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, i, i2, LayoutOrientation.Vertical, LayoutOrientation.Vertical);
