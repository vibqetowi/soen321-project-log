...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo298measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int left = getUnconsumedInsets().getLeft(measureScope, measure.getLayoutDirection());
        ...
        Placeable mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(ConstraintsKt.m5567offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.CC.layout$default(measure, ConstraintsKt.m5565constrainWidthK40F9xA(j, mo4545measureBRTryo0.getWidth() + right), ConstraintsKt.m5564constrainHeightK40F9xA(j, mo4545measureBRTryo0.getHeight() + bottom), null, new InsetsPaddingModifier$measure$1(mo4545measureBRTryo0, left, top), 4, null);
    }
    ...
    public /* synthetic */ InsetsPaddingModifier(WindowInsets windowInsets, InsetsPaddingModifier$special$$inlined$debugInspectorInfo$1 insetsPaddingModifier$special$$inlined$debugInspectorInfo$1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(windowInsets, (i & 2) != 0 ? InspectableValueKt.isDebugInspectorInfoEnabled() ? new InsetsPaddingModifier$special$$inlined$debugInspectorInfo$1(windowInsets) : InspectableValueKt.getNoInspectorInfo() : insetsPaddingModifier$special$$inlined$debugInspectorInfo$1);
    }
}
