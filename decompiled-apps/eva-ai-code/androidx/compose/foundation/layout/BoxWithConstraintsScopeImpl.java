...
final class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m690copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m692copy0kLqBqw(density, j);
    }
    ...
    public final long m691component2msEJaDk() {
        return this.constraints;
    }

    /* renamed from: copy-0kLqBqw  reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m692copy0kLqBqw(Density density, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BoxWithConstraintsScopeImpl) {
            ...
            return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m5544equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
        }
        return false;
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m5554hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m5556toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo685getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo689getMinWidthD9Ej5fM() {
        return this.density.mo585toDpu2uoSUM(Constraints.m5553getMinWidthimpl(mo685getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo687getMaxWidthD9Ej5fM() {
        return Constraints.m5547getHasBoundedWidthimpl(mo685getConstraintsmsEJaDk()) ? this.density.mo585toDpu2uoSUM(Constraints.m5551getMaxWidthimpl(mo685getConstraintsmsEJaDk())) : Dp.Companion.m5626getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo688getMinHeightD9Ej5fM() {
        return this.density.mo585toDpu2uoSUM(Constraints.m5552getMinHeightimpl(mo685getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo686getMaxHeightD9Ej5fM() {
        return Constraints.m5546getHasBoundedHeightimpl(mo685getConstraintsmsEJaDk()) ? this.density.mo585toDpu2uoSUM(Constraints.m5550getMaxHeightimpl(mo685getConstraintsmsEJaDk())) : Dp.Companion.m5626getInfinityD9Ej5fM();
    }
}
