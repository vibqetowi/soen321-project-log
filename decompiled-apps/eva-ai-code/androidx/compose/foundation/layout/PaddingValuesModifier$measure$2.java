...
final class PaddingValuesModifier$measure$2 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(Placeable.PlacementScope layout) {
        ...
        Placeable.PlacementScope.place$default(layout, this.$placeable, this.$this_measure.mo582roundToPx0680j_4(this.this$0.getPaddingValues().mo698calculateLeftPaddingu2uoSUM(this.$this_measure.getLayoutDirection())), this.$this_measure.mo582roundToPx0680j_4(this.this$0.getPaddingValues().mo700calculateTopPaddingD9Ej5fM()), 0.0f, 4, null);
    }
}
