...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m636getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: setBefore-0680j_4  reason: not valid java name */
    public final void m638setBefore0680j_4(float f) {
        this.before = f;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m635getAfterD9Ej5fM() {
        return this.after;
    }

    /* renamed from: setAfter-0680j_4  reason: not valid java name */
    public final void m637setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo500measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        m624alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m624alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, j);
