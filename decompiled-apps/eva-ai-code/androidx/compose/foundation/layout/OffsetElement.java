...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public final float m704getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m705getYD9Ej5fM() {
        return this.y;
    }
    ...
    public void update(OffsetNode node) {
        ...
        node.m712setX0680j_4(this.x);
        node.m713setY0680j_4(this.y);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5612equalsimpl0(this.x, offsetElement.x) && Dp.m5612equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5613hashCodeimpl(this.x) * 31) + Dp.m5613hashCodeimpl(this.y)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5618toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5618toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
