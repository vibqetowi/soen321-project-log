...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final NestedScrollConnection m818rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator m778chooseCalculatorni1skBw = SideCalculator.Companion.m778chooseCalculatorni1skBw(i, (LayoutDirection) consume);
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        Object[] objArr = {windowInsets, view, m778chooseCalculatorni1skBw, density};
        ...
        if (z || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new WindowInsetsNestedScrollConnection(windowInsets, view, m778chooseCalculatorni1skBw, density);
