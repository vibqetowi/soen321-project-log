...
public final class Clickable_androidKt {
    ...
    public static final boolean m469isPressZmokQxo(KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m4281equalsimpl0(KeyEvent_androidKt.m4289getTypeZmokQxo(isPress), KeyEventType.Companion.m4285getKeyDownCS__XNY()) && m468isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo  reason: not valid java name */
    public static final boolean m467isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m4281equalsimpl0(KeyEvent_androidKt.m4289getTypeZmokQxo(isClick), KeyEventType.Companion.m4286getKeyUpCS__XNY()) && m468isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo  reason: not valid java name */
    private static final boolean m468isEnterZmokQxo(KeyEvent keyEvent) {
        int m4295getNativeKeyCodeYVgTNJs = Key_androidKt.m4295getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m4288getKeyZmokQxo(keyEvent));
        return m4295getNativeKeyCodeYVgTNJs == 23 || m4295getNativeKeyCodeYVgTNJs == 66 || m4295getNativeKeyCodeYVgTNJs == 160;
    }
}
