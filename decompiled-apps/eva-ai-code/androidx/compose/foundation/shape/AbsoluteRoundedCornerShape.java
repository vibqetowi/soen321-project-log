...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo992createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m3070RoundRectZAM2FJo(SizeKt.m3108toRectuvyYCjk(j), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f3, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, null)));
    }
    ...
    private final long m996toRadiusBz7bX_o(float f) {
