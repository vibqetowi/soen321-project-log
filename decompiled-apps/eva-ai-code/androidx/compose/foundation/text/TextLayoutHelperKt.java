...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m1107canReuse7_7YC6M(TextLayoutResult canReuse, AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long j) {
        ...
        if (!canReuse.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts() && Intrinsics.areEqual(layoutInput.getText(), text) && layoutInput.getStyle().hasSameLayoutAffectingAttributes(style) && Intrinsics.areEqual(layoutInput.getPlaceholders(), placeholders) && layoutInput.getMaxLines() == i && layoutInput.getSoftWrap() == z && TextOverflow.m5509equalsimpl0(layoutInput.m5051getOverflowgIe3tQ8(), i2) && Intrinsics.areEqual(layoutInput.getDensity(), density) && layoutInput.getLayoutDirection() == layoutDirection && Intrinsics.areEqual(layoutInput.getFontFamilyResolver(), fontFamilyResolver) && Constraints.m5553getMinWidthimpl(j) == Constraints.m5553getMinWidthimpl(layoutInput.m5050getConstraintsmsEJaDk())) {
            if (z || TextOverflow.m5509equalsimpl0(i2, TextOverflow.Companion.m5517getEllipsisgIe3tQ8())) {
                return Constraints.m5551getMaxWidthimpl(j) == Constraints.m5551getMaxWidthimpl(layoutInput.m5050getConstraintsmsEJaDk()) && Constraints.m5550getMaxHeightimpl(j) == Constraints.m5550getMaxHeightimpl(layoutInput.m5050getConstraintsmsEJaDk());
            }
            return true;
        }
        return false;
