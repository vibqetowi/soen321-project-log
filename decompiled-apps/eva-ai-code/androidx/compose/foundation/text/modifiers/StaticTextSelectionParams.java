...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m5506boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m5506boximpl(layoutInput.m5051getOverflowgIe3tQ8());
        int m5518getVisiblegIe3tQ8 = TextOverflow.Companion.m5518getVisiblegIe3tQ8();
        if (m5506boximpl == null) {
            return false;
        }
        return TextOverflow.m5509equalsimpl0(m5506boximpl.m5512unboximpl(), m5518getVisiblegIe3tQ8);
    }
