...
public final class MinLinesConstrainer {
    ...
    public static final class Companion {
        ...
        public final MinLinesConstrainer from(MinLinesConstrainer minLinesConstrainer, LayoutDirection layoutDirection, TextStyle paramStyle, Density density, FontFamily.Resolver fontFamilyResolver) {
            ...
            if (minLinesConstrainer2 != null && layoutDirection == minLinesConstrainer2.getLayoutDirection() && Intrinsics.areEqual(paramStyle, minLinesConstrainer2.getInputTextStyle())) {
    ...
    public final long m1118coerceMinLinesOh53vG4$foundation_release(long j, int i) {
        String str;
        Paragraph m4980ParagraphUdtVg6A;
        String str2;
        Paragraph m4980ParagraphUdtVg6A2;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m4980ParagraphUdtVg6A = ParagraphKt.m4980ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            f = m4980ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m4980ParagraphUdtVg6A2 = ParagraphKt.m4980ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            f2 = m4980ParagraphUdtVg6A2.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (i != 1) {
            m5552getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(f + (f2 * (i - 1))), 0), Constraints.m5550getMaxHeightimpl(j));
        } else {
            m5552getMinHeightimpl = Constraints.m5552getMinHeightimpl(j);
        }
        return ConstraintsKt.Constraints(Constraints.m5553getMinWidthimpl(j), Constraints.m5551getMaxWidthimpl(j), m5552getMinHeightimpl, Constraints.m5550getMaxHeightimpl(j));
    }
}
