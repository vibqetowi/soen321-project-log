...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        ...
        this.prevConstraints = Constraints.Companion.m5559fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m5516getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final long m1128getLayoutSizeYbymL2g$foundation_release() {
        return this.layoutSize;
    }

    /* renamed from: setLayoutSize-ozmzZPI$foundation_release  reason: not valid java name */
    public final void m1130setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA  reason: not valid java name */
    public final boolean m1129layoutWithConstraintsK40F9xA(long j, LayoutDirection layoutDirection) {
        long m5562constrain4WqzIAM;
        long m5562constrain4WqzIAM2;
        ...
        if (this.minLines > 1) {
            ...
            j = from.m1118coerceMinLinesOh53vG4$foundation_release(j, this.minLines);
        }
        boolean z2 = false;
        if (!m1127newLayoutWillBeDifferentK40F9xA(j, layoutDirection)) {
            if (!Constraints.m5544equalsimpl0(j, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m5562constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraph.getWidth()), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m5509equalsimpl0(this.overflow, TextOverflow.Companion.m5518getVisiblegIe3tQ8()) || (IntSize.m5767getWidthimpl(m5562constrain4WqzIAM2) >= paragraph.getWidth() && IntSize.m5766getHeightimpl(m5562constrain4WqzIAM2) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph m1126layoutTextK40F9xA = m1126layoutTextK40F9xA(j, layoutDirection);
        this.prevConstraints = j;
        this.layoutSize = ConstraintsKt.m5562constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m1126layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m1126layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m5509equalsimpl0(this.overflow, TextOverflow.Companion.m5518getVisiblegIe3tQ8()) && (IntSize.m5767getWidthimpl(m5562constrain4WqzIAM) < m1126layoutTextK40F9xA.getWidth() || IntSize.m5766getHeightimpl(m5562constrain4WqzIAM) < m1126layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = m1126layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int i, LayoutDirection layoutDirection) {
        ...
        if (i != i2 || i2 == -1) {
            int ceilToIntPx = TextDelegateKt.ceilToIntPx(m1126layoutTextK40F9xA(ConstraintsKt.Constraints(0, i, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1131updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.text = text;
    ...
    private final Paragraph m1126layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m4982Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1115finalConstraintstfFHcEY(j, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1116finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m5509equalsimpl0(this.overflow, TextOverflow.Companion.m5517getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA  reason: not valid java name */
    private final boolean m1127newLayoutWillBeDifferentK40F9xA(long j, LayoutDirection layoutDirection) {
        ...
        return Constraints.m5551getMaxWidthimpl(j) != Constraints.m5551getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m5550getMaxHeightimpl(j)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long m5542copyZbe2FdA$default = Constraints.m5542copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, m5542copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, CollectionsKt.emptyList(), density, this.fontFamilyResolver), m5542copyZbe2FdA$default, this.maxLines, TextOverflow.m5509equalsimpl0(this.overflow, TextOverflow.Companion.m5517getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
