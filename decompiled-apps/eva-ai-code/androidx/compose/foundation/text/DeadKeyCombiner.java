...
public final class DeadKeyCombiner {
    ...
    public final Integer m1033consumeZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        int m4290getUtf16CodePointZmokQxo = KeyEvent_androidKt.m4290getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & m4290getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(m4290getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer valueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), m4290getUtf16CodePointZmokQxo));
            Integer num2 = valueOf.intValue() == 0 ? null : valueOf;
            return num2 == null ? Integer.valueOf(m4290getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(m4290getUtf16CodePointZmokQxo);
    }
}
