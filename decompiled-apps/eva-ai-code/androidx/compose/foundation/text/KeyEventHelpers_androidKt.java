...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m1034cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m4281equalsimpl0(KeyEvent_androidKt.m4289getTypeZmokQxo(cancelsTextSelection), KeyEventType.Companion.m4286getKeyUpCS__XNY());
    }
}
