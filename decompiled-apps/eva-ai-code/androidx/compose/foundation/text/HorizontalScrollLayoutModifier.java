...
public final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo298measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        Placeable mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m5550getMaxHeightimpl(j)) < Constraints.m5551getMaxWidthimpl(j) ? j : Constraints.m5542copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        int min = Math.min(mo4545measureBRTryo0.getWidth(), Constraints.m5551getMaxWidthimpl(j));
        return MeasureScope.CC.layout$default(measure, min, mo4545measureBRTryo0.getHeight(), null, new HorizontalScrollLayoutModifier$measure$1(measure, this, mo4545measureBRTryo0, min), 4, null);
    }
}
