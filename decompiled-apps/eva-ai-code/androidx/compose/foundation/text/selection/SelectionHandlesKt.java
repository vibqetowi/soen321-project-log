...
public final class SelectionHandlesKt {
    ...
    public static final long m1170getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3018getXimpl(j), Offset.m3019getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m5607constructorimpl(f);
        HandleHeight = Dp.m5607constructorimpl(f);
    }
}
