...
public final class SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Offset> {
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m3007boximpl(m1174invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0  reason: not valid java name */
        public final long m1174invokeF1C5BW0() {
        ...
        if (i == 0) {
            ...
            if (snapshotFlow.collect(new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Offset offset, Continuation continuation) {
                    return m1175emit3MmeM6k(offset.m3028unboximpl(), continuation);
                }

                /* renamed from: emit-3MmeM6k  reason: not valid java name */
                public final Object m1175emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (OffsetKt.m3037isSpecifiedk4lQ0M(animatable.getValue().m3028unboximpl()) && OffsetKt.m3037isSpecifiedk4lQ0M(j)) {
                        if (!(Offset.m3019getYimpl(animatable.getValue().m3028unboximpl()) == Offset.m3019getYimpl(j))) {
                    ...
                    Object snapTo = animatable.snapTo(Offset.m3007boximpl(j), continuation);
