...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1(density, mutableState);
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Offset> {
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m3007boximpl(m1225invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0  reason: not valid java name */
        public final long m1225invokeF1C5BW0() {
            return TextFieldSelectionManagerKt.m1224calculateSelectionMagnifierCenterAndroidO0kMr_c(this.$manager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$1(this.$magnifierSize$delegate));
        }
    }
