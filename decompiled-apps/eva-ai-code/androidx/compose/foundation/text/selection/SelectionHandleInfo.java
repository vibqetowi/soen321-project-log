...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m1166copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m1168copyUv8p0NA(handle, j);
    }
    ...
    public final long m1167component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA  reason: not valid java name */
    public final SelectionHandleInfo m1168copyUv8p0NA(Handle handle, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectionHandleInfo) {
            ...
            return this.handle == selectionHandleInfo.handle && Offset.m3015equalsimpl0(this.position, selectionHandleInfo.position);
        }
        return false;
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m3020hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m3026toStringimpl(this.position)) + ')';
    }
    ...
    public final long m1169getPositionF1C5BW0() {
        return this.position;
    }
}
