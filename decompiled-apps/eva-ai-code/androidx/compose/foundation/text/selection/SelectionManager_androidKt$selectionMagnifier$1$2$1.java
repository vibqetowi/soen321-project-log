...
public final class SelectionManager_androidKt$selectionMagnifier$1$2$1 extends Lambda implements Function1<Function0<? extends Offset>, Modifier> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function1<Density, Offset> {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3007boximpl(m1206invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
        public final long m1206invoketuRUvjQ(Density magnifier) {
    ...
    public static final class AnonymousClass2 extends Lambda implements Function1<DpSize, Unit> {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1207invokeEaSLcWc(dpSize.m5713unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc  reason: not valid java name */
        public final void m1207invokeEaSLcWc(long j) {
            MutableState<IntSize> mutableState = this.$magnifierSize$delegate;
            Density density = this.$density;
            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(mutableState, IntSizeKt.IntSize(density.mo582roundToPx0680j_4(DpSize.m5705getWidthD9Ej5fM(j)), density.mo582roundToPx0680j_4(DpSize.m5703getHeightD9Ej5fM(j))));
        }
    }
