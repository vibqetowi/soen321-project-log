...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public boolean mo405onPreKeyEventZmokQxo(KeyEvent event) {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.Companion.m3034getZeroF1C5BW0();
        ...
        public final long m407getCentreOffsetF1C5BW0() {
            return this.centreOffset;
        }

        /* renamed from: setCentreOffset-k-4lQ0M  reason: not valid java name */
        public final void m408setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m402updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m406updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: updateCommon-XHw0xAI  reason: not valid java name */
    public final void m406updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo404onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        ...
        getClickablePointerInputNode().mo404onPointerEventH0pRuoY(pointerEvent, pass, j);
    }
    ...
    public boolean mo403onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m469isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3977boximpl(KeyEvent_androidKt.m4288getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.m407getCentreOffsetF1C5BW0(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3977boximpl(KeyEvent_androidKt.m4288getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m467isClickZmokQxo(event)) {
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3977boximpl(KeyEvent_androidKt.m4288getKeyZmokQxo(event)));
            if (remove != null) {
