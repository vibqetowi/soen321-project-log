...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m485constructorimpl(0);
    private static final int WhileFocused = m485constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m484boximpl(int i) {
    ...
    public static boolean m486equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m490unboximpl();
    }
    ...
    public static int m488hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m489toStringimpl(int i) {
        if (m487equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m487equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m491getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m492getWhileFocusedZbEOnfQ$annotations() {
        }
