...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m5607constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo470createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            ...
            float mo582roundToPx0680j_4 = density.mo582roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -mo582roundToPx0680j_4, Size.m3087getWidthimpl(j), Size.m3084getHeightimpl(j) + mo582roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo470createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float mo582roundToPx0680j_4 = density.mo582roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-mo582roundToPx0680j_4, 0.0f, Size.m3087getWidthimpl(j) + mo582roundToPx0680j_4, Size.m3084getHeightimpl(j)));
        }
    });
