...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m477Image5hnEew(bitmap, str, companion, center, fit, f2, colorFilter2, FilterQuality.Companion.m3386getLowfv9h1I(), composer, (i & 112) | 8 | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m477Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(bitmap, "bitmap");
        ...
        int m3846getDefaultFilterQualityfv9h1I = (i3 & 128) != 0 ? DrawScope.Companion.m3846getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m3917BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, m3846getDefaultFilterQualityfv9h1I, 6, null);
    ...
    public static final void Image(Painter painter, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        if (str != null) {
            ...
            ImageKt$Image$semantics$1$1 rememberedValue = startRestartGroup.rememberedValue();
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
        ...
        Updater.m2900setimpl(m2893constructorimpl, imageKt$Image$2, ComposeUiNode.Companion.getSetMeasurePolicy());
        ...
        endRestartGroup.updateScope(new ImageKt$Image$3(painter, str, companion2, center, fit, f2, colorFilter2, i, i2));
    }
}
