...
public final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float f) {
        ...
        value.m599dispatchScroll3eAAhYA(this.latestScrollScope, value.m608toOffsettuRUvjQ(f), NestedScrollSource.Companion.m4322getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float f) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m602performRawScrollMKHz9U(value.m608toOffsettuRUvjQ(f));
    }
}
