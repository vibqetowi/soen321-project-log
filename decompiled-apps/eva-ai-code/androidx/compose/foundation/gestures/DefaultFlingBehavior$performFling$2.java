...
final class DefaultFlingBehavior$performFling$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Float>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Math.abs(this.$initialVelocity) > 1.0f) {
                ...
                this.L$0 = floatRef2;
                this.label = 1;
                if (SuspendAnimationKt.animateDecay$default(AnimationState$default, decayAnimationSpec, false, new AnonymousClass1(floatRef3, this.$this_performFling, floatRef2, this.this$0), this, 2, null) == coroutine_suspended) {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(Ref.FloatRef floatRef, ScrollScope scrollScope, Ref.FloatRef floatRef2, DefaultFlingBehavior defaultFlingBehavior) {
            super(1);
