...
public final class LazyGridSnapLayoutInfoProviderKt {
            ...
            public float calculateSnapStepSize(Density density) {
                ...
                if (!getSingleAxisItems().isEmpty()) {
                    ...
                    if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
                        ...
                        i = 0;
                        while (i2 < size) {
                            i += IntSize.m5766getHeightimpl(singleAxisItems.get(i2).mo881getSizeYbymL2g());
                            i2++;
                        }
                    } else {
                        ...
                        i = 0;
                        while (i2 < size2) {
                            i += IntSize.m5767getWidthimpl(singleAxisItems2.get(i2).mo881getSizeYbymL2g());
                            i2++;
                        }
                    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            return IntSize.m5766getHeightimpl(lazyGridLayoutInfo.mo862getViewportSizeYbymL2g());
        }
        return IntSize.m5767getWidthimpl(lazyGridLayoutInfo.mo862getViewportSizeYbymL2g());
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntSize.m5766getHeightimpl(lazyGridItemInfo.mo881getSizeYbymL2g());
        }
        return IntSize.m5767getWidthimpl(lazyGridItemInfo.mo881getSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntOffset.m5726getYimpl(lazyGridItemInfo.mo880getOffsetnOccac());
        }
        return IntOffset.m5725getXimpl(lazyGridItemInfo.mo880getOffsetnOccac());
    }
}
