...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo506calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset m3007boximpl = Offset.m3007boximpl(Offset.Companion.m3034getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m3007boximpl = Offset.m3007boximpl(Offset.m3023plusMKHz9U(m3007boximpl.m3028unboximpl(), changes.get(i).m4428getScrollDeltaF1C5BW0()));
        }
        return Offset.m3025timestuRUvjQ(m3007boximpl.m3028unboximpl(), -calculateMouseWheelScroll.mo588toPx0680j_4(Dp.m5607constructorimpl(64)));
    }
}
