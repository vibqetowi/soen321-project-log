...
final class AndroidOverscrollKt$StretchOverscrollNonClippingLayer$2 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        return m419invoke3p2s80s(measureScope, measurable, constraints.m5557unboximpl());
    }

    /* renamed from: invoke-3p2s80s  reason: not valid java name */
    public final MeasureResult m419invoke3p2s80s(MeasureScope layout, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(layout, mo4545measureBRTryo0.getWidth() + i, mo4545measureBRTryo0.getHeight() + i, null, new AnonymousClass1(mo4545measureBRTryo0, i), 4, null);
    }
