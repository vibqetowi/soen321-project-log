...
public final class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m441copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m443copy8Feqmps(f, brush, shape);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m442component1D9Ej5fM() {
        return this.width;
    }
    ...
    public final BorderModifierNodeElement m443copy8Feqmps(float f, Brush brush, Shape shape) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BorderModifierNodeElement) {
            ...
            return Dp.m5612equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5613hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m5618toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }

    /* renamed from: getWidth-D9Ej5fM  reason: not valid java name */
    public final float m444getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode node) {
        ...
        node.m440setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Dp.m5605boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m3281boximpl(((SolidColor) this.brush).m3626getValue0d7_KjU()));
            inspectorInfo.setValue(Color.m3281boximpl(((SolidColor) this.brush).m3626getValue0d7_KjU()));
        } else {
