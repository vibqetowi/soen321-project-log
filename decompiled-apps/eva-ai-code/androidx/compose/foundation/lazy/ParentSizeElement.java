...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ParentSizeNode) {
            ...
            return ((this.fraction > parentSizeNode.getFraction() ? 1 : (this.fraction == parentSizeNode.getFraction() ? 0 : -1)) == 0) && Intrinsics.areEqual(this.widthState, parentSizeNode.getWidthState()) && Intrinsics.areEqual(this.heightState, parentSizeNode.getHeightState());
        }
        return false;
    }
