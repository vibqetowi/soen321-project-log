...
public final class LazyListBeyondBoundsModifierKt {
    public static final Modifier lazyListBeyondBoundsModifier(Modifier modifier, LazyListState state, int i, boolean z, Orientation orientation, Composer composer, int i2) {
        ...
        Object[] objArr = {obj, beyondBoundsInfo$foundation_release, Boolean.valueOf(z), layoutDirection, orientation};
        ...
        if (z2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new LazyLayoutBeyondBoundsModifierLocal((LazyLayoutBeyondBoundsState) obj, beyondBoundsInfo$foundation_release, z, layoutDirection, orientation);
