...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public LazyLayoutAnimateItemModifierNode(FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m5716boximpl(IntOffset.Companion.m5735getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, null, 12, null);
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5716boximpl(IntOffset.Companion.m5735getZeronOccac()), null, 2, null);
    ...
    public final long m894getRawOffsetnOccac() {
        return this.rawOffset;
    }

    /* renamed from: setRawOffset--gyyYBs  reason: not valid java name */
    public final void m895setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setPlacementDelta--gyyYBs  reason: not valid java name */
    public final void m891setPlacementDeltagyyYBs(long j) {
        this.placementDelta$delegate.setValue(IntOffset.m5716boximpl(j));
    }

    /* renamed from: getPlacementDelta-nOcc-ac  reason: not valid java name */
    public final long m893getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta$delegate.getValue()).m5734unboximpl();
    }
    ...
    public final void m892animatePlacementDeltagyyYBs(long j) {
        long m893getPlacementDeltanOccac = m893getPlacementDeltanOccac();
        long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5725getXimpl(m893getPlacementDeltanOccac) - IntOffset.m5725getXimpl(j), IntOffset.m5726getYimpl(m893getPlacementDeltanOccac) - IntOffset.m5726getYimpl(j));
        m891setPlacementDeltagyyYBs(IntOffset);
    ...
    public void onDetach() {
        m891setPlacementDeltagyyYBs(IntOffset.Companion.m5735getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m896getNotInitializednOccac() {
