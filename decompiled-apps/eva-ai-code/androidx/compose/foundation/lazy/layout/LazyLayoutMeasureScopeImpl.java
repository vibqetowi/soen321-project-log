...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo581roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo581roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo582roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo582roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo587toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo587toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo588toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo588toPx0680j_4(f);
    }
    ...
    public List<Placeable> mo906measure0kLqBqw(int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(subcompose.get(i2).mo4545measureBRTryo0(j));
        }
    ...
    public float mo583toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo583toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo585toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo585toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo584toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo584toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo591toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo591toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo592toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo592toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo590toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo590toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSize-XkaWNTQ */
    public long mo589toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo589toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo586toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo586toDpSizekrfVVM(j);
    }
}
