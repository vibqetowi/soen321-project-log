...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m855measureLazyListCD5nmq0(int i, LazyListMeasuredItemProvider measuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, List<Integer> headerIndexes, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyListItemPlacementAnimator placementAnimator, int i8, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i3 >= 0) {
            if (i4 >= 0) {
                if (i <= 0) {
                    return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m5553getMinWidthimpl(j)), Integer.valueOf(Constraints.m5552getMinHeightimpl(j)), LazyListMeasureKt$measureLazyList$1.INSTANCE), CollectionsKt.emptyList(), -i3, i2 + i4, 0, z2, z ? Orientation.Vertical : Orientation.Horizontal, i4, i5);
                }
                int i19 = i6;
                if (i19 >= i) {
                    i19 = i - 1;
                ...
                int m5565constrainWidthK40F9xA = ConstraintsKt.m5565constrainWidthK40F9xA(j, z ? i49 : i11);
                if (z) {
                    i49 = i11;
                }
                int m5564constrainHeightK40F9xA = ConstraintsKt.m5564constrainHeightK40F9xA(j, i49);
                float f3 = f2;
                int i52 = i10;
                List<LazyListMeasuredItem> calculateItemsOffsets = calculateItemsOffsets(arrayDeque2, createItemsBeforeList, createItemsAfterList, m5565constrainWidthK40F9xA, m5564constrainHeightK40F9xA, i11, i2, i15, z, vertical, horizontal, z2, density);
                int i53 = i11;
                LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem;
                placementAnimator.onMeasured((int) f3, m5565constrainWidthK40F9xA, m5564constrainHeightK40F9xA, calculateItemsOffsets, measuredItemProvider, z);
                LazyListMeasuredItem findOrComposeLazyListHeader = headerIndexes.isEmpty() ^ true ? LazyListHeadersKt.findOrComposeLazyListHeader(calculateItemsOffsets, measuredItemProvider, headerIndexes, i3, m5565constrainWidthK40F9xA, m5564constrainHeightK40F9xA) : null;
                boolean z4 = i52 < i || i53 > i2;
                MeasureResult invoke = layout.invoke(Integer.valueOf(m5565constrainWidthK40F9xA), Integer.valueOf(m5564constrainHeightK40F9xA), new LazyListMeasureKt$measureLazyList$5(calculateItemsOffsets, findOrComposeLazyListHeader));
                if (z3) {
