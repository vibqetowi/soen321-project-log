...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m5551getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m5550getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m859getChildConstraintsmsEJaDk() {
        return this.childConstraints;
    }

    public final LazyListMeasuredItem getAndMeasure(int i) {
        return createItem(i, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), this.measureScope.mo906measure0kLqBqw(i, this.childConstraints));
    }
