...
final class LazyStaggeredGridDslKt$rememberColumnSlots$1$1 extends Lambda implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
        return m928invoke0kLqBqw(density, constraints.m5557unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyStaggeredGridSlots m928invoke0kLqBqw(Density $receiver, long j) {
        ...
        int[] calculateCrossAxisCellSizes = staggeredGridCells.calculateCrossAxisCellSizes($receiver, m5551getMaxWidthimpl, $receiver.mo582roundToPx0680j_4(horizontal.mo661getSpacingD9Ej5fM()));
        int[] iArr = new int[calculateCrossAxisCellSizes.length];
        horizontal.arrange($receiver, m5551getMaxWidthimpl, calculateCrossAxisCellSizes, LayoutDirection.Ltr, iArr);
