...
public final class Latch {
    ...
    public final void openLatch() {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                list.get(i).resumeWith(Result.m7271constructorimpl(Unit.INSTANCE));
            }
            list.clear();
            Unit unit = Unit.INSTANCE;
        }
    ...
    public final Object await(Continuation<? super Unit> continuation) {
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Latch$await$2$2(this, cancellableContinuationImpl2));
