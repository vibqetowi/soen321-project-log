...
public final class StateMapMutableEntriesIterator$next$1 implements Map.Entry<K, V>, KMutableMap.Entry {
    ...
    public V setValue(V v) {
        ...
        StateMapMutableIterator stateMapMutableIterator2 = stateMapMutableIterator;
        if (stateMapMutableIterator2.getMap().getModification$runtime_release() == stateMapMutableIterator2.modification) {
            ?? value = getValue();
            stateMapMutableIterator.getMap().put(getKey(), v);
            setValue((StateMapMutableEntriesIterator$next$1) v);
            return value;
        }
