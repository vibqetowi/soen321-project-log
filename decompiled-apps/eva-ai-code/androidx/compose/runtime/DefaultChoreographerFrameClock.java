        ...
        Choreographer.FrameCallback frameCallback = new Choreographer.FrameCallback() { // from class: androidx.compose.runtime.DefaultChoreographerFrameClock$withFrameNanos$2$callback$1
            ...
            public final void doFrame(long j) {
                ...
                try {
                    ...
                    m7271constructorimpl = Result.m7271constructorimpl(function12.invoke(Long.valueOf(j)));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m7271constructorimpl = Result.m7271constructorimpl(ResultKt.createFailure(th));
                }
                continuation2.resumeWith(m7271constructorimpl);
            }
        };
        choreographer.postFrameCallback(frameCallback);
        cancellableContinuationImpl2.invokeOnCancellation(new DefaultChoreographerFrameClock$withFrameNanos$2$1(frameCallback));
