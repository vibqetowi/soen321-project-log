...
public final class GroupKind {
    ...
    private static final int Group = m2867constructorimpl(0);
    private static final int Node = m2867constructorimpl(1);
    private static final int ReusableNode = m2867constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ GroupKind m2866boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2867constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2868equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m2874unboximpl();
    }
    ...
    public static String m2873toStringimpl(int i) {
    ...
    public String toString() {
        return m2873toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m2874unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m2871isNodeimpl(int i) {
        return i != Companion.m2875getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl  reason: not valid java name */
    public static final boolean m2872isReusableimpl(int i) {
        return i != Companion.m2876getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m2875getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs  reason: not valid java name */
        public final int m2876getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs  reason: not valid java name */
        public final int m2877getReusableNodeULZAiWs() {
