...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedPlaceholder$1 extends Lambda implements Function3<Modifier, Composer, Integer, Unit> {
    ...
    public final void invoke(Modifier modifier, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C138@5768L341:TextFieldImpl.kt#jmzs0o");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1536681527, "C140@5902L25,141@5990L10,139@5840L247:TextFieldImpl.kt#jmzs0o");
            TextFieldImplKt.m1521DecorationeuL9pac(textFieldColors.placeholderColor(z, composer, ((i3 >> 27) & 14) | ((i4 >> 6) & 112)).getValue().m3301unboximpl(), MaterialTheme.INSTANCE.getTypography(composer, 6).getSubtitle1(), null, function2, composer, (i3 >> 6) & 7168, 4);
