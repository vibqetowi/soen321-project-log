...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public State<Dp> elevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function2) new DefaultFloatingActionButtonElevation$elevation$1$1(interactionSource, snapshotStateList, null);
        ...
        EffectsKt.LaunchedEffect(Dp.m5605boximpl(f2), new DefaultFloatingActionButtonElevation$elevation$2(animatable, this, f2, interaction, null), composer, 64);
