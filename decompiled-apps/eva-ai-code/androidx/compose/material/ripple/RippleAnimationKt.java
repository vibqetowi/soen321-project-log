...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5607constructorimpl(10);
    ...
    public static final float m1554getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m3087getWidthimpl(j), Size.m3084getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1553getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m3016getDistanceimpl = Offset.m3016getDistanceimpl(OffsetKt.Offset(Size.m3087getWidthimpl(j), Size.m3084getHeightimpl(j))) / 2.0f;
        return z ? m3016getDistanceimpl + getRippleEndRadius.mo588toPx0680j_4(BoundedRippleExtraRadius) : m3016getDistanceimpl;
    }
}
