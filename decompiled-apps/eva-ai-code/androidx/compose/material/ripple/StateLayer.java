...
public final class StateLayer {
    ...
    public final void m1562drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float f2;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m1553getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3762getSizeNHjbRc());
        } else {
            f2 = drawStateLayer.mo588toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m3290copywmQWz5c$default = Color.m3290copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.CC.m3829drawCircleVaOC9Bg$default(drawStateLayer, m3290copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float m3087getWidthimpl = Size.m3087getWidthimpl(drawStateLayer.mo3762getSizeNHjbRc());
            float m3084getHeightimpl = Size.m3084getHeightimpl(drawStateLayer.mo3762getSizeNHjbRc());
