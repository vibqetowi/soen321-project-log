...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance mo1550rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long mo1394defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m3301unboximpl() != Color.Companion.m3327getUnspecified0d7_KjU()) {
            mo1394defaultColorWaAFU9c = this.color.getValue().m3301unboximpl();
        } else {
            mo1394defaultColorWaAFU9c = rippleTheme.mo1394defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance mo1550rememberUpdatedRippleInstance942rkJo = mo1550rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m3281boximpl(mo1394defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(mo1550rememberUpdatedRippleInstance942rkJo, interactionSource, new Ripple$rememberUpdatedInstance$1(interactionSource, mo1550rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return mo1550rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Ripple) {
            ...
            return this.bounded == ripple.bounded && Dp.m5612equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
        }
        return false;
    }

    public int hashCode() {
        return (((UByte$$ExternalSyntheticBackport0.m(this.bounded) * 31) + Dp.m5613hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
