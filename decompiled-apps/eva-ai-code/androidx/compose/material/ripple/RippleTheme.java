...
public interface RippleTheme {
    ...
    long mo1394defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1561defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m3343luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m3328getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1560defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (z) {
                if (ColorKt.m3343luminance8_81llA(j) > 0.5d) {
