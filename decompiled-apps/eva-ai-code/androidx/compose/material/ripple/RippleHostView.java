...
public final class RippleHostView extends View {
    ...
    public final void m1556addRippleKOepWvA(PressInteraction.Press interaction, boolean z, long j, int i, long j2, float f, Function0<Unit> onInvalidateRipple) {
        ...
        m1557updateRipplePropertiesbiQXAtU(j, i, j2, f);
        if (z) {
            unprojectedRipple.setHotspot(Offset.m3018getXimpl(interaction.m622getPressPositionF1C5BW0()), Offset.m3019getYimpl(interaction.m622getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1557updateRipplePropertiesbiQXAtU(long j, int i, long j2, float f) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(i);
        unprojectedRipple.m1564setColorDxMtmZc(j2, f);
        Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m3087getWidthimpl(j)), MathKt.roundToInt(Size.m3084getHeightimpl(j)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
