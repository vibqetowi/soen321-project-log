...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1394defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1561defaultRippleColor5vOe2sY = RippleTheme.Companion.m1561defaultRippleColor5vOe2sY(Color.Companion.m3317getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1560defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1560defaultRippleAlphaDxMtmZc(Color.Companion.m3317getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
