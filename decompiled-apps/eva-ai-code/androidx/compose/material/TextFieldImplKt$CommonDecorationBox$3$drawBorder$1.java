...
public final class TextFieldImplKt$CommonDecorationBox$3$drawBorder$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C194@8214L246:TextFieldImpl.kt#jmzs0o");
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier m1420outlineCutout12SF9DM = OutlinedTextFieldKt.m1420outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, OutlinedTextFieldKt.BorderId), this.$labelSize.getValue().m3092unboximpl(), this.$contentPadding);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m1420outlineCutout12SF9DM);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1536678945, "C:TextFieldImpl.kt#jmzs0o");
            composer.startReplaceableGroup(1661576646);
            ComposerKt.sourceInformation(composer, "198@8430L8");
            if (function2 != null) {
