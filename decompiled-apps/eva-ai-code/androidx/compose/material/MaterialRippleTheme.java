...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1394defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1561defaultRippleColor5vOe2sY = companion.m1561defaultRippleColor5vOe2sY(((Color) consume).m3301unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        Object consume = composer.consume(ContentColorKt.getLocalContentColor());
        ComposerKt.sourceInformationMarkerEnd(composer);
        RippleAlpha m1560defaultRippleAlphaDxMtmZc = companion.m1560defaultRippleAlphaDxMtmZc(((Color) consume).m3301unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1560defaultRippleAlphaDxMtmZc;
    }
}
