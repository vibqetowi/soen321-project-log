...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1343apply7g2Lkgo(long j, float f, Composer composer, int i) {
        long m1368calculateForegroundColorCLU3JFs;
        ...
        if (Dp.m5606compareTo0680j_4(f, Dp.m5607constructorimpl(0)) > 0 && !colors.isLight()) {
            m1368calculateForegroundColorCLU3JFs = ElevationOverlayKt.m1368calculateForegroundColorCLU3JFs(j, f, composer, (i & 112) | (i & 14));
            j = ColorKt.m3336compositeOverOWjLjI(m1368calculateForegroundColorCLU3JFs, j);
        }
        if (ComposerKt.isTraceInProgress()) {
