...
public final class DefaultButtonElevation implements ButtonElevation {
    ...
    public State<Dp> elevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5605boximpl(f2), new DefaultButtonElevation$elevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1598807146);
            ComposerKt.sourceInformation(composer, "556@22499L546");
            EffectsKt.LaunchedEffect(Dp.m5605boximpl(f2), new DefaultButtonElevation$elevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
