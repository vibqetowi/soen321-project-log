...
final class AndroidAlertDialog_androidKt$AlertDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            float f = 8;
            Modifier m749paddingVpY3zN4 = PaddingKt.m749paddingVpY3zN4(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), Dp.m5607constructorimpl(f), Dp.m5607constructorimpl(2));
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 350577093, "C80@3937L226:AndroidAlertDialog.android.kt#jmzs0o");
            AlertDialogKt.m1231AlertDialogFlowRowixp7dh8(Dp.m5607constructorimpl(f), Dp.m5607constructorimpl(12), ComposableLambdaKt.composableLambda(composer, 1789213604, true, new AndroidAlertDialog_androidKt$AlertDialog$1$1$1(function2, i2, function22)), composer, 438);
