...
final class BottomSheetScaffoldKt$BottomSheet$2 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Boolean> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(BottomSheetState bottomSheetState, CoroutineScope coroutineScope) {
            super(0);
            this.$state = bottomSheetState;
            this.$scope = coroutineScope;
        }
        ...
        public final Boolean invoke() {
            if (this.$state.getAnchoredDraggableState$material_release().getConfirmValueChange$material_release().invoke(BottomSheetValue.Expanded).booleanValue()) {
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new C00291(this.$state, null), 3, null);
            }
            return true;
        }
        ...
        public static final class C00291 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00291(BottomSheetState bottomSheetState, Continuation<? super C00291> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00291(this.$state, continuation);
            }
    ...
    public static final class AnonymousClass2 extends Lambda implements Function0<Boolean> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(BottomSheetState bottomSheetState, CoroutineScope coroutineScope) {
            super(0);
            this.$state = bottomSheetState;
            this.$scope = coroutineScope;
        }
