...
public final class BottomNavigationKt$BottomNavigation$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        float f;
        ComposerKt.sourceInformation(composer, "C102@4444L243:BottomNavigation.kt#jmzs0o");
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m781height3ABfNKs(fillMaxWidth$default, f));
