...
final class DrawerKt$BottomDrawer$2$1$4 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Boolean> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(BottomDrawerState bottomDrawerState, CoroutineScope coroutineScope) {
            super(0);
            this.$drawerState = bottomDrawerState;
            this.$scope = coroutineScope;
        }
        ...
        public final Boolean invoke() {
            if (this.$drawerState.confirmStateChange$material_release(BottomDrawerValue.Closed)) {
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new C00331(this.$drawerState, null), 3, null);
            }
            return true;
        }
        ...
        public static final class C00331 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00331(BottomDrawerState bottomDrawerState, Continuation<? super C00331> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00331(this.$drawerState, continuation);
            }
