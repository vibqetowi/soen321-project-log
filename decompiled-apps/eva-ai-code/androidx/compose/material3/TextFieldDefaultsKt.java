...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m2134animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().m5621unboximpl(), new SolidColor(indicatorColor$material3_release.getValue().m3301unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
