...
public final class VisibleModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo298measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        if (!this.visible) {
            return MeasureScope.CC.layout$default(measure, 0, 0, null, VisibleModifier$measure$1.INSTANCE, 4, null);
        }
        return MeasureScope.CC.layout$default(measure, mo4545measureBRTryo0.getWidth(), mo4545measureBRTryo0.getHeight(), null, new VisibleModifier$measure$2(mo4545measureBRTryo0), 4, null);
    }
