...
public final class ModalBottomSheet_androidKt$ModalBottomSheetPopup$modalBottomSheetWindow$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public ModalBottomSheet_androidKt$ModalBottomSheetPopup$modalBottomSheetWindow$1$1$1(WindowInsets windowInsets, State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier imePadding = WindowInsetsPadding_androidKt.imePadding(WindowInsetsPaddingKt.windowInsetsPadding(SemanticsModifierKt.semantics$default(Modifier.Companion, false, AnonymousClass1.INSTANCE, 1, null), this.$windowInsets));
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 321876634, "C439@18616L16:ModalBottomSheet.android.kt#uh7d8r");
            ModalBottomSheetPopup$lambda$5 = ModalBottomSheet_androidKt.ModalBottomSheetPopup$lambda$5(state);
            ModalBottomSheetPopup$lambda$5.invoke(composer, 0);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
