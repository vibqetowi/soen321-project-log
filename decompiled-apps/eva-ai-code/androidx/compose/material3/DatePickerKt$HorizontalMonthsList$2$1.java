...
public final class DatePickerKt$HorizontalMonthsList$2$1 extends Lambda implements Function1<LazyListScope, Unit> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass1(StateData stateData, CalendarMonth calendarMonth, Function1<? super Long, Unit> function1, CalendarDate calendarDate, Function1<? super Long, Boolean> function12, DatePickerFormatter datePickerFormatter, DatePickerColors datePickerColors, int i) {
            super(4);
            this.$stateData = stateData;
            this.$firstMonth = calendarMonth;
            this.$onDateSelected = function1;
        ...
        public final void invoke(LazyItemScope items, int i, Composer composer, int i2) {
            ...
            if ((i3 & 731) != 146 || !composer.getSkipping()) {
                ...
                ComposerKt.sourceInformationMarkerStart(composer, 1656167412, "C1309@54344L379:DatePicker.kt#uh7d8r");
                int i5 = i4 << 3;
                int i6 = i4 << 6;
    ...
    public final void invoke2(LazyListScope LazyRow) {
        ...
        LazyListScope.CC.items$default(LazyRow, this.$stateData.getTotalMonthsInRange(), null, null, ComposableLambdaKt.composableLambdaInstance(-65053693, true, new AnonymousClass1(this.$stateData, this.$firstMonth, this.$onDateSelected, this.$today, this.$dateValidator, this.$dateFormatter, this.$colors, this.$$dirty)), 6, null);
    }
}
