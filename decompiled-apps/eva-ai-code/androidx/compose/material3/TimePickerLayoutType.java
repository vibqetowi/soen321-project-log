...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m2176constructorimpl(0);
    private static final int Vertical = m2176constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2175boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2176constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2177equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m2181unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2178equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2179hashCodeimpl(int i) {
        return i;
    }
    ...
    public int hashCode() {
        return m2179hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2182getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE  reason: not valid java name */
        public final int m2183getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    public String toString() {
        return m2180toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2180toStringimpl(int i) {
        return m2178equalsimpl0(i, Horizontal) ? "Horizontal" : m2178equalsimpl0(i, Vertical) ? "Vertical" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
