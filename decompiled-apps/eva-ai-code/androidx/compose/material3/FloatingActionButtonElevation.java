...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5605boximpl(f2), new FloatingActionButtonElevation$animateElevation$2(animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5612equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5612equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5612equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m5612equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
    }

    public int hashCode() {
        return (((((Dp.m5613hashCodeimpl(this.defaultElevation) * 31) + Dp.m5613hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5613hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5613hashCodeimpl(this.hoveredElevation);
    }
}
