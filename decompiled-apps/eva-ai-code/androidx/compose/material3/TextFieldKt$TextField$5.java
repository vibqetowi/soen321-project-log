...
final class TextFieldKt$TextField$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1751957978, true, new AnonymousClass1(this.$value, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, this.$isError, this.$label, this.$placeholder, this.$leadingIcon, this.$trailingIcon, this.$prefix, this.$suffix, this.$supportingText, this.$shape, this.$colors, this.$$dirty, this.$$dirty1, this.$$dirty2));
            int i2 = this.$$dirty;
            int i3 = this.$$dirty1;
    ...
    public static final class AnonymousClass1 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
        ...
        public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer composer, int i) {
            ...
            if ((i2 & 91) != 18 || !composer.getSkipping()) {
                ...
                int i4 = this.$$dirty1;
                int i5 = this.$$dirty2;
                TextFieldDefaults.INSTANCE.DecorationBox(this.$value.getText(), innerTextField, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, z, function2, function22, function23, function24, function25, function26, function27, shape, textFieldColors, null, null, composer, ((i3 >> 3) & 896) | ((i2 << 3) & 112) | ((i4 >> 12) & 7168) | (i4 & 57344) | ((i5 << 15) & 458752) | ((i4 << 9) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 100663296 | ((i4 << 3) & 112) | ((i4 << 3) & 896) | ((i4 << 3) & 7168) | ((i5 << 9) & 57344) | ((i5 << 9) & 458752), ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                    return;
                }
