...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m2183getVerticalQJTpgSE = TimePickerLayoutType.Companion.m2182getHorizontalQJTpgSE();
        } else {
            m2183getVerticalQJTpgSE = TimePickerLayoutType.Companion.m2183getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2183getVerticalQJTpgSE;
    }
}
