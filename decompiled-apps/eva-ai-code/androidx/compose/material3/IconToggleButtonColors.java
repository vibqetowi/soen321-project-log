...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m3292equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m3292equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m3292equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m3292equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m3292equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m3298hashCodeimpl(this.containerColor) * 31) + Color.m3298hashCodeimpl(this.contentColor)) * 31) + Color.m3298hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3298hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3298hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m3298hashCodeimpl(this.checkedContentColor);
    }
}
