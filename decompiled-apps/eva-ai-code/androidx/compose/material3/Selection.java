...
public final class Selection {
    ...
    private static final int Hour = m1966constructorimpl(0);
    private static final int Minute = m1966constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Selection m1965boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1966constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1967equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1971unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1968equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m1967equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1969hashCodeimpl(this.value);
    }

    public String toString() {
        return m1970toStringimpl(this.value);
    }
