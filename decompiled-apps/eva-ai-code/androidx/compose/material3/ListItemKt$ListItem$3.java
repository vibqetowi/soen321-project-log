...
final class ListItemKt$ListItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier semantics = SemanticsModifierKt.semantics(PaddingKt.padding(SizeKt.m783heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null), this.$paddingValues), true, AnonymousClass1.INSTANCE);
