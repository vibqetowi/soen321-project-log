...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1425714523, "C165@7013L190:TextFieldImpl.kt#uh7d8r");
            TextFieldImplKt.m2135DecorationKTwxG1Y(j, textStyle, function2, composer, (i2 >> 21) & 896, 0);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
