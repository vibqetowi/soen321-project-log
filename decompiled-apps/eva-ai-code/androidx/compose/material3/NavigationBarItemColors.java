...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m329animateColorAsStateeuL9pac = SingleValueAnimationKt.m329animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long m1881getIndicatorColor0d7_KjU$material3_release() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m3292equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m3292equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m3292equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m3292equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m3292equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m3292equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m3298hashCodeimpl(this.selectedIconColor) * 31) + Color.m3298hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m3298hashCodeimpl(this.selectedTextColor)) * 31) + Color.m3298hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m3298hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m3298hashCodeimpl(this.disabledIconColor)) * 31) + Color.m3298hashCodeimpl(this.disabledTextColor);
    }
}
