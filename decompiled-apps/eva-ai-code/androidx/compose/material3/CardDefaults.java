...
public final class CardDefaults {
    ...
    public final CardElevation m1608cardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2485getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledCardTokens.INSTANCE.m2485getContainerElevationD9Ej5fM() : f;
        float m2491getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledCardTokens.INSTANCE.m2491getPressedContainerElevationD9Ej5fM() : f2;
        float m2488getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledCardTokens.INSTANCE.m2488getFocusContainerElevationD9Ej5fM() : f3;
        float m2489getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledCardTokens.INSTANCE.m2489getHoverContainerElevationD9Ej5fM() : f4;
        float m2487getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledCardTokens.INSTANCE.m2487getDraggedContainerElevationD9Ej5fM() : f5;
        float m2486getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilledCardTokens.INSTANCE.m2486getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-574898487, i, -1, "androidx.compose.material3.CardDefaults.cardElevation (Card.kt:373)");
        }
        CardElevation cardElevation = new CardElevation(m2485getContainerElevationD9Ej5fM, m2491getPressedContainerElevationD9Ej5fM, m2488getFocusContainerElevationD9Ej5fM, m2489getHoverContainerElevationD9Ej5fM, m2487getDraggedContainerElevationD9Ej5fM, m2486getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1610elevatedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2401getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedCardTokens.INSTANCE.m2401getContainerElevationD9Ej5fM() : f;
        float m2407getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedCardTokens.INSTANCE.m2407getPressedContainerElevationD9Ej5fM() : f2;
        float m2404getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedCardTokens.INSTANCE.m2404getFocusContainerElevationD9Ej5fM() : f3;
        float m2405getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedCardTokens.INSTANCE.m2405getHoverContainerElevationD9Ej5fM() : f4;
        float m2403getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedCardTokens.INSTANCE.m2403getDraggedContainerElevationD9Ej5fM() : f5;
        float m2402getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? ElevatedCardTokens.INSTANCE.m2402getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1154241939, i, -1, "androidx.compose.material3.CardDefaults.elevatedCardElevation (Card.kt:401)");
        }
        CardElevation cardElevation = new CardElevation(m2401getContainerElevationD9Ej5fM, m2407getPressedContainerElevationD9Ej5fM, m2404getFocusContainerElevationD9Ej5fM, m2405getHoverContainerElevationD9Ej5fM, m2403getDraggedContainerElevationD9Ej5fM, m2402getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1612outlinedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2587getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? OutlinedCardTokens.INSTANCE.m2587getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m2587getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m2587getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m2587getContainerElevationD9Ej5fM : f4;
        float m2589getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? OutlinedCardTokens.INSTANCE.m2589getDraggedContainerElevationD9Ej5fM() : f5;
        float m2588getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? OutlinedCardTokens.INSTANCE.m2588getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-97678773, i, -1, "androidx.compose.material3.CardDefaults.outlinedCardElevation (Card.kt:429)");
        }
        CardElevation cardElevation = new CardElevation(m2587getContainerElevationD9Ej5fM, f7, f8, f9, m2589getDraggedContainerElevationD9Ej5fM, m2588getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1607cardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1687contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1687contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m3336compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m3336compositeOverOWjLjI(Color.m3290copywmQWz5c$default(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1692surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), FilledCardTokens.INSTANCE.m2486getDisabledContainerElevationD9Ej5fM())) : j3;
        long m3290copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3290copywmQWz5c$default(ColorSchemeKt.m1687contentColorForek8zF_U(color, composer, i & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1589582123, i, -1, "androidx.compose.material3.CardDefaults.cardColors (Card.kt:455)");
        }
        CardColors cardColors = new CardColors(color, m1687contentColorForek8zF_U, m3336compositeOverOWjLjI, m3290copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1609elevatedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1687contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1687contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m3336compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m3336compositeOverOWjLjI(Color.m3290copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1692surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), ElevatedCardTokens.INSTANCE.m2402getDisabledContainerElevationD9Ej5fM())) : j3;
        long m3290copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3290copywmQWz5c$default(m1687contentColorForek8zF_U, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m1611outlinedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        CardColors cardColors = new CardColors(color, m1687contentColorForek8zF_U, j5, m3290copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedCardBorder(boolean z, Composer composer, int i, int i2) {
        ...
        if (z) {
            ...
            m3336compositeOverOWjLjI = ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-31428766);
            ComposerKt.sourceInformation(composer, "537@25023L9,540@25172L11");
            m3336compositeOverOWjLjI = ColorKt.m3336compositeOverOWjLjI(Color.m3290copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1692surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), OutlinedCardTokens.INSTANCE.m2588getDisabledContainerElevationD9Ej5fM()));
            composer.endReplaceableGroup();
        }
        Color m3281boximpl = Color.m3281boximpl(m3336compositeOverOWjLjI);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m3281boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BorderStrokeKt.m448BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m2593getOutlineWidthD9Ej5fM(), m3336compositeOverOWjLjI);
