...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5607constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5607constructorimpl((float) 48.0d);
    ...
    public final float m2309getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2310getSizeD9Ej5fM() {
        return Size;
    }
}
