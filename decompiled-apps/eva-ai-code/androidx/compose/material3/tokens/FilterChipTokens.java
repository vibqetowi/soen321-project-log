...
public final class FilterChipTokens {
    ...
    private static final float ContainerHeight = Dp.m5607constructorimpl((float) 32.0d);
    ...
    private static final float DraggedContainerElevation = ElevationTokens.INSTANCE.m2412getLevel4D9Ej5fM();
    private static final float ElevatedContainerElevation = ElevationTokens.INSTANCE.m2409getLevel1D9Ej5fM();
    private static final ColorSchemeKeyTokens ElevatedDisabledContainerColor = ColorSchemeKeyTokens.OnSurface;
    private static final float ElevatedDisabledContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final float ElevatedFocusContainerElevation = ElevationTokens.INSTANCE.m2409getLevel1D9Ej5fM();
    private static final float ElevatedHoverContainerElevation = ElevationTokens.INSTANCE.m2410getLevel2D9Ej5fM();
    private static final float ElevatedPressedContainerElevation = ElevationTokens.INSTANCE.m2409getLevel1D9Ej5fM();
    ...
    private static final float FlatContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    ...
    private static final float FlatSelectedFocusContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final float FlatSelectedHoverContainerElevation = ElevationTokens.INSTANCE.m2409getLevel1D9Ej5fM();
    private static final float FlatSelectedOutlineWidth = Dp.m5607constructorimpl((float) 0.0d);
    private static final float FlatSelectedPressedContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final float FlatUnselectedFocusContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens FlatUnselectedFocusOutlineColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float FlatUnselectedHoverContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens FlatUnselectedOutlineColor = ColorSchemeKeyTokens.Outline;
    private static final float FlatUnselectedOutlineWidth = Dp.m5607constructorimpl((float) 1.0d);
    private static final float FlatUnselectedPressedContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    ...
    private static final float IconSize = Dp.m5607constructorimpl((float) 18.0d);
