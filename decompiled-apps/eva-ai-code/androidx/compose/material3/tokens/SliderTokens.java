...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2409getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5607constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2408getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5607constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5607constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5607constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5607constructorimpl(f2);
        HandleWidth = Dp.m5607constructorimpl(f2);
        InactiveTrackHeight = Dp.m5607constructorimpl(f);
    }
    ...
    public final float m2704getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2705getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2706getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2707getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2708getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2709getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2710getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2711getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2713getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m2715getTrackElevationD9Ej5fM() {
    ...
    public final float m2712getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2714getTickMarksContainerSizeD9Ej5fM() {
