...
public final class TimePickerKt$clockDial$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5716boximpl(IntOffset.Companion.m5735getZeronOccac()), null, 2, null);
        ...
        if (changed || rememberedValue5 == Composer.Companion.getEmpty()) {
            rememberedValue5 = (Function1) new TimePickerKt$clockDial$2$1$1(timePickerState);
            composer.updateRememberedValue(rememberedValue5);
        }
        composer.endReplaceableGroup();
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(OnRemeasuredModifierKt.onSizeChanged(companion, (Function1) rememberedValue5), new Object[]{this.$state, IntOffset.m5716boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo588toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass2(mutableState, mutableState2, coroutineScope, this.$state, mo588toPx0680j_4, this.$autoSwitchToMinute, null)), new Object[]{this.$state, IntOffset.m5716boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo588toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3(coroutineScope, this.$state, this.$autoSwitchToMinute, mo588toPx0680j_4, mutableState, mutableState2, null));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final long invoke$lambda$7(MutableState<IntOffset> mutableState) {
        return mutableState.getValue().m5734unboximpl();
    }
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* loaded from: classes.dex */
        public static final class C00642 extends Lambda implements Function1<Offset, Unit> {
            final /* synthetic */ boolean $autoSwitchToMinute;
            final /* synthetic */ float $maxDist;
            final /* synthetic */ CoroutineScope $scope;
            final /* synthetic */ TimePickerState $state;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00642(CoroutineScope coroutineScope, TimePickerState timePickerState, float f, boolean z) {
                super(1);
                this.$scope = coroutineScope;
                this.$state = timePickerState;
                this.$maxDist = f;
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m2173invokek4lQ0M(offset.m3028unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
            public final void m2173invokek4lQ0M(long j) {
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new AnonymousClass1(this.$state, j, this.$maxDist, this.$autoSwitchToMinute, null), 3, null);
            }
            ...
            public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (this.$state.onTap$material3_release(Offset.m3018getXimpl(this.$it), Offset.m3019getYimpl(this.$it), this.$maxDist, this.$autoSwitchToMinute, this) == coroutine_suspended) {
        ...
        public static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
            ...
            public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                return m2172invoked4ec7I(pressGestureScope, offset.m3028unboximpl(), continuation);
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final Object m2172invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.label == 0) {
                    ResultKt.throwOnFailure(obj);
                    long j = this.J$0;
                    TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, Offset.m3018getXimpl(j));
                    TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, Offset.m3019getYimpl(j));
                    return Unit.INSTANCE;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures$default((PointerInputScope) this.L$0, null, null, new AnonymousClass1(this.$offsetX$delegate, this.$offsetY$delegate, null), new C00642(this.$scope, this.$state, this.$maxDist, this.$autoSwitchToMinute), this, 3, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public static final class AnonymousClass3 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1 extends Lambda implements Function0<Unit> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass1(CoroutineScope coroutineScope, TimePickerState timePickerState, boolean z) {
                super(0);
                this.$scope = coroutineScope;
                this.$state = timePickerState;
                this.$autoSwitchToMinute = z;
            ...
            public final void invoke2() {
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new C00651(this.$state, this.$autoSwitchToMinute, null), 3, null);
            }
            ...
            public static final class C00651 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00651(TimePickerState timePickerState, boolean z, Continuation<? super C00651> continuation) {
                    super(2, continuation);
                    this.$state = timePickerState;
                    this.$autoSwitchToMinute = z;
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00651(this.$state, this.$autoSwitchToMinute, continuation);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        if (Selection.m1968equalsimpl0(this.$state.m2185getSelectionJiIwxys$material3_release(), Selection.Companion.m1972getHourJiIwxys()) && this.$autoSwitchToMinute) {
                        ...
                        } else if (Selection.m1968equalsimpl0(this.$state.m2185getSelectionJiIwxys$material3_release(), Selection.Companion.m1973getMinuteJiIwxys())) {
                            this.label = 2;
        ...
        public static final class AnonymousClass2 extends Lambda implements Function2<PointerInputChange, Offset, Unit> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass2(CoroutineScope coroutineScope, TimePickerState timePickerState, float f, MutableState<Float> mutableState, MutableState<Float> mutableState2) {
                super(2);
                this.$scope = coroutineScope;
                this.$state = timePickerState;
                this.$maxDist = f;
            ...
            public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                m2174invokeUv8p0NA(pointerInputChange, offset.m3028unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
            public final void m2174invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                Intrinsics.checkNotNullParameter(pointerInputChange, "<anonymous parameter 0>");
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new AnonymousClass1(j, this.$state, this.$offsetX$delegate, this.$offsetY$delegate, null), 3, null);
            ...
            /* compiled from: TimePicker.kt */
            @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
            @DebugMetadata(c = "androidx.compose.material3.TimePickerKt$clockDial$2$3$2$1", f = "TimePicker.kt", i = {}, l = {AdaptiveTrackSelection.DEFAULT_MAX_WIDTH_TO_DISCARD}, m = "invokeSuspend", n = {}, s = {})
            ...
            public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        TimePickerKt$clockDial$2.invoke$lambda$2(mutableState, TimePickerKt$clockDial$2.invoke$lambda$1(mutableState) + Offset.m3018getXimpl(this.$dragAmount));
                        MutableState<Float> mutableState2 = this.$offsetY$delegate;
                        TimePickerKt$clockDial$2.invoke$lambda$5(mutableState2, TimePickerKt$clockDial$2.invoke$lambda$4(mutableState2) + Offset.m3019getYimpl(this.$dragAmount));
                        this.label = 1;
                        if (TimePickerState.update$material3_release$default(this.$state, TimePickerKt.atan(TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m5726getYimpl(this.$state.m2184getCenternOccac$material3_release()), TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m5725getXimpl(this.$state.m2184getCenternOccac$material3_release())), false, this, 2, null) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else if (i != 1) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (DragGestureDetectorKt.detectDragGestures$default((PointerInputScope) this.L$0, null, new AnonymousClass1(this.$scope, this.$state, this.$autoSwitchToMinute), null, new AnonymousClass2(this.$scope, this.$state, this.$maxDist, this.$offsetX$delegate, this.$offsetY$delegate), this, 5, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
