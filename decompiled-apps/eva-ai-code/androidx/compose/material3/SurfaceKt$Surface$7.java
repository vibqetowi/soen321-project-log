...
public final class SurfaceKt$Surface$7 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            m2074surfaceColorAtElevationCLU3JFs = SurfaceKt.m2074surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14);
            m2073surface8ww4TTg = SurfaceKt.m2073surface8ww4TTg(minimumInteractiveComponentSize, shape, m2074surfaceColorAtElevationCLU3JFs, this.$border, this.$shadowElevation);
            Modifier m985toggleableO2vRcR0$default = ToggleableKt.m985toggleableO2vRcR0$default(m2073surface8ww4TTg, this.$checked, this.$interactionSource, RippleKt.m1559rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m985toggleableO2vRcR0$default);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1301741971, "C459@22997L9:Surface.kt#uh7d8r");
