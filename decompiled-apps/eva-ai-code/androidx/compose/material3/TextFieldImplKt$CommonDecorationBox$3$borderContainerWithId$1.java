...
public final class TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier m1920outlineCutout12SF9DM = OutlinedTextFieldKt.m1920outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId), this.$labelSize.getValue().m3092unboximpl(), this.$contentPadding);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m1920outlineCutout12SF9DM);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1425717638, "C237@10128L11:TextFieldImpl.kt#uh7d8r");
