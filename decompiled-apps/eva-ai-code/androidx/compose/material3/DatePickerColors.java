...
public final class DatePickerColors {
    ...
    public final long m1728getDayInSelectionRangeContainerColor0d7_KjU$material3_release() {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        long j;
        State<Color> m329animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            m329animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m3281boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation(composer, "596@26492L134");
            m329animateColorAsStateeuL9pac = SingleValueAnimationKt.m329animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        long m3326getTransparent0d7_KjU;
        ...
        if (z) {
            m3326getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m3326getTransparent0d7_KjU = Color.Companion.m3326getTransparent0d7_KjU();
        }
        long j = m3326getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation(composer, "622@27316L134");
            rememberUpdatedState = SingleValueAnimationKt.m329animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1577406187);
            ComposerKt.sourceInformation(composer, "627@27480L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3281boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m329animateColorAsStateeuL9pac = SingleValueAnimationKt.m329animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> m329animateColorAsStateeuL9pac = SingleValueAnimationKt.m329animateColorAsStateeuL9pac(z ? this.selectedYearContainerColor : Color.Companion.m3326getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DatePickerColors) {
            ...
            return Color.m3292equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m3292equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m3292equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m3292equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m3292equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m3292equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m3292equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m3292equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m3292equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m3292equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m3292equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m3292equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m3292equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m3292equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m3292equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m3292equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m3292equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m3292equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m3292equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Color.m3298hashCodeimpl(this.containerColor) * 31) + Color.m3298hashCodeimpl(this.titleContentColor)) * 31) + Color.m3298hashCodeimpl(this.headlineContentColor)) * 31) + Color.m3298hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m3298hashCodeimpl(this.subheadContentColor)) * 31) + Color.m3298hashCodeimpl(this.yearContentColor)) * 31) + Color.m3298hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m3298hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m3298hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m3298hashCodeimpl(this.dayContentColor)) * 31) + Color.m3298hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m3298hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m3298hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m3298hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m3298hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m3298hashCodeimpl(this.todayContentColor)) * 31) + Color.m3298hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m3298hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m3298hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
