...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float mo700calculateTopPaddingD9Ej5fM() {
        return Dp.m5607constructorimpl(this.topPadding.getValue().m5621unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float mo697calculateBottomPaddingD9Ej5fM() {
        return Dp.m5607constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
