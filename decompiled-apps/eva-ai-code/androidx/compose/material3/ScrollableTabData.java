...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int mo582roundToPx0680j_4 = density.mo582roundToPx0680j_4(((TabPosition) CollectionsKt.last((List<? extends Object>) list)).m2098getRightD9Ej5fM()) + i;
        int maxValue = mo582roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo582roundToPx0680j_4(tabPosition.m2097getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo582roundToPx0680j_4(tabPosition.m2099getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(mo582roundToPx0680j_4 - maxValue, 0));
    }
}
