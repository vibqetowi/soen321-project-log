...
final class ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$1 extends Lambda implements Function2<SheetValue, Float, Unit> {
    ...
    public ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$1(CoroutineScope coroutineScope, SheetState sheetState) {
        super(2);
    ...
    public final void invoke(SheetValue target, float f) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new AnonymousClass1(this.$sheetState, target, f, null), 3, null);
    }
