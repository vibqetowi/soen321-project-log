...
public final class NavigationRailKt$NavigationRail$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(PaddingKt.m750paddingVpY3zN4$default(SizeKt.m802widthInVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), this.$windowInsets), NavigationRailTokens.INSTANCE.m2570getContainerWidthD9Ej5fM(), 0.0f, 2, null), 0.0f, NavigationRailKt.getNavigationRailVerticalPadding(), 1, null));
            Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
            Arrangement.HorizontalOrVertical m655spacedBy0680j_4 = Arrangement.INSTANCE.m655spacedBy0680j_4(NavigationRailKt.getNavigationRailVerticalPadding());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 716053607, "C127@5756L9:NavigationRail.kt#uh7d8r");
            composer.startReplaceableGroup(716053607);
            ComposerKt.sourceInformation(composer, "124@5652L8,125@5677L52");
            if (function3 != null) {
                function3.invoke(columnScopeInstance, composer, Integer.valueOf(((i2 >> 6) & 112) | 6));
                f = NavigationRailKt.NavigationRailHeaderPadding;
                SpacerKt.Spacer(SizeKt.m781height3ABfNKs(Modifier.Companion, f), composer, 6);
            }
