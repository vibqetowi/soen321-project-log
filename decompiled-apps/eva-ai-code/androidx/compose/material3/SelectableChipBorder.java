...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m448BorderStrokecXLIe8U(z2 ? this.selectedBorderWidth : this.borderWidth, j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.borderColor, selectableChipBorder.borderColor) && Color.m3292equalsimpl0(this.selectedBorderColor, selectableChipBorder.selectedBorderColor) && Color.m3292equalsimpl0(this.disabledBorderColor, selectableChipBorder.disabledBorderColor) && Color.m3292equalsimpl0(this.disabledSelectedBorderColor, selectableChipBorder.disabledSelectedBorderColor) && Dp.m5612equalsimpl0(this.borderWidth, selectableChipBorder.borderWidth) && Dp.m5612equalsimpl0(this.selectedBorderWidth, selectableChipBorder.selectedBorderWidth);
    }

    public int hashCode() {
        return (((((((((Color.m3298hashCodeimpl(this.borderColor) * 31) + Color.m3298hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m3298hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3298hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5613hashCodeimpl(this.borderWidth)) * 31) + Dp.m5613hashCodeimpl(this.selectedBorderWidth);
    }
}
