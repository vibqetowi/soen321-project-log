...
public final class CheckboxColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m3292equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m3292equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m3292equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m3292equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m3292equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m3292equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m3292equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m3292equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m3292equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m3292equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((Color.m3298hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m3298hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m3298hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m3298hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m3298hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m3298hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m3298hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m3298hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m3298hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m3298hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3298hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
