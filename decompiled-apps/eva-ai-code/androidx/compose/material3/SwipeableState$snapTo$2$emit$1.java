...
@DebugMetadata(c = "androidx.compose.material3.SwipeableState$snapTo$2", f = "Swipeable.kt", i = {0}, l = {TypedValues.AttributesType.TYPE_PATH_ROTATE}, m = "emit", n = {"this"}, s = {"L$0"})
