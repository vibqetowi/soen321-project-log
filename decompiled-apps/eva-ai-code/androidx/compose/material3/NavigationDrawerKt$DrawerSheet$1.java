...
public final class NavigationDrawerKt$DrawerSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            f = NavigationDrawerKt.MinimumDrawerWidth;
            Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m799sizeInqDBjuR0$default(Modifier.Companion, f, 0.0f, DrawerDefaults.INSTANCE.m1775getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, null), this.$windowInsets);
