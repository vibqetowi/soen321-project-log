...
public final class MenuItemColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3281boximpl(z ? this.leadingIconColor : this.disabledLeadingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3281boximpl(z ? this.trailingIconColor : this.disabledTrailingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m3292equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m3292equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m3292equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m3292equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m3292equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((Color.m3298hashCodeimpl(this.textColor) * 31) + Color.m3298hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3298hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3298hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3298hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3298hashCodeimpl(this.disabledTrailingIconColor);
    }
}
