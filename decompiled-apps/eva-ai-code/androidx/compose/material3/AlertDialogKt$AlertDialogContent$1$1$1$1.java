...
final class AlertDialogKt$AlertDialogContent$1$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier align = columnScope.align(PaddingKt.padding(Modifier.Companion, paddingValues), Alignment.Companion.getCenterHorizontally());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 691155642, "C67@2381L6:AlertDialog.kt#uh7d8r");
