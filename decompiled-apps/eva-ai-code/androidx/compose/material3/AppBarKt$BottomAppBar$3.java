...
public final class AppBarKt$BottomAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m781height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m2288getContainerHeightD9Ej5fM()), this.$contentPadding);
