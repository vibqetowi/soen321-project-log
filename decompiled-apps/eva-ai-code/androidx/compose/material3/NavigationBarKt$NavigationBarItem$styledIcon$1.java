...
public final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier.Companion clearAndSetSemantics = this.$label != null && (this.$alwaysShowLabel || this.$selected) ? SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, AnonymousClass1.INSTANCE) : Modifier.Companion;
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1844200490, "C175@8215L78:NavigationBar.kt#uh7d8r");
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3281boximpl(invoke$lambda$0(iconColor$material3_release)))}, function2, composer, ((i3 >> 6) & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
