...
public final class IconButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m3292equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m3292equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m3292equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m3298hashCodeimpl(this.containerColor) * 31) + Color.m3298hashCodeimpl(this.contentColor)) * 31) + Color.m3298hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3298hashCodeimpl(this.disabledContentColor);
    }
}
