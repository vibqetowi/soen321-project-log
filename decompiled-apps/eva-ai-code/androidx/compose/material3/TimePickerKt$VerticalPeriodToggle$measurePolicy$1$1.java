    ...
    public final MeasureResult mo272measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long j) {
        ...
        for (Measurable measurable : list) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                Placeable mo4545measureBRTryo0 = measurable.mo4545measureBRTryo0(Constraints.m5542copyZbe2FdA$default(j, 0, 0, 0, MathKt.roundToInt(MeasurePolicy.mo588toPx0680j_4(TimePickerTokens.INSTANCE.m2760getPeriodSelectorOutlineWidthD9Ej5fM())), 3, null));
                ...
                for (Measurable measurable2 : arrayList2) {
                    arrayList3.add(measurable2.mo4545measureBRTryo0(Constraints.m5542copyZbe2FdA$default(j, 0, 0, 0, Constraints.m5550getMaxHeightimpl(j) / 2, 3, null)));
                }
                return MeasureScope.CC.layout$default(MeasurePolicy, Constraints.m5551getMaxWidthimpl(j), Constraints.m5550getMaxHeightimpl(j), null, new TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$measure$1(arrayList3, mo4545measureBRTryo0), 4, null);
            }
        }
