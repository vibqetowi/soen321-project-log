...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1838constructorimpl(0);
    private static final int StartDateInput = m1838constructorimpl(1);
    private static final int EndDateInput = m1838constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1837boximpl(int i) {
    ...
    public static boolean m1839equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).m1843unboximpl();
    }
    ...
    public static String m1842toStringimpl(int i) {
        return m1840equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m1840equalsimpl0(i, StartDateInput) ? "StartDateInput" : m1840equalsimpl0(i, EndDateInput) ? "EndDateInput" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
