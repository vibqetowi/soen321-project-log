...
public final class FabPosition {
    ...
    private static final int Center = m1791constructorimpl(0);
    private static final int End = m1791constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FabPosition m1790boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1791constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1792equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).m1796unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1792equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1794hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m1796unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m1797getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs  reason: not valid java name */
        public final int m1798getEndERTFSPs() {
    ...
    public String toString() {
        return m1795toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1795toStringimpl(int i) {
        return m1793equalsimpl0(i, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}
