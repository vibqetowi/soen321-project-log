...
public final class RichTooltipColors {
    ...
    public final long m1946getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m1947getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m1948getTitleContentColor0d7_KjU() {
        return this.titleContentColor;
    }

    /* renamed from: getActionContentColor-0d7_KjU  reason: not valid java name */
    public final long m1945getActionContentColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RichTooltipColors) {
            ...
            return Color.m3292equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m3292equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m3292equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m3292equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((Color.m3298hashCodeimpl(this.containerColor) * 31) + Color.m3298hashCodeimpl(this.contentColor)) * 31) + Color.m3298hashCodeimpl(this.titleContentColor)) * 31) + Color.m3298hashCodeimpl(this.actionContentColor);
    }
}
