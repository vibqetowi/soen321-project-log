...
public final class SliderColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m3292equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m3292equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m3292equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m3292equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m3292equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m3292equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m3292equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m3292equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m3292equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3298hashCodeimpl(this.thumbColor) * 31) + Color.m3298hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3298hashCodeimpl(this.activeTickColor)) * 31) + Color.m3298hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3298hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3298hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3298hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3298hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3298hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3298hashCodeimpl(this.disabledInactiveTickColor);
    }
}
