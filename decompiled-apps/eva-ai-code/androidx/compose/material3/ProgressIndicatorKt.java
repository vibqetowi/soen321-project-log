...
public final class ProgressIndicatorKt {
    ...
    private static final float LinearIndicatorHeight = LinearProgressIndicatorTokens.INSTANCE.m2538getTrackHeightD9Ej5fM();
    private static final float CircularIndicatorDiameter = Dp.m5607constructorimpl(CircularProgressIndicatorTokens.INSTANCE.m2310getSizeD9Ej5fM() - Dp.m5607constructorimpl(CircularProgressIndicatorTokens.INSTANCE.m2309getActiveIndicatorWidthD9Ej5fM() * 2));
    ...
    /* JADX WARN: Removed duplicated region for block: B:85:0x0148 A[LOOP:0: B:84:0x0146->B:85:0x0148, LOOP_END] */
    ...
    */
    public static final void m1931LinearProgressIndicator_5eSRE(float f, Modifier modifier, long j, long j2, int i, Composer composer, int i2, int i3) {
        int i4;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)75@3530L11,76@3593L16,84@3883L194,80@3741L336:ProgressIndicator.kt#uh7d8r");
        if ((i3 & 1) != 0) {
            i4 = i2 | 6;
        } else if ((i2 & 14) == 0) {
        ...
        if (i10 != 0) {
            ...
            if (i5 == 0) {
                ...
                if ((i4 & 46811) == 9362 || !startRestartGroup.getSkipping()) {
                    ...
                    if ((i2 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i5 != 0) {
                            i6 = ProgressIndicatorDefaults.INSTANCE.m1924getLinearStrokeCapKaPHkGw();
                        }
                    } else {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(905419617, i2, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:72)");
                    }
                    ...
                    Object[] objArr = {Color.m3281boximpl(j4), StrokeCap.m3637boximpl(i6), Float.valueOf(coerceIn), Color.m3281boximpl(j3)};
                    ...
                    if (!z || rememberedValue == Composer.Companion.getEmpty()) {
                        rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$1$1(j4, i6, coerceIn, j3);
                ...
                endRestartGroup.updateScope(new ProgressIndicatorKt$LinearProgressIndicator$2(f, companion, j5, j6, i6, i2, i3));
                return;
            }
            i6 = i;
            if ((i4 & 46811) == 9362) {
            ...
            Object[] objArr2 = {Color.m3281boximpl(j4), StrokeCap.m3637boximpl(i6), Float.valueOf(coerceIn2), Color.m3281boximpl(j3)};
            startRestartGroup.startReplaceableGroup(-568225417);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            i7 = 0;
            z = false;
            ...
            rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$1$1(j4, i6, coerceIn2, j3);
            startRestartGroup.updateRememberedValue(rememberedValue);
            startRestartGroup.endReplaceableGroup();
        ...
        Modifier m797sizeVpY3zN422 = SizeKt.m797sizeVpY3zN4(ProgressSemanticsKt.progressSemantics$default(companion, coerceIn22, null, 0, 6, null), LinearIndicatorWidth, LinearIndicatorHeight);
        Object[] objArr22 = {Color.m3281boximpl(j4), StrokeCap.m3637boximpl(i6), Float.valueOf(coerceIn22), Color.m3281boximpl(j3)};
        startRestartGroup.startReplaceableGroup(-568225417);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
        i7 = 0;
        z = false;
        ...
        rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$1$1(j4, i6, coerceIn22, j3);
        startRestartGroup.updateRememberedValue(rememberedValue);
        startRestartGroup.endReplaceableGroup();
        CanvasKt.Canvas(m797sizeVpY3zN422, (Function1) rememberedValue, startRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
        }
        long j522 = j3;
        long j622 = j4;
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x01f9 A[LOOP:0: B:74:0x01f7->B:75:0x01f9, LOOP_END] */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1929LinearProgressIndicator2cYBFYY(Modifier modifier, long j, long j2, int i, Composer composer, int i2, int i3) {
        Object obj;
        int i4;
        long j3;
        long j4;
        int i5;
        Modifier.Companion companion;
        int m1924getLinearStrokeCapKaPHkGw;
        long j5;
        long j6;
        boolean z;
        int i6;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(LinearProgressIndicator)P(1,0:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.StrokeCap)109@5065L11,110@5128L16,113@5249L28,117@5531L319,128@5894L319,139@6258L323,150@6626L323,165@7081L660,161@6954L787:ProgressIndicator.kt#uh7d8r");
        int i10 = i3 & 1;
        if (i10 != 0) {
            i4 = i2 | 6;
            obj = modifier;
        ...
        if (i11 != 0) {
            ...
            if ((i4 & 5851) == 1170 || !startRestartGroup.getSkipping()) {
                ...
                if ((i2 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if (i11 != 0) {
                        m1924getLinearStrokeCapKaPHkGw = ProgressIndicatorDefaults.INSTANCE.m1924getLinearStrokeCapKaPHkGw();
                        j5 = j3;
                        j6 = j4;
                        startRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-476865359, i2, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:107)");
                        }
                        InfiniteTransition rememberInfiniteTransition = InfiniteTransitionKt.rememberInfiniteTransition(null, startRestartGroup, 0, 1);
                        State<Float> animateFloat = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                        State<Float> animateFloat2 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                        State<Float> animateFloat3 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                        ...
                        Object[] objArr = {Color.m3281boximpl(j6), StrokeCap.m3637boximpl(m1924getLinearStrokeCapKaPHkGw), animateFloat, animateFloat2, Color.m3281boximpl(j5), animateFloat3, animateFloat4};
                        startRestartGroup.startReplaceableGroup(-568225417);
                        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
                        z = false;
                        for (i6 = 0; i6 < 7; i6++) {
                        ...
                        rememberedValue = startRestartGroup.rememberedValue();
                        if (!z || rememberedValue == Composer.Companion.getEmpty()) {
                            rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$3$1(j6, m1924getLinearStrokeCapKaPHkGw, animateFloat, animateFloat2, j5, animateFloat3, animateFloat4);
                            startRestartGroup.updateRememberedValue(rememberedValue);
                        }
                        startRestartGroup.endReplaceableGroup();
                        CanvasKt.Canvas(m797sizeVpY3zN4, (Function1) rememberedValue, startRestartGroup, 0);
                        ...
                        j3 = j5;
                        j7 = j6;
                        i7 = m1924getLinearStrokeCapKaPHkGw;
                    }
                } else {
                    startRestartGroup.skipToGroupEnd();
                    companion = obj;
                ...
                j5 = j3;
                j6 = j4;
                m1924getLinearStrokeCapKaPHkGw = i5;
                startRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                }
                ...
                State<Float> animateFloat5 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition2, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                State<Float> animateFloat22 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition2, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                State<Float> animateFloat32 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition2, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
                ...
                Object[] objArr2 = {Color.m3281boximpl(j6), StrokeCap.m3637boximpl(m1924getLinearStrokeCapKaPHkGw), animateFloat5, animateFloat22, Color.m3281boximpl(j5), animateFloat32, animateFloat42};
                startRestartGroup.startReplaceableGroup(-568225417);
                ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
                z = false;
                while (i6 < 7) {
                ...
                rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$3$1(j6, m1924getLinearStrokeCapKaPHkGw, animateFloat5, animateFloat22, j5, animateFloat32, animateFloat42);
                startRestartGroup.updateRememberedValue(rememberedValue);
                startRestartGroup.endReplaceableGroup();
                CanvasKt.Canvas(m797sizeVpY3zN42, (Function1) rememberedValue, startRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        State<Float> animateFloat52 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition22, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
        State<Float> animateFloat222 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition22, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
        State<Float> animateFloat322 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition22, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
        State<Float> animateFloat422 = InfiniteTransitionKt.animateFloat(rememberInfiniteTransition22, 0.0f, 1.0f, AnimationSpecKt.m352infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineTail$1.INSTANCE), null, 0L, 6, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
        Modifier m797sizeVpY3zN422 = SizeKt.m797sizeVpY3zN4(ProgressSemanticsKt.progressSemantics(companion), LinearIndicatorWidth, LinearIndicatorHeight);
        Object[] objArr22 = {Color.m3281boximpl(j6), StrokeCap.m3637boximpl(m1924getLinearStrokeCapKaPHkGw), animateFloat52, animateFloat222, Color.m3281boximpl(j5), animateFloat322, animateFloat422};
        startRestartGroup.startReplaceableGroup(-568225417);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
        z = false;
        while (i6 < 7) {
        ...
        rememberedValue = new ProgressIndicatorKt$LinearProgressIndicator$3$1(j6, m1924getLinearStrokeCapKaPHkGw, animateFloat52, animateFloat222, j5, animateFloat322, animateFloat422);
        startRestartGroup.updateRememberedValue(rememberedValue);
        startRestartGroup.endReplaceableGroup();
        CanvasKt.Canvas(m797sizeVpY3zN422, (Function1) rememberedValue, startRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final /* synthetic */ void m1932LinearProgressIndicatoreaDK9VM(float f, Modifier modifier, long j, long j2, Composer composer, int i, int i2) {
        int i3;
        Object obj;
        long j3;
        long j4;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,3:c#ui.graphics.Color)194@7971L11,195@8034L16,196@8056L140:ProgressIndicator.kt#uh7d8r");
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
            ...
            if ((i3 & 5851) == 1170 || !startRestartGroup.getSkipping()) {
                ...
                if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i2 & 8) != 0) {
                        ...
                        startRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-372717133, i3, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:191)");
                        }
                        m1931LinearProgressIndicator_5eSRE(f, companion, j5, linearTrackColor, ProgressIndicatorDefaults.INSTANCE.m1924getLinearStrokeCapKaPHkGw(), startRestartGroup, (i3 & 14) | 24576 | (i3 & 112) | (i3 & 896) | (i3 & 7168), 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        j3 = j5;
    ...
    public static final /* synthetic */ void m1930LinearProgressIndicatorRIQooxk(Modifier modifier, long j, long j2, Composer composer, int i, int i2) {
        Object obj;
        int i3;
        long j3;
        long j4;
        ...
        if ((i3 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            m1929LinearProgressIndicator2cYBFYY(companion, j5, j6, ProgressIndicatorDefaults.INSTANCE.m1924getLinearStrokeCapKaPHkGw(), startRestartGroup, (i5 & 14) | CipherStorageKeystoreRsaEcb.ENCRYPTION_KEY_SIZE | (i5 & 112) | (i5 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            j4 = j6;
    ...
    public static final void m1942drawLinearIndicatorqYKTg0g(DrawScope drawScope, float f, float f2, long j, float f3, int i) {
    ...
    public static final void m1943drawLinearIndicatorTrackAZGd3zU(DrawScope drawScope, long j, float f, int i) {
        m1942drawLinearIndicatorqYKTg0g(drawScope, 0.0f, 1.0f, j, f, i);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1925CircularProgressIndicatorDUhRLBM(float f, Modifier modifier, long j, float f2, long j2, int i, Composer composer, int i2, int i3) {
        int i4;
        Modifier.Companion companion;
        long j3;
        int i5;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(CircularProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.unit.Dp,5:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)289@11687L13,291@11821L18,*295@12015L7,298@12096L365:ProgressIndicator.kt#uh7d8r");
        if ((i3 & 1) != 0) {
            i4 = i2 | 6;
        } else if ((i2 & 14) == 0) {
            i4 = (startRestartGroup.changed(f) ? 4 : 2) | i2;
                ...
                if (i6 != 0) {
                    ...
                    if ((i4 & 374491) == 74898 || !startRestartGroup.getSkipping()) {
                        ...
                        if ((i2 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i5 != 0) {
                                f3 = ProgressIndicatorDefaults.INSTANCE.m1923getCircularStrokeWidthD9Ej5fM();
                            }
                            if ((i3 & 16) != 0) {
                                j4 = ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6);
                            }
                            if (i6 != 0) {
                                i7 = ProgressIndicatorDefaults.INSTANCE.m1921getCircularDeterminateStrokeCapKaPHkGw();
                            }
                        } else {
                            startRestartGroup.skipToGroupEnd();
                        }
                        startRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1472321743, i2, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:286)");
                        }
                        float coerceIn = RangesKt.coerceIn(f, 0.0f, 1.0f);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1926CircularProgressIndicatorLxG7B9w(Modifier modifier, long j, float f, long j2, int i, Composer composer, int i2, int i3) {
        Object obj;
        int i4;
        long j3;
        float f2;
        ...
        int i6;
        Modifier.Companion companion;
        int m1922getCircularIndeterminateStrokeCapKaPHkGw;
        float f3;
        long j5;
        long j6;
        int i7;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(CircularProgressIndicator)P(1,0:c#ui.graphics.Color,3:c#ui.unit.Dp,4:c#ui.graphics.Color,2:c#ui.graphics.StrokeCap)330@13521L13,332@13655L18,*335@13799L7,339@13898L28,341@14055L278,353@14447L230,364@14794L345,375@15172L354,386@15531L737:ProgressIndicator.kt#uh7d8r");
        int i10 = i3 & 1;
        if (i10 != 0) {
            i4 = i2 | 6;
            obj = modifier;
        ...
        if (i11 != 0) {
            ...
            if (i5 == 0) {
                ...
                if ((i4 & 46811) == 9362 || !startRestartGroup.getSkipping()) {
                    ...
                    if ((i2 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i5 != 0) {
                            ...
                            j6 = j3;
                            obj = modifier2;
                            i7 = m1922getCircularIndeterminateStrokeCapKaPHkGw;
                            j7 = j5;
                        }
                    } else {
                        startRestartGroup.skipToGroupEnd();
                    ...
                    f3 = f2;
                    j5 = j4;
                    m1922getCircularIndeterminateStrokeCapKaPHkGw = i6;
                    startRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                    }
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                ...
                endRestartGroup.updateScope(new ProgressIndicatorKt$CircularProgressIndicator$4(obj, j6, f2, j7, i7, i2, i3));
                return;
            }
            i6 = i;
            if ((i4 & 46811) == 9362) {
        ...
        Object consume222 = startRestartGroup.consume(CompositionLocalsKt.getLocalDensity());
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        Stroke stroke222 = new Stroke(((Density) consume222).mo588toPx0680j_4(f3), 0.0f, m1922getCircularIndeterminateStrokeCapKaPHkGw, 0, null, 26, null);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final /* synthetic */ void m1927CircularProgressIndicatorMBs18nI(float f, Modifier modifier, long j, float f2, Composer composer, int i, int i2) {
        int i3;
        Object obj;
        long j2;
        int i4;
        float f3;
        Modifier.Companion companion;
        float m1923getCircularStrokeWidthD9Ej5fM;
        long j3;
        ScopeUpdateScope endRestartGroup;
        int i5;
        Composer startRestartGroup = composer.startRestartGroup(402841196);
        ComposerKt.sourceInformation(startRestartGroup, "C(CircularProgressIndicator)P(2,1,0:c#ui.graphics.Color,3:c#ui.unit.Dp)415@16500L13,422@16713L18,417@16587L219:ProgressIndicator.kt#uh7d8r");
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
            i3 = (startRestartGroup.changed(f) ? 4 : 2) | i;
            ...
            if (i4 == 0) {
                ...
                if ((i3 & 5851) == 1170 || !startRestartGroup.getSkipping()) {
                    ...
                    if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i4 != 0) {
                            m1923getCircularStrokeWidthD9Ej5fM = ProgressIndicatorDefaults.INSTANCE.m1923getCircularStrokeWidthD9Ej5fM();
                            j3 = j2;
                            startRestartGroup.endDefaults();
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(402841196, i3, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:412)");
                            }
                            m1925CircularProgressIndicatorDUhRLBM(f, companion, j3, m1923getCircularStrokeWidthD9Ej5fM, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6), ProgressIndicatorDefaults.INSTANCE.m1921getCircularDeterminateStrokeCapKaPHkGw(), startRestartGroup, 196608 | (i3 & 14) | (i3 & 112) | (i3 & 896) | (i3 & 7168), 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                    ...
                    j3 = j2;
                    m1923getCircularStrokeWidthD9Ej5fM = f3;
                    startRestartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                    }
                    m1925CircularProgressIndicatorDUhRLBM(f, companion, j3, m1923getCircularStrokeWidthD9Ej5fM, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6), ProgressIndicatorDefaults.INSTANCE.m1921getCircularDeterminateStrokeCapKaPHkGw(), startRestartGroup, 196608 | (i3 & 14) | (i3 & 112) | (i3 & 896) | (i3 & 7168), 0);
                ...
                endRestartGroup.updateScope(new ProgressIndicatorKt$CircularProgressIndicator$5(f, companion, j3, m1923getCircularStrokeWidthD9Ej5fM, i, i2));
                return;
            }
            f3 = f2;
            if ((i3 & 5851) == 1170) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final /* synthetic */ void m1928CircularProgressIndicatoraMcp0Q(Modifier modifier, long j, float f, Composer composer, int i, int i2) {
        Object obj;
        int i3;
        long j2;
        float f2;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(CircularProgressIndicator)P(1,0:c#ui.graphics.Color,2:c#ui.unit.Dp)430@17015L13,436@17214L18,432@17102L207:ProgressIndicator.kt#uh7d8r");
        int i5 = i2 & 1;
        if (i5 != 0) {
            i3 = i | 6;
            obj = modifier;
            ...
            if ((i3 & 731) == 146 || !startRestartGroup.getSkipping()) {
                ...
                if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if (i6 != 0) {
                        ...
                        startRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(947193756, i7, -1, "androidx.compose.material3.CircularProgressIndicator (ProgressIndicator.kt:428)");
                        }
                        m1926CircularProgressIndicatorLxG7B9w(companion, j3, m1923getCircularStrokeWidthD9Ej5fM, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6), ProgressIndicatorDefaults.INSTANCE.m1922getCircularIndeterminateStrokeCapKaPHkGw(), startRestartGroup, (i7 & 14) | 24576 | (i7 & 112) | (i7 & 896), 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        f2 = m1923getCircularStrokeWidthD9Ej5fM;
                    }
                } else {
                    startRestartGroup.skipToGroupEnd();
                    if ((i2 & 2) != 0) {
                ...
                m1923getCircularStrokeWidthD9Ej5fM = f2;
                long j42 = j2;
                int i72 = i3;
                j3 = j42;
                startRestartGroup.endDefaults();
                ...
                m1926CircularProgressIndicatorLxG7B9w(companion, j3, m1923getCircularStrokeWidthD9Ej5fM, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6), ProgressIndicatorDefaults.INSTANCE.m1922getCircularIndeterminateStrokeCapKaPHkGw(), startRestartGroup, (i72 & 14) | 24576 | (i72 & 112) | (i72 & 896), 0);
                if (ComposerKt.isTraceInProgress()) {
                }
                f2 = m1923getCircularStrokeWidthD9Ej5fM;
            } else {
        ...
        m1926CircularProgressIndicatorLxG7B9w(companion, j3, m1923getCircularStrokeWidthD9Ej5fM, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor(startRestartGroup, 6), ProgressIndicatorDefaults.INSTANCE.m1922getCircularIndeterminateStrokeCapKaPHkGw(), startRestartGroup, (i722 & 14) | 24576 | (i722 & 112) | (i722 & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
        }
        f2 = m1923getCircularStrokeWidthD9Ej5fM;
        endRestartGroup = startRestartGroup.endRestartGroup();
    ...
    private static final void m1938drawCircularIndicator42QJj7c(DrawScope drawScope, float f, float f2, long j, Stroke stroke) {
        float f3 = 2;
    ...
    public static final void m1939drawCircularIndicatorTrackbw27NRU(DrawScope drawScope, long j, Stroke stroke) {
        m1938drawCircularIndicator42QJj7c(drawScope, 0.0f, 360.0f, j, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawDeterminateCircularIndicator-42QJj7c  reason: not valid java name */
    public static final void m1940drawDeterminateCircularIndicator42QJj7c(DrawScope drawScope, float f, float f2, long j, Stroke stroke) {
        m1938drawCircularIndicator42QJj7c(drawScope, f, f2, j, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawIndeterminateCircularIndicator-hrjfTZI  reason: not valid java name */
    public static final void m1941drawIndeterminateCircularIndicatorhrjfTZI(DrawScope drawScope, float f, float f2, float f3, long j, Stroke stroke) {
        m1938drawCircularIndicator42QJj7c(drawScope, f + (StrokeCap.m3640equalsimpl0(stroke.m3908getCapKaPHkGw(), StrokeCap.Companion.m3644getButtKaPHkGw()) ? 0.0f : ((f2 / Dp.m5607constructorimpl(CircularIndicatorDiameter / 2)) * 57.29578f) / 2.0f), Math.max(f3, 0.1f), j, stroke);
    }
