...
public final class TopAppBarColors {
    ...
    public final long m2263getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m2264getTitleContentColor0d7_KjU$material3_release() {
        return this.titleContentColor;
    }

    /* renamed from: getActionIconContentColor-0d7_KjU$material3_release  reason: not valid java name */
    public final long m2262getActionIconContentColor0d7_KjU$material3_release() {
        return this.actionIconContentColor;
    }

    /* renamed from: containerColor-XeAY9LY$material3_release  reason: not valid java name */
    public final long m2261containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m3342lerpjxsXWHM = ColorKt.m3342lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3342lerpjxsXWHM;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3292equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m3292equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m3292equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m3292equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m3292equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m3298hashCodeimpl(this.containerColor) * 31) + Color.m3298hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3298hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3298hashCodeimpl(this.titleContentColor)) * 31) + Color.m3298hashCodeimpl(this.actionIconContentColor);
    }
}
