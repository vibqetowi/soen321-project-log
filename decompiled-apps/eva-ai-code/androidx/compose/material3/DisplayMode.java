...
public final class DisplayMode {
    ...
    private static final int Picker = m1760constructorimpl(0);
    private static final int Input = m1760constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1759boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1760constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1761equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).m1765unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1761equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1763hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1767getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0  reason: not valid java name */
        public final int m1766getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    public String toString() {
        return m1764toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1764toStringimpl(int i) {
        return m1762equalsimpl0(i, Picker) ? "Picker" : m1762equalsimpl0(i, Input) ? "Input" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
