...
public final class DatePickerState {
    ...
    public final int m1743getDisplayModejFl4v0() {
        return ((DisplayMode) this.displayMode$delegate.getValue()).m1765unboximpl();
    }

    /* renamed from: setDisplayMode-vCnGnXg  reason: not valid java name */
    public final void m1744setDisplayModevCnGnXg(int i) {
        this.displayMode$delegate.setValue(DisplayMode.m1759boximpl(i));
    }
