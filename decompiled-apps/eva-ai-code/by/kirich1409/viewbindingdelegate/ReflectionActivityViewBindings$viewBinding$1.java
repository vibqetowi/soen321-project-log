...
final class ReflectionActivityViewBindings$viewBinding$1 extends Lambda implements Function1<ComponentActivity, T> {
    final /* synthetic */ Class<T> $viewBindingClass;
    final /* synthetic */ int $viewBindingRootId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReflectionActivityViewBindings$viewBinding$1(int i, Class<T> cls) {
        super(1);
    ...
    public final ViewBinding invoke(ComponentActivity activity) {
        ...
        return ViewBindingCache.INSTANCE.getBind$com_github_kirich1409_ViewBindingPropertyDelegate(this.$viewBindingClass).bind(requireViewById);
    }
}
