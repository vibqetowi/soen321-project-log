...
public final class ReflectionFragmentViewBindings$viewBinding$3 extends Lambda implements Function1<Fragment, T> {
    final /* synthetic */ Fragment $this_viewBinding;
    final /* synthetic */ Class<T> $viewBindingClass;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReflectionFragmentViewBindings$viewBinding$3(Class<T> cls, Fragment fragment) {
        super(1);
