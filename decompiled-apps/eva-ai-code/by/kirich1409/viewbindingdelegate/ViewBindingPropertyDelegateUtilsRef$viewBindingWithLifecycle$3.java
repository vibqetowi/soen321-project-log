...
public final class ViewBindingPropertyDelegateUtilsRef$viewBindingWithLifecycle$3 extends Lambda implements Function1<R, VB> {
    final /* synthetic */ boolean $attachToParent;
    final /* synthetic */ LayoutInflater $layoutInflater;
    final /* synthetic */ ViewGroup $parent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ViewBindingPropertyDelegateUtilsRef$viewBindingWithLifecycle$3(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        super(1);
