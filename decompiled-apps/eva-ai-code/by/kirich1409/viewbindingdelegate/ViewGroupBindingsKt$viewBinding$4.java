...
public final class ViewGroupBindingsKt$viewBinding$4 extends Lambda implements Function1<ViewGroup, T> {
    final /* synthetic */ Function1<View, T> $vbFactory;
    final /* synthetic */ int $viewBindingRootId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ViewGroupBindingsKt$viewBinding$4(Function1<? super View, ? extends T> function1, int i) {
        super(1);
