...
public final class FullInflateViewBinding<VB extends ViewBinding> extends InflateViewBinding<VB> {
    ...
    public FullInflateViewBinding(Method inflateViewBinding) {
    ...
    public VB inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        ...
        Object invoke = this.inflateViewBinding.invoke(null, layoutInflater, viewGroup, Boolean.valueOf(z));
        if (invoke != null) {
            return (VB) invoke;
        }
