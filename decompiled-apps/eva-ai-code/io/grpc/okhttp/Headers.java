...
class Headers {
    ...
    private static boolean isApplicationHeader(String str) {
        return (str.startsWith(CertificateUtil.DELIMITER) || GrpcUtil.CONTENT_TYPE_KEY.name().equalsIgnoreCase(str) || GrpcUtil.USER_AGENT_KEY.name().equalsIgnoreCase(str)) ? false : true;
    }
}
