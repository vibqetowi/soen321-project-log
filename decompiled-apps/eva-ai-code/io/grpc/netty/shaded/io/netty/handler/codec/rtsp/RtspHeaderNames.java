...
public final class RtspHeaderNames {
    ...
    public static final AsciiString SESSION = AsciiString.cached(EnvelopeCache.PREFIX_CURRENT_SESSION_FILE);
    ...
    public static final AsciiString TIMESTAMP = AsciiString.cached(AnalyticsConstants.TIMESTAMP);
