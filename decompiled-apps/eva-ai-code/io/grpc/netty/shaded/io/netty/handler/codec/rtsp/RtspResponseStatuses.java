...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus PARAMETER_IS_READONLY = new HttpResponseStatus(FacebookRequestErrorClassification.ESC_APP_NOT_INSTALLED, "Parameter Is Read-Only");
