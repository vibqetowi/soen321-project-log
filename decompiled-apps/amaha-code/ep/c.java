...
public final class c extends k implements p<ResourceData, Boolean, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ b f14453u;
    ...
    public final hs.k invoke(ResourceData resourceData, Boolean bool) {
        ...
        i.g(model, "model");
        b bVar = this.f14453u;
        Intent putExtra = new Intent(bVar.requireActivity(), ExpertResourceActivity.class).putExtra("fetchData", true).putExtra("slug", model.getSlug());
        Bundle a10 = b0.a("share_source", "home_screen");
        String str4 = "read";
        if (booleanValue) {
            str = "read";
        } else {
        ...
        bVar.startActivity(putExtra.putExtra("share_bundle", a10));
        if (!booleanValue) {
        ...
        Bundle a11 = b0.a("source", "home_screen");
