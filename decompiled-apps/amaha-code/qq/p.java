...
/* compiled from: DepressionPleasurablePickerFragment.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lqq/p;", "Lrr/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
...
public final class p extends rr.b {
    ...
    public final LinkedHashMap f30059w = new LinkedHashMap();

    /* renamed from: v  reason: collision with root package name */
    public final String f30058v = LogHelper.INSTANCE.makeLogTag(p.class);

    public final View _$_findCachedViewById(int i6) {
        View findViewById;
        LinkedHashMap linkedHashMap = this.f30059w;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        try {
            ...
            ((RobertoTextView) _$_findCachedViewById(R.id.header)).setText(getString(R.string.depressionPleasurablePickerHeader));
            ((RobertoTextView) _$_findCachedViewById(R.id.subheader)).setText(getString(R.string.depressionPleasurablePickerSubheader));
            ((RobertoButton) _$_findCachedViewById(R.id.continueCTA)).setText(getString(R.string.commit));
            ...
            while (it.hasNext()) {
                ...
                inflate.setOnClickListener(new ho.o(this, 25, inflate));
            }
            ((RobertoButton) _$_findCachedViewById(R.id.continueCTA)).setOnClickListener(new n(this, 1));
        } catch (Exception e10) {
            LogHelper.INSTANCE.e(this.f30058v, e10);
        }
    }
}
