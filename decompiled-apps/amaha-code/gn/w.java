...
public final class w extends kotlin.jvm.internal.k implements ss.l<SingleUseEvent<? extends Boolean>, hs.k> {
    ...
    public final /* synthetic */ ReworkSignupFragment f16661u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w(ReworkSignupFragment reworkSignupFragment) {
        super(1);
        this.f16661u = reworkSignupFragment;
    }
    ...
    public final hs.k invoke(SingleUseEvent<? extends Boolean> singleUseEvent) {
        ...
        if (singleUseEvent2 != null && (contentIfNotHandled = singleUseEvent2.getContentIfNotHandled()) != null) {
            ...
            ReworkSignupFragment reworkSignupFragment = this.f16661u;
            try {
                if (booleanValue) {
                    int i6 = ReworkSignupFragment.C;
                    reworkSignupFragment.I().dismiss();
