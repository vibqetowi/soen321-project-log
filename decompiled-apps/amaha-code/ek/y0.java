...
/* compiled from: LogGoodThingsStaticAdapter.kt */
/* loaded from: classes2.dex */
public final class y0 extends RecyclerView.e<a> {

    /* renamed from: x  reason: collision with root package name */
    public final ArrayList<ScreenResult1Model> f14354x;

    /* renamed from: y  reason: collision with root package name */
    public final Context f14355y;
    ...
    public final class a extends RecyclerView.c0 {
        ...
        public final RobertoTextView f14356u;

        /* renamed from: v  reason: collision with root package name */
        public final LinearLayout f14357v;

        public a(View view) {
            super(view);
            View findViewById = view.findViewById(R.id.date);
            kotlin.jvm.internal.i.f(findViewById, "itemView.findViewById(R.id.date)");
            this.f14356u = (RobertoTextView) findViewById;
            ...
            this.f14357v = (LinearLayout) findViewById2;
        }
    }

    public y0(Context context, ArrayList goalList) {
        kotlin.jvm.internal.i.g(goalList, "goalList");
        this.f14354x = new ArrayList<>();
        this.f14354x = goalList;
        this.f14355y = context;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.e
    public final int f() {
        return this.f14354x.size();
    }
    ...
    public final void n(a aVar, int i6) {
        boolean z10;
        a aVar2 = aVar;
        ScreenResult1Model screenResult1Model = this.f14354x.get(i6);
        ...
        RobertoTextView robertoTextView = aVar2.f14356u;
        ...
        int i10 = 0;
        while (i10 < size) {
            LayoutInflater from = LayoutInflater.from(this.f14355y);
            LinearLayout linearLayout = aVar2.f14357v;
            ...
            ((RobertoTextView) inflate.findViewById(R.id.content)).setText(screenResult1Model2.getList().get(i10));
