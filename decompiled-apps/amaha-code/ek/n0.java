...
/* compiled from: Log32AdapterNew.kt */
/* loaded from: classes2.dex */
public final class n0 extends RecyclerView.e<a> {
    public final HashSet<String> A;

    /* renamed from: x  reason: collision with root package name */
    public final ArrayList<ScreenResult31Model> f14222x;

    /* renamed from: y  reason: collision with root package name */
    public final Context f14223y;

    /* renamed from: z  reason: collision with root package name */
    public final Calendar f14224z;
    ...
    public final class a extends RecyclerView.c0 {
        ...
        public final RobertoTextView f14225u;

        /* renamed from: v  reason: collision with root package name */
        public final LinearLayout f14226v;

        /* renamed from: w  reason: collision with root package name */
        public final RobertoTextView f14227w;

        public a(View view) {
            super(view);
            View findViewById = view.findViewById(R.id.date);
            kotlin.jvm.internal.i.f(findViewById, "itemView.findViewById(R.id.date)");
            this.f14225u = (RobertoTextView) findViewById;
            ...
            this.f14226v = (LinearLayout) findViewById2;
            ...
            this.f14227w = (RobertoTextView) findViewById3;
        }
    }

    public n0(Context context, ArrayList goalList) {
        kotlin.jvm.internal.i.g(goalList, "goalList");
        this.f14222x = new ArrayList<>();
        Calendar calendar = Calendar.getInstance();
        this.f14224z = calendar;
        this.A = new HashSet<>();
        this.f14222x = goalList;
        this.f14223y = context;
        calendar.clear(11);
        calendar.clear(9);
        calendar.clear(12);
        calendar.clear(10);
    ...
    public final void n(a aVar, int i6) {
        boolean z10;
        a aVar2 = aVar;
        ScreenResult31Model screenResult31Model = this.f14222x.get(i6);
        ...
        Calendar calendar = Calendar.getInstance();
        long j10 = 1000;
        calendar.setTimeInMillis(screenResult31Model2.getDate() * j10);
        calendar.clear(11);
        calendar.clear(9);
        calendar.clear(12);
        calendar.clear(10);
        calendar.clear(13);
        calendar.clear(14);
        Calendar calendar2 = this.f14224z;
        long d10 = defpackage.b.d(calendar, calendar2.getTimeInMillis(), j10);
        HashSet<String> hashSet = this.A;
        RobertoTextView robertoTextView = aVar2.f14225u;
        if (d10 < 86400) {
            ...
            if (z10) {
                ...
                if (hashSet.contains(obj)) {
                    ...
                    Date w10 = defpackage.c.w(screenResult31Model2.getDate() * j10);
                    defpackage.c.A(defpackage.b.n("dd", w10), ' ', defpackage.b.n("MMM", w10), robertoTextView);
                    hashSet.add(obj);
                }
            }
        }
        aVar2.f14227w.setText(DateFormat.format("HH:mm", screenResult31Model2.getDate() * j10).toString());
        Context context = this.f14223y;
        LayoutInflater from = LayoutInflater.from(context);
        LinearLayout linearLayout = aVar2.f14226v;
        View inflate = from.inflate(R.layout.row_log_item_new, (ViewGroup) linearLayout, false);
        ((RobertoTextView) inflate.findViewById(R.id.title)).setText("Person with Shared Identity");
        ((RobertoTextView) inflate.findViewById(R.id.content)).setText(screenResult31Model2.getName());
        linearLayout.addView(inflate);
        View inflate2 = LayoutInflater.from(context).inflate(R.layout.row_log_item_new, (ViewGroup) linearLayout, false);
        ((RobertoTextView) inflate2.findViewById(R.id.title)).setText("Reason");
        ((RobertoTextView) inflate2.findViewById(R.id.content)).setText(screenResult31Model2.getSelection());
