...
public final class o0 extends kotlin.jvm.internal.k implements ss.p<Integer, Long, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ N3ScreenFragment f28620u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ List<?> f28621v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o0(N3ScreenFragment n3ScreenFragment, List<?> list) {
        super(2);
        this.f28620u = n3ScreenFragment;
        this.f28621v = list;
    }
    ...
    public final hs.k invoke(Integer num, Long l2) {
        ...
        N3ScreenFragment n3ScreenFragment = this.f28620u;
        ...
        if (newDynamicParentActivity != null) {
            Object j22 = is.u.j2(intValue, this.f28621v);
