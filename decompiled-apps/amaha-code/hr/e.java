...
/* compiled from: Log22ResultFragment.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lhr/e;", "Lrr/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes2.dex */
public final class e extends rr.b {

    /* renamed from: x  reason: collision with root package name */
    public static final /* synthetic */ int f18323x = 0;

    /* renamed from: w  reason: collision with root package name */
    public final LinkedHashMap f18326w = new LinkedHashMap();

    /* renamed from: u  reason: collision with root package name */
    public final String f18324u = LogHelper.INSTANCE.makeLogTag(e.class);
    ...
    public final void J(ScreenResult22Model screenResult22Model) {
        ...
        while (it.hasNext()) {
            ...
            if (next.getIn2Min()) {
                ...
                ((RobertoTextView) linearLayout.findViewById(R.id.text1)).setText(this.f18325v + ' ' + i6);
    ...
    public final View _$_findCachedViewById(int i6) {
        View findViewById;
        LinkedHashMap linkedHashMap = this.f18326w;
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return inflater.inflate(R.layout.fragment_log22_result, viewGroup, false);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        try {
            ...
            this.f18325v = prefix;
            ((RobertoTextView) _$_findCachedViewById(R.id.textView1)).setText(screenResult22Model.getTitle1());
            ((RobertoTextView) _$_findCachedViewById(R.id.tvRememberLabel1)).setText(screenResult22Model.getRememberLabel());
            ((RobertoTextView) _$_findCachedViewById(R.id.tvRemember1)).setText(screenResult22Model.getRememberText1());
            J(screenResult22Model);
            ((RobertoButton) _$_findCachedViewById(R.id.button1)).setOnClickListener(new a(templateActivity, 4));
            ((ImageView) _$_findCachedViewById(R.id.ivClose)).setOnClickListener(new a(templateActivity, 5));
            ...
            LogHelper.INSTANCE.e(this.f18324u, "exception in on view created", e10);
        }
    }
}
