...
public final class b extends kotlin.jvm.internal.k implements ss.q<Integer, String, Boolean, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ List<LibraryCollection> f676u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ c f677v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(List<LibraryCollection> list, c cVar) {
        super(3);
        this.f676u = list;
        this.f677v = cVar;
    }
    ...
    */
    public final hs.k invoke(Integer num, String str, Boolean bool) {
        ...
        List<LibraryCollection> list = this.f676u;
        ...
        if (libraryCollection != null && (itemList2 = libraryCollection.getItemList()) != null) {
            ...
            if (z13) {
                ...
                a10.putString("source_of_action", "collection_list_view");
