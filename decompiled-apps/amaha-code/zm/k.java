...
public final class k extends RecyclerView.e<a> {
    ...
    public final p<LearningHubModel, Boolean, hs.k> f39664x;

    /* renamed from: y  reason: collision with root package name */
    public final String f39665y;

    /* renamed from: z  reason: collision with root package name */
    public final Context f39666z;
    ...
    public k(ArrayList list, ArrayList filteredList, androidx.fragment.app.p pVar, an.g gVar) {
        kotlin.jvm.internal.i.g(list, "list");
        kotlin.jvm.internal.i.g(filteredList, "filteredList");
        this.f39664x = gVar;
        this.f39665y = LogHelper.INSTANCE.makeLogTag(k.class);
        new ArrayList();
        this.B = 1;
        this.C = 2;
        this.D = 3;
    ...
    */
    public final void n(a aVar, int i6) {
        ...
        try {
            ...
            view.setOnClickListener(new w0(learningHubModel, 16, this));
        } catch (Exception e10) {
            LogHelper.INSTANCE.e(this.f39665y, e10);
        }
    }
    ...
    public final RecyclerView.c0 p(int i6, RecyclerView parent) {
        ...
        if (i6 == 0) {
            return new a(defpackage.e.h(parent, R.layout.row_library_resources_article, parent, false, "from(parent.context)\n   …s_article, parent, false)"));
        }
        if (i6 == this.B) {
            return new a(defpackage.e.h(parent, R.layout.row_library_resources_quotes, parent, false, "from(parent.context).inf…es_quotes, parent, false)"));
        }
        if (i6 == this.C) {
            return new a(defpackage.e.h(parent, R.layout.row_library_resources_creatives, parent, false, "from(parent.context).inf…creatives, parent, false)"));
        }
        if (i6 == this.D) {
            return new a(defpackage.e.h(parent, R.layout.row_library_resources_video, parent, false, "from(parent.context).inf…ces_video, parent, false)"));
        }
        return new a(defpackage.e.h(parent, R.layout.row_library_resources_quotes, parent, false, "from(parent.context).inf…es_quotes, parent, false)"));
    }
}
