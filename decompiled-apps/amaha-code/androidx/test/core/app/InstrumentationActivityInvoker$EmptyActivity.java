...
public class InstrumentationActivityInvoker$EmptyActivity extends Activity {
    ...
    public final BroadcastReceiver f3078u = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker$EmptyActivity.1
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BroadcastReceiver broadcastReceiver = this.f3078u;
    ...
    public final void onDestroy() {
        super.onDestroy();
        unregisterReceiver(this.f3078u);
    }
