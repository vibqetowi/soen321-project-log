...
public final class s implements CustomRetrofitCallback<sf.m> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ u f22342u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ ls.d<ArrayList<String>> f22343v;
    ...
    public final void onFailure(dw.b<sf.m> call, Throwable t3) {
        ...
        LogHelper.INSTANCE.e(this.f22342u.f22353a, t3);
        this.f22343v.resumeWith(new ArrayList());
    }
    ...
    public final void onResponse(dw.b<sf.m> call, dw.z<sf.m> response) {
        ...
        ls.d<ArrayList<String>> dVar = this.f22343v;
        if (a10) {
            try {
                ...
                LogHelper.INSTANCE.e(this.f22342u.f22353a, e10);
