...
public final class t implements CustomRetrofitCallback<sf.m> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ u f22349u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ ls.d<Boolean> f22350v;
    ...
    public final void onFailure(dw.b<sf.m> call, Throwable t3) {
        ...
        LogHelper.INSTANCE.e(this.f22349u.f22353a, t3);
        this.f22350v.resumeWith(null);
    }
    ...
    public final void onResponse(dw.b<sf.m> call, dw.z<sf.m> response) {
        ...
        ls.d<Boolean> dVar = this.f22350v;
        if (a10) {
            try {
                ...
                LogHelper.INSTANCE.e(this.f22349u.f22353a, e10);
                dVar.resumeWith(Boolean.FALSE);
                return;
            }
        }
