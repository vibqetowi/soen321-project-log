...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lrm/l;", "Lrr/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes2.dex */
public final class l extends rr.b {

    /* renamed from: y  reason: collision with root package name */
    public static final /* synthetic */ int f30819y = 0;

    /* renamed from: v  reason: collision with root package name */
    public boolean f30821v;

    /* renamed from: x  reason: collision with root package name */
    public final LinkedHashMap f30823x = new LinkedHashMap();

    /* renamed from: u  reason: collision with root package name */
    public final m0 f30820u = b0.j(this, y.a(um.c.class), new c(this), new d(this), new e(this));

    /* renamed from: w  reason: collision with root package name */
    public final ArrayList<JournalAttachImageModel> f30822w = new ArrayList<>();
    ...
    public static final class a extends kotlin.jvm.internal.k implements ss.l<Integer, hs.k> {
        ...
        /* renamed from: u  reason: collision with root package name */
        public static final a f30824u = new a();
    ...
    public static final class b extends kotlin.jvm.internal.k implements ss.l<Integer, hs.k> {
        ...
        /* renamed from: u  reason: collision with root package name */
        public static final b f30825u = new b();
    ...
    public static final class c extends kotlin.jvm.internal.k implements ss.a<q0> {
        ...
        /* renamed from: u  reason: collision with root package name */
        public final /* synthetic */ Fragment f30826u;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(Fragment fragment) {
            super(0);
            this.f30826u = fragment;
        }

        @Override // ss.a
        public final q0 invoke() {
            return defpackage.e.m(this.f30826u, "requireActivity().viewModelStore");
        }
    }
    ...
    public static final class d extends kotlin.jvm.internal.k implements ss.a<k1.a> {
        ...
        /* renamed from: u  reason: collision with root package name */
        public final /* synthetic */ Fragment f30827u;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(Fragment fragment) {
            super(0);
            this.f30827u = fragment;
        }

        @Override // ss.a
        public final k1.a invoke() {
            return defpackage.b.r(this.f30827u, "requireActivity().defaultViewModelCreationExtras");
        }
    }
    ...
    public static final class e extends kotlin.jvm.internal.k implements ss.a<o0.b> {
        ...
        /* renamed from: u  reason: collision with root package name */
        public final /* synthetic */ Fragment f30828u;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Fragment fragment) {
            super(0);
            this.f30828u = fragment;
        }

        @Override // ss.a
        public final o0.b invoke() {
            return pl.a.e(this.f30828u, "requireActivity().defaultViewModelProviderFactory");
        }
    }

    public final um.c J() {
        return (um.c) this.f30820u.getValue();
    }
    ...
    public final View _$_findCachedViewById(int i6) {
        View findViewById;
        LinkedHashMap linkedHashMap = this.f30823x;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (journalModel != null) {
            ...
            if (list != null) {
                ...
                if (arrayList.size() > 0) {
                    ...
                    if (recyclerView2 != null) {
                        ...
                        recyclerView2.setAdapter(new mm.b(arrayList, requireActivity, true, a.f30824u, b.f30825u));
                    }
                }
            }
            RobertoTextView robertoTextView4 = (RobertoTextView) _$_findCachedViewById(R.id.tvMenuEdit);
            if (robertoTextView4 != null) {
                robertoTextView4.setOnClickListener(new View.OnClickListener(this) { // from class: rm.i

                    /* renamed from: v  reason: collision with root package name */
                    public final /* synthetic */ l f30812v;
                    ...
                    public final void onClick(View view2) {
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                it2.setFavourite(this$0.f30821v);
                                J.h(it2);
            ...
            if (robertoTextView5 != null) {
                robertoTextView5.setOnClickListener(new View.OnClickListener(this) { // from class: rm.j

                    /* renamed from: v  reason: collision with root package name */
                    public final /* synthetic */ l f30815v;
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (robertoTextView6 != null) {
                                    robertoTextView6.setOnClickListener(new View.OnClickListener() { // from class: rm.k
                                        @Override // android.view.View.OnClickListener
                                            ...
                                            switch (i12) {
                                                ...
                                                default:
                                                    ...
                                                    if (this$02.J().G != null) {
                                                        ...
                                                        this$02.J().E.e(this$02.getViewLifecycleOwner(), new qm.c(4, new m(this$02, deletionDialog)));
                                ...
                                if (robertoTextView7 != null) {
                                    robertoTextView7.setOnClickListener(new View.OnClickListener() { // from class: rm.k
                                        @Override // android.view.View.OnClickListener
                                        public final void onClick(View view3) {
                                            String str5;
                                            String str6;
            ...
            if (appCompatImageView != null) {
                appCompatImageView.setOnClickListener(new View.OnClickListener(this) { // from class: rm.i
            ...
            this.f30821v = journalModel.isFavourite();
            ...
            if (appCompatImageView3 != null) {
                appCompatImageView3.setOnClickListener(new View.OnClickListener(this) { // from class: rm.i
        ...
        if (appCompatImageView4 != null) {
            appCompatImageView4.setOnClickListener(new View.OnClickListener(this) { // from class: rm.j
