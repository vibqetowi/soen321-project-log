...
public final class i1 extends kotlin.jvm.internal.k implements ss.q<String, String, Integer, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ V3DashboardActivity f13042u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ V3DashboardActivity f13043v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i1(V3DashboardActivity v3DashboardActivity, V3DashboardActivity v3DashboardActivity2) {
        super(3);
        this.f13042u = v3DashboardActivity;
        this.f13043v = v3DashboardActivity2;
    }
    ...
    public final hs.k invoke(String str, String str2, Integer num) {
        ...
        Intent putExtra = new Intent(this.f13043v, TelecommunicationsPWAActivity.class).putExtra(Constants.TELECOMMUNICATION_REDIRECT, pp.c.PROFILE).putExtra(SessionManager.KEY_UUID, uuid);
        V3DashboardActivity v3DashboardActivity = this.f13042u;
