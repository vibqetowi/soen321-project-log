...
public final class g2 extends BottomSheetBehavior.f {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ V3DashboardActivity f13026a;

    public g2(V3DashboardActivity v3DashboardActivity) {
        this.f13026a = v3DashboardActivity;
    }

    @Override // com.google.android.material.bottomsheet.BottomSheetBehavior.f
    public final void c(int i6, View view) {
        View n02;
        V3DashboardActivity v3DashboardActivity = this.f13026a;
        if (i6 != 1 && i6 != 3) {
