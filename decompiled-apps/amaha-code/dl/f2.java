...
public final class f2 implements Animator.AnimatorListener {
    ...
    public final /* synthetic */ LottieAnimationView f13018a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ V3DashboardActivity f13019b;

    public f2(LottieAnimationView lottieAnimationView, V3DashboardActivity v3DashboardActivity) {
        this.f13018a = lottieAnimationView;
        this.f13019b = v3DashboardActivity;
    }

    @Override // android.animation.Animator.AnimatorListener
    public final void onAnimationCancel(Animator animation) {
        kotlin.jvm.internal.i.g(animation, "animation");
        LottieAnimationView lottieAnimationView = this.f13018a;
        if (lottieAnimationView != null) {
            lottieAnimationView.i();
        }
        Dialog dialog = this.f13019b.f10729j0;
        if (dialog != null) {
            dialog.dismiss();
        } else {
    ...
    public final void onAnimationEnd(Animator animation) {
        kotlin.jvm.internal.i.g(animation, "animation");
        V3DashboardActivity v3DashboardActivity = this.f13019b;
        ...
        if (dialog != null) {
            ...
            if (v3DashboardActivity.f10752x != null) {
                if ((v3DashboardActivity.N0().getAssessments().size() == 1 && v3DashboardActivity.N0().getPlanV3().size() == 1) || (v3DashboardActivity.N0().getAssessments().size() == 2 && v3DashboardActivity.N0().getPlanV3().size() == 16)) {
                    ...
                    V3DashboardActivity v3DashboardActivity2 = this.f13019b;
