...
public final class d extends b<r2.b> {
    public static final String f;

    static {
        String f2 = q.f("NetworkNotRoamingCtrlr");
        i.f(f2, "tagWithPrefix(\"NetworkNotRoamingCtrlr\")");
        f = f2;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(g<r2.b> tracker) {
        super(tracker);
        i.g(tracker, "tracker");
    }
