...
public final class h implements CustomRetrofitCallback<EmailLoginResponseModel> {
    ...
    public final /* synthetic */ kotlinx.coroutines.j<LoginResponse> f17869u;
    ...
    public final void onFailure(dw.b<EmailLoginResponseModel> call, Throwable t3) {
        ...
        this.f17869u.resumeWith(new LoginResponse(null, false, LoginFailure.API_FAILURE, null, 8, null));
    }
    ...
    public final void onResponse(dw.b<EmailLoginResponseModel> call, dw.z<EmailLoginResponseModel> response) {
        ...
        kotlinx.coroutines.j<LoginResponse> jVar = this.f17869u;
        String str2 = null;
