...
public final class c1 extends kotlin.jvm.internal.k implements ss.l<List<? extends c4.h>, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ a1 f26453u;
    ...
    public final hs.k invoke(List<? extends c4.h> list) {
        ...
        if (list2 != null) {
            a1 a1Var = this.f26453u;
            a1Var.getClass();
            a1Var.B = list2;
            String str3 = a1Var.f26421v;
            try {
                ...
                a1Var.f26422w = (MonetizationActivity) requireActivity;
                androidx.fragment.app.y childFragmentManager = a1Var.getChildFragmentManager();
                kotlin.jvm.internal.i.f(childFragmentManager, "this@DynamicCampaignFragment.childFragmentManager");
                ...
                a1Var.D = String.valueOf(str);
                CampaignModel campaignModel2 = a1Var.Y().B;
                if (campaignModel2 != null) {
                    arrayList = campaignModel2.getMainSellingScreen();
                } else {
                    arrayList = null;
                }
                a1Var.H = arrayList;
                if (arrayList != null) {
                    ...
                    while (it4.hasNext()) {
                        ...
                        if (a10 != null) {
                            ...
                            bundle.putString("template_colour", a1Var.D);
                            try {
                                StringBuilder sb2 = new StringBuilder();
                                sb2.append("dynamic_");
                                CampaignModel campaignModel3 = a1Var.Y().B;
                            ...
                            if (gv.r.J0(campaignElementModel.getName(), "CTA")) {
                                ...
                                aVar.f(R.id.dynamicCampaignFragmentBottomSheet, a10, campaignElementModel.getName());
                                aVar.j();
                                childFragmentManager.B();
                            } else {
                                LayoutInflater layoutInflater = a1Var.X().getLayoutInflater();
                                View view = a1Var.getView();
                                if (view != null) {
                                    viewGroup = (ViewGroup) view.findViewById(R.id.dynamicCampaignFragmentMainLayout);
                                } else {
                                    viewGroup = null;
                                }
                                ...
                                if (view2 != null) {
                                    linearLayout = (LinearLayout) view2.findViewById(R.id.dynamicCampaignFragmentMainLayout);
                                } else {
                                    linearLayout = null;
                                }
