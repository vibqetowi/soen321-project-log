...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lnn/j0;", "Lrn/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes2.dex */
public final class j0 extends rn.b {

    /* renamed from: y  reason: collision with root package name */
    public final LinkedHashMap f26525y = new LinkedHashMap();

    /* renamed from: w  reason: collision with root package name */
    public ArrayList<String> f26523w = new ArrayList<>();

    /* renamed from: x  reason: collision with root package name */
    public final String f26524x = LogHelper.INSTANCE.makeLogTag(j0.class);
    ...
    */
    public final void I() {
        ...
        try {
            ...
            if (arguments != null) {
                String string2 = arguments.getString("cb3_desc", "");
                boolean z12 = false;
                if (string2 != null && string2.length() != 0) {
                    ...
                    if (string2 != null) {
                        ((RobertoTextView) _$_findCachedViewById(R.id.cb3Title)).setText(string2);
                    }
                    stringArrayList = arguments.getStringArrayList("cb3_icon_list");
                    if (stringArrayList != null && !stringArrayList.isEmpty()) {
                        ...
                        if (str == null) {
                            ((RobertoTextView) _$_findCachedViewById(R.id.cb3Title)).setTextColor(ColorStateList.valueOf(Color.parseColor(str)));
                            return;
                        }
                        return;
                    }
            ...
            LogHelper.INSTANCE.e(this.f26524x, e10);
        }
    }
    ...
    public final View _$_findCachedViewById(int i6) {
        View findViewById;
        LinkedHashMap linkedHashMap = this.f26525y;
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return inflater.inflate(R.layout.fragment_cb3, viewGroup, false);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        try {
            I();
            int size = this.f26523w.size();
            for (int i6 = 0; i6 < size; i6++) {
                View inflate = getLayoutInflater().inflate(R.layout.row_cb3, (ViewGroup) ((LinearLayout) _$_findCachedViewById(R.id.cb3Container)), false);
                String str = (String) is.u.j2(i6, this.f26523w);
                if (str != null) {
                    if (getActivity() == null) {
                        z10 = true;
                    } else {
                ...
                ((LinearLayout) _$_findCachedViewById(R.id.cb3Container)).addView(inflate);
            }
            F().U();
        } catch (Exception e10) {
            LogHelper.INSTANCE.e(this.f26524x, e10);
