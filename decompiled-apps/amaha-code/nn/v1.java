...
/* compiled from: TB2Fragment.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lnn/v1;", "Lrn/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes2.dex */
public final class v1 extends rn.b {

    /* renamed from: x  reason: collision with root package name */
    public final LinkedHashMap f26632x = new LinkedHashMap();

    /* renamed from: w  reason: collision with root package name */
    public final String f26631w = LogHelper.INSTANCE.makeLogTag(v1.class);
    ...
    */
    public final void I() {
        try {
            ...
            if (arguments != null) {
                String string = arguments.getString("tb2_text");
                String str = null;
                boolean z10 = true;
                if (string != null) {
                    if (gv.n.B0(string)) {
            ...
            ((RobertoTextView) _$_findCachedViewById(R.id.tb1Text)).setGravity(8388611);
        } catch (Exception e10) {
            LogHelper.INSTANCE.e(this.f26631w, e10);
        }
    }
    ...
    public final View _$_findCachedViewById(int i6) {
        View findViewById;
        LinkedHashMap linkedHashMap = this.f26632x;
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return inflater.inflate(R.layout.fragment_tb2, viewGroup, false);
    }
