...
/* compiled from: CB4Fragment.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lnn/k0;", "Lrn/b;", "<init>", "()V", "app_productionRelease"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes2.dex */
public final class k0 extends rn.b {
    public final LinkedHashMap A = new LinkedHashMap();

    /* renamed from: w  reason: collision with root package name */
    public ArrayList<String> f26530w = new ArrayList<>();

    /* renamed from: x  reason: collision with root package name */
    public ArrayList<String> f26531x = new ArrayList<>();

    /* renamed from: y  reason: collision with root package name */
    public String f26532y = "";

    /* renamed from: z  reason: collision with root package name */
    public final String f26533z = LogHelper.INSTANCE.makeLogTag(k0.class);
    ...
    */
    public final void I() {
        ...
        try {
            ...
            if (arguments != null) {
                String string3 = arguments.getString("cb4_title", "");
                boolean z14 = false;
                if (string3 != null && string3.length() != 0) {
                    ...
                    if (string3 != null) {
                        ((RobertoTextView) _$_findCachedViewById(R.id.cb4Title)).setText(string3);
                    }
                    string = arguments.getString("cb4_desc", "");
                    if (string != null && string.length() != 0) {
                        ...
                        if (string != null) {
                            ((RobertoTextView) _$_findCachedViewById(R.id.cb4Subtitle)).setText(string);
                        }
                        stringArrayList = arguments.getStringArrayList("cb4_icon_list");
                        if (stringArrayList != null && !stringArrayList.isEmpty()) {
                            ...
                            if (stringArrayList != null) {
                                this.f26530w = stringArrayList;
                            }
                            stringArrayList2 = arguments.getStringArrayList("cb4_point_list");
                            if (stringArrayList2 != null && !stringArrayList2.isEmpty()) {
                                ...
                                if (str == null) {
                                    ((RobertoTextView) _$_findCachedViewById(R.id.cb4Title)).setTextColor(ColorStateList.valueOf(Color.parseColor(str)));
                                    ((RobertoTextView) _$_findCachedViewById(R.id.cb4Subtitle)).setTextColor(ColorStateList.valueOf(Color.parseColor(str)));
                                    this.f26532y = str;
                                    return;
                                }
                                return;
            ...
            LogHelper.INSTANCE.e(this.f26533z, e10);
        }
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return inflater.inflate(R.layout.fragment_cb4, viewGroup, false);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        try {
            I();
            Integer num = (Integer) is.k.c2(new Integer[]{Integer.valueOf(this.f26530w.size()), Integer.valueOf(this.f26531x.size())});
            if (num != null) {
                i6 = num.intValue();
            } else {
                i6 = 0;
            ...
            for (int i10 = 0; i10 < i6; i10++) {
                View inflate = getLayoutInflater().inflate(R.layout.row_cb4, (ViewGroup) ((LinearLayout) _$_findCachedViewById(R.id.cb4Container)), false);
                String str = null;
                if (!this.f26530w.isEmpty()) {
                    String str2 = (String) is.u.j2(i10, this.f26530w);
                    if (str2 == null) {
                        String str3 = this.f26530w.get(0);
                    ...
                    if (str2 != null) {
                        ...
                        d10.d(new File(activity2.getFilesDir(), str2)).B((AppCompatImageView) inflate.findViewById(R.id.cb4RowImage));
                    }
                }
                String str4 = (String) is.u.j2(i10, this.f26531x);
                if (str4 != null) {
                    ((RobertoTextView) inflate.findViewById(R.id.cb4RowText)).setText(str4);
                }
                String str5 = this.f26532y;
                if (!gv.n.B0(str5)) {
                    str = str5;
                }
                ((RobertoTextView) inflate.findViewById(R.id.cb4RowText)).setTextColor(ColorStateList.valueOf(Color.parseColor(str)));
                ((LinearLayout) _$_findCachedViewById(R.id.cb4Container)).addView(inflate);
            }
            F().U();
        } catch (Exception e10) {
            LogHelper.INSTANCE.e(this.f26533z, e10);
