...
public final class b extends k implements s<String, String, Integer, String, Boolean, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ a f17781u;
    ...
    public final Object y(String uuid, String providerName, Object obj, String earliestAvailableDateTime, Object obj2) {
        ...
        a aVar = this.f17781u;
        aVar.f17778z.a(new Intent(aVar.requireActivity(), TelecommunicationsPWAActivity.class).putExtra(Constants.TELECOMMUNICATION_REDIRECT, pp.c.PROFILE).putExtra(SessionManager.KEY_UUID, uuid).putExtra("override_source_value", "app_expert_care"));
        ...
        if (dVar != null) {
            ...
            gk.a.b(f, "therapy_psychiatry_profile_card_click");
            return hs.k.f19476a;
        }
        i.q("viewModel");
        throw null;
