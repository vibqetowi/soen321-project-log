...
public class DatabaseError {
    ...
    private DatabaseError(int i6, String str) {
        this(i6, str, null);
    }

    public static DatabaseError fromCode(int i6) {
        Map<Integer, String> map = errorReasons;
        if (map.containsKey(Integer.valueOf(i6))) {
            return new DatabaseError(i6, map.get(Integer.valueOf(i6)), null);
        }
        throw new IllegalArgumentException(c.p("Invalid Firebase Database error code: ", i6));
    }

    public static DatabaseError fromException(Throwable th2) {
    ...
    private DatabaseError(int i6, String str, String str2) {
        this.code = i6;
        this.message = str;
