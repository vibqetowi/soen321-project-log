...
final class AFa1qSDK {
    ...
    public final Map AFInAppEventType(List<Map<String, Object>> list) {
        ...
        for (Map<String, Object> map : list) {
            ...
            if (z10 && z11) {
                aFa1wSDK = AFa1wSDK.ALL;
            } else if (z10) {
                aFa1wSDK = AFa1wSDK.FIRST;
            } else {
                aFa1wSDK = AFa1wSDK.NONE;
            }
            if (aFa1wSDK != AFa1wSDK.NONE) {
                ...
                hashMap.put(AFa1zSDK.values()[num.intValue()].values, hashMap2);
                if (aFa1wSDK2 == AFa1wSDK.FIRST) {
