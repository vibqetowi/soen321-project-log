...
public class CircularSliderGreyBg extends View {
    ...
    public CircularSliderGreyBg(Context context, AttributeSet attributeSet) {
        ...
        this.J = Color.parseColor("#465A62");
        this.K = true;
        this.Q = false;
    ...
    public final void a(int i6, int i10) {
        int i11 = i6 - this.f11833v;
        int i12 = this.f11834w - i10;
        double d10 = i11;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f11832u) {
            this.O = (int) ((Math.cos(this.C) * this.f11835x) + this.f11833v);
            int sin = (int) (this.f11834w - (Math.sin(this.C) * this.f11835x));
            this.P = sin;
    ...
    public final void onSizeChanged(int i6, int i10, int i11, int i12) {
        ...
        this.f11833v = ((i6 - i14) / 2) + (i14 / 2);
        this.f11834w = ((i10 - i15) / 2) + (i15 / 2);
        this.f11835x = ((i13 / 2) - (this.A / 2)) - this.f11836y;
        int i16 = this.f11833v;
        int i17 = this.f11835x;
        int i18 = this.f11834w;
        this.H = new RectF(i16 - i17, i18 - i17, i16 + i17, i18 + i17);
        if (this.f11837z != null) {
            int i19 = this.f11835x;
            this.F = new SweepGradient(i19, i19, this.f11837z, (float[]) null);
        }
    ...
    public void setBorderGradientColors(String[] strArr) {
        this.f11837z = new int[strArr.length];
        for (int i6 = 0; i6 < strArr.length; i6++) {
            this.f11837z[i6] = Color.parseColor(strArr[i6]);
        }
    }
    ...
    public void setBorderGradientColors(int[] iArr) {
        ...
        this.f11837z = Arrays.copyOf(iArr, iArr.length);
        int i6 = this.f11835x;
        this.F = new SweepGradient(i6, i6, this.f11837z, (float[]) null);
    }
