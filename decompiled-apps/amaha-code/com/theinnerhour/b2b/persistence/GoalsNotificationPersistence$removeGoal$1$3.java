...
public final class GoalsNotificationPersistence$removeGoal$1$3 extends k implements l<NotificationGoal, Boolean> {
    final /* synthetic */ String $goalId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GoalsNotificationPersistence$removeGoal$1$3(String str) {
        super(1);
        this.$goalId = str;
    }
