...
public final class SubscriptionPersistence$fetchData$2 extends k implements ss.a<hs.k> {
    public static final SubscriptionPersistence$fetchData$2 INSTANCE = new SubscriptionPersistence$fetchData$2();

    public SubscriptionPersistence$fetchData$2() {
        super(0);
    }
