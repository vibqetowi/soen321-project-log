...
public final class CourseApiUtil$addAllMiniCourses$onLoaded$1 extends kotlin.jvm.internal.k implements q<Boolean, String, ArrayList<MiniCourseMeta>, hs.k> {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (kotlin.jvm.internal.i.b(next2.getSlug(), slug)) {
                    ...
                    miniCourse.setPosition(next2.getInDomainPos());
                    break;
                }
            }
            ...
            if (this.$finalMcList.size() == 18) {
                Iterator<MiniCourse> it3 = this.$finalMcList.iterator();
                while (true) {
                    if (!it3.hasNext()) {
                        str = "";
                        break;
                    }
                    MiniCourse next3 = it3.next();
                    if (kotlin.jvm.internal.i.b(next3.getCourse(), FirebasePersistence.getInstance().getUser().getCurrentCourseName()) && next3.getDomain() != null) {
                        String domain = next3.getDomain();
                        kotlin.jvm.internal.i.d(domain);
                        if (r.J0(domain, "basic")) {
                            str = next3.getDomain();
