...
public final class CourseApiUtil$sendMiniCourseRequest$onLoaded$1 extends kotlin.jvm.internal.k implements q<Boolean, String, ArrayList<MiniCourseMeta>, hs.k> {
    ...
    public CourseApiUtil$sendMiniCourseRequest$onLoaded$1(String str, ArrayList<MiniCourseInfoMeta> arrayList, List<MiniCourse> list, CourseApiUtil courseApiUtil) {
        super(3);
        this.$slug = str;
