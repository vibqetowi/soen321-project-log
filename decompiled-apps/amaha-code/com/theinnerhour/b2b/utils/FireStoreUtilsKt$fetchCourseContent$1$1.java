...
@ns.e(c = "com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchCourseContent$1$1", f = "FireStoreUtils.kt", l = {325}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class FireStoreUtilsKt$fetchCourseContent$1$1 extends ns.i implements p<d0, ls.d<? super hs.k>, Object> {
    ...
    /* compiled from: FireStoreUtils.kt */
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/d0;", "Lhs/k;", "<anonymous>"}, k = 3, mv = {1, 7, 1})
    @ns.e(c = "com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchCourseContent$1$1$1", f = "FireStoreUtils.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchCourseContent$1$1$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FireStoreUtilsKt$fetchCourseContent$1$1(ya.h<r> hVar, p<? super Boolean, ? super TemplateModel, hs.k> pVar, ls.d<? super FireStoreUtilsKt$fetchCourseContent$1$1> dVar) {
        super(2, dVar);
        this.$it = hVar;
        this.$onLoad = pVar;
    }
    ...
    @Override // ns.a
    public final ls.d<hs.k> create(Object obj, ls.d<?> dVar) {
        return new FireStoreUtilsKt$fetchCourseContent$1$1(this.$it, this.$onLoad, dVar);
    }
            ...
            if (i6 != 0) {
                ...
                if (this.$it.isSuccessful()) {
                    ...
                    while (true) {
                        ...
                        xVar.f23469u = ((q) aVar2.next()).d(TemplateModel.class);
                    }
                }
    ...
    @Override // ss.p
    public final Object invoke(d0 d0Var, ls.d<? super hs.k> dVar) {
        return ((FireStoreUtilsKt$fetchCourseContent$1$1) create(d0Var, dVar)).invokeSuspend(hs.k.f19476a);
    }
}
