...
public final class FireStoreUtilsKt$fetchMiniCourseMeta$1 extends kotlin.jvm.internal.k implements ss.l<r, hs.k> {
    final /* synthetic */ q<Boolean, String, ArrayList<MiniCourseMeta>, Object> $onLoad;
    final /* synthetic */ String $slug;

    /* compiled from: FireStoreUtils.kt */
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/d0;", "Lhs/k;", "<anonymous>"}, k = 3, mv = {1, 7, 1})
    @ns.e(c = "com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchMiniCourseMeta$1$1", f = "FireStoreUtils.kt", l = {189}, m = "invokeSuspend")
    /* renamed from: com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchMiniCourseMeta$1$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends ns.i implements p<d0, ls.d<? super hs.k>, Object> {
        ...
        @ns.e(c = "com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchMiniCourseMeta$1$1$2", f = "FireStoreUtils.kt", l = {}, m = "invokeSuspend")
        /* renamed from: com.theinnerhour.b2b.utils.FireStoreUtilsKt$fetchMiniCourseMeta$1$1$2  reason: invalid class name */
        /* loaded from: classes2.dex */
        public static final class AnonymousClass2 extends ns.i implements p<d0, ls.d<? super Object>, Object> {
            ...
            public AnonymousClass2(q<? super Boolean, ? super String, ? super ArrayList<MiniCourseMeta>, ? extends Object> qVar, String str, ArrayList<MiniCourseMeta> arrayList, ls.d<? super AnonymousClass2> dVar) {
                super(2, dVar);
                this.$onLoad = qVar;
                this.$slug = str;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public AnonymousClass1(r rVar, q<? super Boolean, ? super String, ? super ArrayList<MiniCourseMeta>, ? extends Object> qVar, String str, ls.d<? super AnonymousClass1> dVar) {
            super(2, dVar);
            this.$it = rVar;
            this.$onLoad = qVar;
            this.$slug = str;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FireStoreUtilsKt$fetchMiniCourseMeta$1(q<? super Boolean, ? super String, ? super ArrayList<MiniCourseMeta>, ? extends Object> qVar, String str) {
        super(1);
        this.$onLoad = qVar;
        this.$slug = str;
    }
