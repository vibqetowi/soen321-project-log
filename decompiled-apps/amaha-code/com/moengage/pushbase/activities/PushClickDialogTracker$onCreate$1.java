...
public final class PushClickDialogTracker$onCreate$1 extends k implements a<String> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ PushClickDialogTracker f10192u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PushClickDialogTracker$onCreate$1(PushClickDialogTracker pushClickDialogTracker) {
        super(0);
        this.f10192u = pushClickDialogTracker;
    }

    @Override // ss.a
    public final String invoke() {
        String str;
        str = this.f10192u.tag;
