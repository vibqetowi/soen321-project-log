...
public final class PushClickDialogTracker$onCreate$2 extends k implements a<String> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ PushClickDialogTracker f10193u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PushClickDialogTracker$onCreate$2(PushClickDialogTracker pushClickDialogTracker) {
        super(0);
        this.f10193u = pushClickDialogTracker;
    }

    @Override // ss.a
    public final String invoke() {
        String str;
        str = this.f10193u.tag;
