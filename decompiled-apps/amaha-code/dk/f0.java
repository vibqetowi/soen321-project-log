...
public final class f0 extends kotlin.jvm.internal.k implements ss.p<Boolean, TemplateModel, hs.k> {

    /* renamed from: u  reason: collision with root package name */
    public final /* synthetic */ TemplateActivity f12918u;

    /* renamed from: v  reason: collision with root package name */
    public final /* synthetic */ boolean f12919v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f0(TemplateActivity templateActivity, boolean z10) {
        super(2);
        this.f12918u = templateActivity;
        this.f12919v = z10;
    }
    ...
    public final hs.k invoke(Boolean bool, TemplateModel templateModel) {
        ...
        TemplateActivity templateActivity = this.f12918u;
        try {
            ProgressDialogUtil progressDialogUtil = templateActivity.f10546x;
            if (progressDialogUtil != null) {
                progressDialogUtil.dismiss();
            }
            LogHelper.INSTANCE.i(templateActivity.f10545w, "fetch course content template activity " + this.f12919v);
            ...
            Utils.INSTANCE.showCustomToast(templateActivity, "Something went wrong, please try again");
            templateActivity.finish();
            LogHelper.INSTANCE.e(templateActivity.f10545w, "error in fetchCourseContent", e10);
        }
        return hs.k.f19476a;
    }
}
