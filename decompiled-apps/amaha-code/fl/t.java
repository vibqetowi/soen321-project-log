...
public final class t implements SeekBar.OnSeekBarChangeListener {
    ...
    public final /* synthetic */ NotV4Activity f15159a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ kotlin.jvm.internal.v f15160b;

    public t(NotV4Activity notV4Activity, kotlin.jvm.internal.v vVar) {
        this.f15159a = notV4Activity;
        this.f15160b = vVar;
    }
    ...
    public final void onProgressChanged(SeekBar seekBar, int i6, boolean z10) {
        ...
        yp.c cVar11;
        yp.c cVar12;
        NotV4Activity notV4Activity = this.f15159a;
        if (seekBar != null) {
            seekBar.setThumbTintList(ColorStateList.valueOf(g0.a.b(notV4Activity, R.color.sea)));
        }
        v.c cVar13 = notV4Activity.F;
        AppCompatImageView appCompatImageView7 = null;
        if (cVar13 != null && (cVar12 = (yp.c) cVar13.f34633x) != null) {
        ...
        kotlin.jvm.internal.v vVar = this.f15160b;
        vVar.f23467u = i6;
        v.c cVar14 = notV4Activity.F;
        if (cVar14 != null && (cVar11 = (yp.c) cVar14.f34633x) != null) {
        ...
        v.c cVar15 = notV4Activity.F;
        if (cVar15 != null && (cVar10 = (yp.c) cVar15.f34633x) != null) {
        ...
        v.c cVar16 = notV4Activity.F;
        if (cVar16 != null && (cVar9 = (yp.c) cVar16.f34633x) != null) {
        ...
        v.c cVar17 = notV4Activity.F;
        if (cVar17 != null && (cVar8 = (yp.c) cVar17.f34633x) != null) {
            constraintLayout2 = cVar8.f38735b;
        } else {
            constraintLayout2 = null;
        }
        bVar.b(constraintLayout2);
        v.c cVar18 = notV4Activity.F;
        if (cVar18 != null && (cVar7 = (yp.c) cVar18.f34633x) != null) {
        ...
        if (appCompatImageView2 != null) {
            ...
            if (number2.intValue() == 0) {
                ...
                dimensionPixelSize = notV4Activity.getResources().getDimensionPixelSize(number2.intValue());
            }
            appCompatImageView2.setTranslationX(dimensionPixelSize);
        }
        v.c cVar19 = notV4Activity.F;
        if (cVar19 != null && (cVar6 = (yp.c) cVar19.f34633x) != null) {
        ...
        if (z11) {
            v.c cVar20 = notV4Activity.F;
            if (cVar20 != null && (cVar5 = (yp.c) cVar20.f34633x) != null && (appCompatImageView6 = cVar5.f38739g) != null) {
        ...
        if (z12) {
            v.c cVar21 = notV4Activity.F;
            if (cVar21 != null && (cVar4 = (yp.c) cVar21.f34633x) != null && (appCompatImageView5 = cVar4.f38739g) != null) {
        ...
        if (z13) {
            ...
            if (cVar22 != null && (cVar3 = (yp.c) cVar22.f34633x) != null && (appCompatImageView4 = cVar3.f38739g) != null) {
                appCompatImageView4.setImageResource(R.drawable.ic_nps_allie_3);
            }
        } else if (i6 == 10 && (cVar = notV4Activity.F) != null && (cVar2 = (yp.c) cVar.f34633x) != null && (appCompatImageView3 = cVar2.f38739g) != null) {
